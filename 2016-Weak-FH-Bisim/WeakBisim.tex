...
\begin{theorem}[Congruence]\label{thm-congr-weq}
	...
	$\pNet[\pNetQ']_{j_0}$ are weak FH-bisimilar.
\end{theorem}
 \begin{proof}  (Sketch of proof) Consider $Q$ weak FH-bisimilar to $Q'$.  It means, there exist a FH-bisimulation $\mathcal{R}_{Q,Q'}$ relating the two pNets $Q$ and $Q'$. We define a relation $\mathcal{R}$ relating states of $P[Q]_{j_0}$ with states of $P[Q']_{j_0}$: 
