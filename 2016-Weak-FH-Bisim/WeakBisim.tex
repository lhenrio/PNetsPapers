...
\openrule
         ...
         {s^2_i \OTarrow {\alpha} s^2_{i+1}} \in \mathcal{T}
\qquad
\openrule
         {
...
\\
s=s^1_i \wedge s^1_n=s^2_0 \wedge s^2_n = s^3_0 \wedge s^3_n=s'
\\\\
\overline{\gamma}=\biguplus_{i=0}^n \vis{\overline{\beta^1_i}} \dotcup  \biguplus_{i=0}^n \vis{\overline{\beta^2_i}} \dotcup \biguplus_{i=0}^n \vis{\overline{\beta^3_i}}
\\
\Pred=\bigwedge_{i}^n\Pred^1_i\land\bigwedge_{i}^n\Pred^2_i\subst{\Post_1}\land (\bigwedge_{i}^n\Pred^3_i\subst{\Post^2_i})\subst{\Post^1_i}
}
{
\openrule
         {
           \overline{\gamma},
		\Pred,
				({x^3_k\gets (e^3_k\subst {\Post^2_i})\subst{\Post^1_i}})^{k\in K} } 
         {s \OTWeakarrow {\alpha} s'} \in\WT
}
\end{mathpar}
\end{lemma}
