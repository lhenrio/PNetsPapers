...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{z\in Z}}
   \left( \forall j\in J_{x y z}. \gamma_j=\gamma_{j x y z}  \Rightarrow \Pred_{OT_{x y z}}
     ...
     \Pred_{s',t_{x y z}}\subst{\Post_{OT}}\subst{\Post\,}\right)$
We recall that we have:\\
$\Pred_{OT}= \Pred^1 \wedge \Pred^2\subst{\Post^1} \wedge \Pred^3\subst{\Post^2}\subst{\Post^1}$\\
$\Post_{OT}=\Post^3\subst{\Post^2}\subst{\Post^1}$\\
...
$(\Pred_{s,t} \land \Pred^1)\wedge\Pred^2\subst{\Post^1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
  \!\! \left( \forall j\in J_x. \vis{\beta^1_j}=\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     \land \alpha_x\!=\!\tau \land  
     \Pred_{s_1^1,t_x}\subst{\Post^1}\subst{\Post_{OT_x}}\right) \wedge\Pred^2\subst{\Post^1} \subst{\Post_{OT_x}}  \\
$
...
$(\Pred_{s,t} \land \Pred^1)\wedge\Pred^2\subst{\Post^1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
\!\!   \left(\forall j\in J_x. \vis{\beta^1_j}\!=\!\gamma_{jx}\Rightarrow \Pred_{OT_x}
     \!\land\! \alpha_x\!=\!\tau\land(\Pred_{s_1^1,t_x}\wedge\Pred^2)\subst{\Post^1}\subst{\Post_{OT_x}} \right)$\\
...
$(\Pred_{s,t} \land \Pred^1)\wedge\Pred^2\subst{\Post^1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
   ...
   ( \forall j\in J_{x y}. \vis{\beta^2_j}\!\!=\!\!\gamma_{jx y}\Rightarrow\\~~\qquad\quad \Pred_{OT_{x y}}\land \alpha\!=\!\alpha_{x y}\! \land \Pred_{s_1^2,t_{x y}}\subst{\Post^2}\subst{\Post_{OT_{x y}}})\Big)\subst{\Post^1} \subst{\Post_{OT_x}} \Big)$\\
...
\Big(\forall j\in J_x. \vis{\beta^1_j}\!\!=\!\!\gamma_{jx} \land  \forall j \in J_{x y}. \vis{\beta^2_j}\!\!=\!\gamma_{jx y}\Rightarrow\Pred_{OT_x} \land  \Pred_{OT_{x y}} \\\subst{\Post^1} \subst{\Post_{OT_x}} \land \alpha_x\!=\!\tau \land \alpha\!=\!\alpha_{x y} \land \Pred_{s_1^2,t_{x y}}\subst{\Post^2}\subst{\Post^1}\subst{\Post_{OT_{x y}}} \subst{\Post_{OT_x}}\Big)$\\ 
Finally, the conjunction with the term $\Pred^3\subst{\Post^2}\subst{\Post^1}$ of the both sides of the implication and rewriting, we get:\\
...
\tau \land \alpha\!=\! \alpha_{x y} \land (\Pred_{s_1^2,t_{xy}} \land  \Pred^3) \subst{\Post^2}
\subst{\Post^1}\subst{\Post_{OT_{x y}}} 
\subst{\Post_{OT_x}} \Big)$\\ 
Again because of the domain independence of the substitution, we deleted $\subst{\Post^1}$, and  we have added  $\subst{\Post_{OT_{x y}}}\subst{\Post_{OT_x}}$ on the right side of the implication.
...
\tau \!\land \alpha\!=\!\alpha_{x y} \land \alpha_{x y z}\!=\!\tau \land \Pred_{s^3_1,t_{x y z}}  \underbrace{\subst{\Post^3}\subst{\Post^2}
