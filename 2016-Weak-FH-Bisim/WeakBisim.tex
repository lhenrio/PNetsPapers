...
Relying on open automata, this article defines bisimulation relations  for the comparison of systems specified as pNets.
...
The article is illustrated with a transport protocol running example.
\end{abstract}
...
% a bisimulation
an equivalence between the semantics presented in this article and the operational one shown in~\cite{AmeurBoulifa2017} is outside the scope of this article because we focus here on the modelisation of holes that were not modelled in the previous semantics.
