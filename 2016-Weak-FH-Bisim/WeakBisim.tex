...
In previous works~\cite{AmeurBoulifa2017}, only closed pNets were equipped with a semantics, it was defined as labelled transition systems. 
...
an expression. Formally, for all predicate $\Pred$ for all partial function $\Post$, if $V\!\cap \!\dom(\Post)=\emptyset$, we have: 
		 \begin{mathpar}
    \openrule
         {
           \set{\beta}, \Pred\,',\Post\,'}
