...
\Pred=\bigwedge_{i=0}^{m_1}\big(\Pred^1_i\bigotimes_{j=0}^{i-1}\subst{\Post_j^1}\big)\land\Pred^2\bigotimes_{i=0}^{m_1}\subst{\Post_i^1}\land \bigwedge_{i=0}^{m_2}\Pred_i^3\big(\bigotimes_{i=0}^{m_1}\subst{\Post_i^1}(\subst{\Post^2}  \bigotimes_{j=0}^{i-1}\subst{\Post^3_j})\big)\\
...
\displaystyle{\gamma_j}=\mybigdotcup_{i=0}^{m_1}  \vis{\beta^1_{ij}} \dotcup  (\set{\beta^2_i}) \dotcup \mybigdotcup_{i=0}^{m_2} \vis{\beta^3_{ij}}
\\
