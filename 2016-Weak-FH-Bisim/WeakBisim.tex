...
\\
 ...
 \text{and\qquad} \gamma_j^{j\in J\cap\Holes(Q)}= \mybigdotcup_{p=0}^n \gamma_{p j}^{j\in J_p} \\
...
%
\Pred_k=\bigwedge_{i=n'_{k}}^{n_k\!-\!1}\!\!\Pred''_{i}\subst{\bigotimes_{j=i-1}^{n'_{k}}\!\!\Post_{j}}\land\Pred''_{n_k} \subst{\bigotimes_{j=n_k-1}^{n'_{k}}\!\!\Post''_{j}}\land\\ 
