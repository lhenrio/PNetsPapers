...
\TODO{informal semantics of pnets}
...
\TODO{\Post~is missing}
\end{mathpar}

\begin{mathpar}
\Longleftrightarrow  \left \{ \begin{array}{l} 
\alpha = \tau \wedge s=s' \wedge  \vis{\overline{\beta^2}}=\emptyset \wedge \Pred^2 =\symb{True} \wedge \Post^2 =\symb{Id(s)}\\
\\
\bigvee \\
\\
{
...
\TODO{I will complete I will express the induction is on length of m or n}
...
implies \TODO{by induction hypothesis and simplification}
...
\end{mathpar}
implies \TODO{by induction hypothesis}
\begin{mathpar}
