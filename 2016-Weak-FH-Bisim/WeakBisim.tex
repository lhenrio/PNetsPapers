...
$\displaystyle{
\set{\gamma}=\mybigdotcup_{i=0}^{m_1} \vis{\set{\beta_{1i}}\subst{\bigotimes_{j=i-1}^{0}\!\! \Post_{1j}}}\dotcup  \vis{\set{\beta_2}\subst{\bigotimes_{j=n}^{0}\Post_{1j}}} \dotcup \mybigdotcup_{i=0}^{m_2} \vis{\set{\beta_{3i}} \subst{\bigotimes_{j=i-1}^{0}\!\Post_{3j}\shortotimes\Post_2\shortotimes\bigotimes_{j=m_1}^{0}\!\!\Post_{1j}} }}
\\
...
$\forall p\! \in\! [0..(n_k\!-\!1)] Q\models{\openrule
			{
				(\beta_{1pj})^{j\in J\cap\Holes(Q)}, {{\Pred''{1p}}},  
				{{\Post''_{1p}}}}
...
$Q\models{\openrule
			{
				(\beta_{2j})^{j\in J\cap\Holes(Q)}, {{\Pred''_2}},  
				{{\Post''_2}}}
				{\ostate{v_{n_k'l}^{l\in L_Q}} \OTarrow {\alpha_k}
...
By replacing $\Pred_{1i}$,  $\Pred_2$, and $\Pred_{3i}$ by their equivalent formula  we obtain:\\
$\Pred \iff\displaystyle{\bigwedge_{i=0}^{m_1}({\Pred'_{1i}}
		\land {\Pred''_{1i}}\land \alpha_{1i}=\beta_{1ij_0}) \bigotimes_{j=0}^{i-1}\subst{\Post_{1j}}\land}\\
~~\qquad\qquad\qquad({\Pred'_2}\land {\Pred''_2}\land \alpha_2=\beta_{2j_0})	\bigotimes_{i=0}^{m_1}\subst{\Post_{1i}}\land\\
...
{\Pred'_{1i}}\bigotimes_{j=0}^{i-1}\subst{{\Post'_{1j}}}\big)
\land{\Pred'_2}\bigotimes_{i=0}^{m_1}\subst{{\Post'_{1i}}}\land} \\
~~\qquad\qquad\quad\big(\bigwedge_{i=0}^{m_2}{\Pred'_{3i}}\bigotimes_{j=0}^{i-1}\subst{{\Post'_{3j}}}\subst{{\Post'_2}}\bigotimes_{j=0}^{m_1}\subst{{\Post'_{1j}}}\big) \land\\	
~\qquad\qquad\quad\bigwedge_{i=0}^{m_1}({\Pred''_{1i}}\land \alpha_{1i}=\beta_{1ij_0}) \bigotimes_{j=0}^{i-1}\subst{\Post_{1j}}\land({\Pred''_2}\land \alpha_2=\beta_{2j_0})	\bigotimes_{i=0}^{m_1}\subst{\Post_{1i}}\land\\
~\qquad\qquad\quad\bigwedge_{i=0}^{m_2} ({\Pred''_{3i}}\land \alpha_{3i}=\beta_{3ij_0})\bigotimes_{j=0}^{i-1}\subst{\Post_{3j}}\subst{\Post_2}  \bigotimes_{i=0}^{m_1}\subst{\Post_{1i}}
$\\		
Therefore, we have:\\
...
By replacing ${\Post_{1i}}$,  $\Post_2$, and ${\Post_{3i}}$ and because the ${\Post'_i}$ and ${\Post''_i}$ are independent (the ${\Post'_i}$ concern the leaves of $P$ while the ${\Post''_i}$ concern the leaves of $Q$), we obtain:\\
$\Post= \displaystyle{\bigotimes_{i=0}^{m_2}\subst{{\Post'_{3i}}\uplus 
		{\Post''_{3i}}} \subst{{\Post'_2}\uplus 
		{\Post''_2}} \bigotimes_{j=0}^{m_1}\subst{ {\Post'_{1i}}\uplus 
		{\Post''_{1i}}}}\\
~~\qquad= \bigotimes_{i=0}^{m_2}{\Post'_{3i}}\subst{{\Post'_2}}\bigotimes_{j=0}^{m_1}\subst{{\Post'_{1j}}} \uplus \bigotimes_{i=0}^{m_2}{\Post''_{3i}}\subst{{\Post''_2}}\bigotimes_{j=0}^{m_1}\subst{{\Post''_{1j}}} \\
