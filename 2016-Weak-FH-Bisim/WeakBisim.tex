...
We first define the set of actions that do not distinguish input variables, they will be used in synchronisation vectors of pNets below:
...
\subsection{Parameterised Networks (pNets): definition}
\label{section:pnets}
