...
\openrule
         {
           \set{\beta_2},\Pred_2,\Post_2 }
         {s_{20} \OTarrow {\alpha} s_{21}} \in \mathcal{T}
 \wedge
\forall i \in [0..m].\openrule
         {
           \set{\beta_{3i}},\Pred_{3i},  \Post_{3i}  }
 ...
 \openrule
    {
       \set{\beta_{10}},\Pred_{10},\Post_{10}   }
         {s_{10} \OTarrow {\tau} s_{11}} \in \mathcal{T}          
\end{mathpar}
we have $(s,t|\Pred_{s,t})\in\mathcal{R}$, hence $(s_{10},t|\Pred_{s_{10},t})\in\mathcal{R}$, since $s=s_{10}$. By  Definition \ref{def-Weak-bisim} we  can deduce there exist weak open transitions $\symb{WOT}_x^{x\in X} \subseteq \WT_2$:
 \begin{mathpar}
    \openrule
         {
           \gamma_{j x}^{j\in J_{x}}, \Pred_{OT_x},\Post_{OT_x}}
...
\item Concerning the middle open transition, we have:
 \begin{mathpar}
     \openrule
         {
           \beta_j^{j \in J_2},\Pred_2,\Post_2 }
         {s_{20} \OTarrow {\alpha} s_{21}} 
\end{mathpar}
For each of the weak open transition obtained above, we have the following.
We have $(s_{11},t_x|\Pred_{s_{11},t_x})\in \mathcal{R}$, then $(s_{20},t_x|\Pred_{s_{20},t_x})\in \mathcal{R}$. Again 
...
%\inferrule{
 \openrule
    {
       \set{\beta_3},\Pred_3,\Post_3   }
         {s_{30} \OTarrow {\tau} s_{31}} \in \mathcal{T}          
\end{mathpar}
Additionally, we have 
$(s_{21},t_{x y}|\Pred_{s_{30},t_{x y}})\in \mathcal{R}$, then $(s_{30},t_{x y}|\Pred_{s_{30},t_{x y}})\in \mathcal{R}$
...
$\Post_{OT}=\Post_3\subst{\Post_2\shortotimes\Post_1}$\\
...
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
  \!\! \left( \forall j\in J_x. \vis{\beta_{1j}}=\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     \land \alpha_x\!=\!\tau \land  
     \Pred_{s_1^1,t_x}\subst{\Post^1\shortotimes\Post_{OT_x}}\right) \wedge\Pred_2\subst{\Post_1\shortotimes\Post_{OT_x}}  \\
$
...
By replacing the inner sub-term $(\Pred_{s_{11},t_x}\wedge\Pred_2)$ by the consequent of the corresponding implication given in case 2,  the formula becomes: \\
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
   \!\!\Big(\forall j\in J_x. \vis{\beta_{1j}}\!\!=\!\!\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     \!\land\! \alpha_x\!=\!\tau \land\Big(\displaystyle{\bigvee_{y\in Y}}
   ( \forall j\in J_{x y}. \vis{\beta_{2j}}\!\!=\!\!\gamma_{jx y}\Rightarrow\\~~\qquad\quad \Pred_{OT_{x y}}\land \alpha\!=\!\alpha_{x y}\! \land \Pred_{s_{21},t_{x y}}\subst{\Post_2\shortotimes\Post_{OT_{x y}}})\Big)\subst{\Post_1\shortotimes\Post_{OT_x}} \Big)$\\
...
\Big(\forall j\in J_x. \vis{\beta_{1j}}\!\!=\!\!\gamma_{jx} \land  \forall j \in J_{x y}. \vis{\beta_{2j}}\!\!=\!\gamma_{jx y}\Rightarrow\Pred_{OT_x} \land  \Pred_{OT_{x y}} \\\subst{\Post_1\shortotimes\Post_{OT_x}} \land \alpha_x\!=\!\tau \land \alpha\!=\!\alpha_{x y} \land \Pred_{s_{21},t_{x y}}\subst{\Post_2\shortotimes\Post_1\shortotimes \Post_{OT_{x y}}\shortotimes \Post_{OT_x}}\Big)$\\ 
...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}} 
\Big(\forall j\in J_x.\vis{\beta^1_j}\!=\!\gamma_{jx} \land  \forall j \in J_{x y}. \vis{\beta_{2j}}\!=\!\gamma_{jx y} \Rightarrow \Pred_{OT_x}\land\Pred_{OT_{x y}}\subst{\Post_{OT_x}} \land \alpha_x\!=\!
\tau \land \alpha\!=\! \alpha_{x y} \land (\Pred_{s_{21},t_{xy}} \land  \Pred_3) \subst{\Post_2\shortotimes \Post_1\shortotimes \Post_{OT_{x y}}\shortotimes\Post_{OT_x}} \Big)$\\ 
Again because of the domain independence of the substitution, we deleted $\subst{\Post_1}$, and  we have added  $\subst{\Post_{OT_{x y}}\shortotimes\Post_{OT_x}}$ on the right side of the implication.
...
\Big(\forall j\in J_x.\vis{\beta_{1j}}\!\!=\!\!\gamma_{jx} \land\!  \forall j \!\in\! J_{x y}.\vis{\beta_{2j}}\!\!=\!\!\gamma_{jx y} \forall j\!\in\! J_{x y z}. \vis{\beta_{3j}}\!\!=\!\!\gamma_{j x y z} \Rightarrow  \Pred_{OT_x}\land\Pred_{OT_{x y}}\subst{\Post_{OT_x}} \land \Pred_{OT_{x y z}}\!\subst{\Post_{OT_{x y}}\shortotimes\Post_{OT_x}} \land \alpha_x\!=\!
\tau \!\land \alpha\!=\!\alpha_{x y} \land \alpha_{x y z}\!=\!\tau \land \Pred_{s_{31},t_{x y z}}  \subst{\underbrace{\Post_3\shortotimes\Post_2\shortotimes\Post^1}_{\Post_{OT}}\,\shortotimes \Post_{OT_{x y z}}\shortotimes \Post_{OT_{x y}}\shortotimes\Post_{OT_x}} \Big)$
Therefore, having $s_{31}=s'$ we can conclude:\\
$(\Pred_{s,t} \land \Pred_1)\land \Pred_2\subst{\Post_1} \land \Pred_3\subst{\Post_2\shortotimes\Post_1}\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}} \displaystyle{\bigvee_{z\in Z}} 
\Big(\forall j\in J_{x y z}. \vis{\beta^1_j}.\vis{\beta_{2j}}.\vis{\beta_{3j}}\!=\!\gamma_{j x y z} \Rightarrow  \Pred_{OT_x}\land\Pred_{OT_{x y}}\subst{\Post_{OT_x}} \land \Pred_{OT_{x y z}}\subst{\Post_{OT_{x y}}\shortotimes\Post_{OT_x}} \land \alpha\!=\!\alpha_{x y} \land \Pred_{s',t_{x y z}}\subst{\Post_{OT}\shortotimes\Post_{OT_{x y z}}\shortotimes\Post_{OT_{x y}}\shortotimes\Post_{OT_x}} \Big)$
