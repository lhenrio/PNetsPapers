...
\begin{figure}[h]
  ...
  \caption{Weak Open Automaton of the implementation}
   \label{Appendix:ImplOAl}
\end{figure}

In Figure \ref{Appendix:ImplOA} we show the weak open automaton of our implementation pNet. 
\TODO{This version is very uncomplete, at least 12 WOTs are missing, inculding: all variants of WI3 starting from 202; the inverse of WI4, WI5, WI6, WI8, etc}
...
Figure \ref{Appendix:ImplOA} shows a more compact version of this weak automation, that will be easier to read for humans...
...
In this configuration we can garanty that they are Weak Bisimilar, and merge their (incoming and outgoing) transitions in the Figure. We denote this equivalence class of states as $\{000,202\}$.
...
\ERIC{Correspondance between the WOTs naming:
$WI_3 ','',''' -> WI_3 a,b,c$\\
$WI_7 ','' -> WI_7 a,b$\\
$WI_8 ','',''' -> WI_8 a,b,c$\\
$WI_9 ,','' -> W_{456,564,645}$\\
$WI_{4a,5a,6a}$ are new.
}
...
\medskip
This result is INCORRECT: the Post cannot use $s1\_msg$, this variable is not available in state 220
...
\TODO{no yet checked (old version), or not yet fully validated ...:}
