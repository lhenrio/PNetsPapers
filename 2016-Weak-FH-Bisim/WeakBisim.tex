...
\\
\Pred=\bigwedge_{i=0}^n\Pred^1_i\land\Pred\,^2\subst{\biguplus_{i=0}^{n}\Post_i^1}\land (\bigwedge_{i=0}^m\Pred_i^3\subst{\Post^2})\subst{\biguplus_{i=0}^{n}\Post^1_i}\\
...
\\
\Pred_{OT}=\bigwedge_{i=0}^n\Pred^1_i\land\Pred\,^2\subst{\biguplus_{i=0}^{n}\Post_i^1}\land (\bigwedge_{i=0}^m\Pred_i^3\subst{\Post^2})\subst{\biguplus_{i=0}^{n}\Post^1_i}\\
\Post_{OT}=({x^3_k\gets (e^3_k\subst {\Post^2})\subst{\Post^1_i}})^{k\in K}
$
...
\end{mathpar}
\paragraph{2nd transition:} Concerning the middle open transition, we have
 \begin{mathpar}
     \openrule
         {
...
\openrule
         {
           \gamma_{j x y z}^{j\in J_{x y z}}, \Pred_{OT_{x y z}},({x_k\gets e_k})^{k\in K}}
         {t_{x y} \OTWeakarrow {\tau} t_{x y z}}
\\
\Pred_{OT_{x y z}}=\Pred_{OT_x}\land\Pred_{OT_{x y}}\subst{\Post_{OT_x}}\land (\Pred_{OT_{x y z}}\subst{\Post_{OT_{x y}}})\subst{\Post_{OT_x}}
}
{
\openrule
         {
		...
		\Pred_{OT_{x y z}},
				({x_k\gets (e_k\subst {\Post_{OT_{x y}}})\subst{\Post_{OT_{x}}}})^{k\in K} } 
...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{z\in Z}}
   \left( \forall j\in J_{x y z}. \gamma_j=\gamma_{j x y z}  \Rightarrow \Pred_{OT_{x y z}}
     ...
     \Pred_{s',t_{x y z}}\subst{\Post_{OT}}\subst{\Post_{OT_{x y z}}}\right)$
By knowing this:\\
...
(\Pred_{s,t} \land \Pred^1)\wedge\Pred^2\subst{\Post^1}\\
 \hspace{1cm} \implies\!\!\! \Big(\displaystyle{\bigvee_{x\in X}}
   \left( \forall j\in J_x. \vis{\beta^1_j}=\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     \land \alpha_x\!=\!\tau \land  
     \Pred_{s^1,t_x}\subst{\Post^1}\subst{\Post_{OT_x}}\right) \Big) \wedge\Pred^2\subst{\Post^1}   \\
\implies\\    
      $
