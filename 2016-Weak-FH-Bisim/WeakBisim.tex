...
\begin{example}
  Figure \ref{SimpleProtCounter:SpecOA-partial} show a partial view of the weak automaton of the simple protocol implementation.
  
\TODO{Explain the partial OA, and comment on building of WOT1}
\end{example}

\begin{figure}[t]
   \centerline{\includegraphics[width=12cm]{ATG/SPImplWeakOpen}}
  \caption{Weak Open Automaton, partial}
