...
INtiuition: tau is non observable if the automaton allows any tau transition from holes, and the global transition resulting from a tau in a hole is a tau transition not changing the action state.
...
Weak bisimulation can be alternatively defined as a strong bisimulation on the weak open automata, however this would still need a specific definition of strong bisimulation for weau open automata. \TODO{polish}
