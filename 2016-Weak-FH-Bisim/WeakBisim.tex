...
The pNets model is hierarchical in the structure of the processes, in contrast to the Statecharts formalism \cite{Harel:87}, which is widely used to model high-level behaviour,  that organises the states in a hierarchy. \LUDO{I moved this sentence here}
