...
\end{mathpar}
 ...
 \implies\!\!\!\displaystyle{\bigvee_{x\in X}}
   \big(\forall j\in J_x. \vis{\beta_j}=\gamma_{jx}\Rightarrow \Pred_{OT_x}
     \land \alpha\!=\!\alpha_x\land  
     \Pred_{s',t_x}\subst{\Post_{OT}}\subst{\Post_{OT_x}}\big)$\\
...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
  \!\! \left( \forall j\in J_x.\vis{\beta^1_j}=\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     ...
     \Pred_{s_1^1,t_x}\subst{\Post^1}\subst{\Post_{OT_x}}\right)$
...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{y\in Y}}
 \!\!  \left( \forall j\in J_{x y}. \vis{\beta^2_j}\!=\!\gamma_{jx y}\Rightarrow \Pred_{OT_{x y}}\!\land \alpha\!=\!\alpha_{x y} \land  
     \Pred_{s_1^2,t_{x y}}\subst{\Post^2}\subst{\Post_{OT_{x y}}}\right)$
...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{z\in Z}}
   \!\left( \forall j\in J_{xyz}. \vis{\beta^3_j}\!=\!\gamma_{j x y z} \! \Rightarrow\! \Pred_{OT_{x y z}}\!
     ...
     \Pred_{s^3_1,t_{x y z}}\subst{\Post^3}\subst{\Post_{OT_{x y z}}}\right)$
...
\\
\Pred=\Pred_{OT_x}\land\Pred_{OT_{x y}}\subst{\Post_{OT_x}}\land (\Pred_{OT_{x y z}}\subst{\Post_{OT_{x y}}})\subst{\Post_{OT_x}}
}
{
\openrule
         {
           \gamma_{j x}^{j\in J_{x}} \dotcup \gamma_{j x y}^{j\in J_{x y}}\dotcup\gamma_{j x y z}^{j\in J_{x y z}},
		\Pred, \Post_{OT_{x y z}}\subst {\Post_{OT_{x y}}}\subst{\Post_{OT_{x}}}}  
