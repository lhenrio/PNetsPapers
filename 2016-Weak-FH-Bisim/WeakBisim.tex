...
A relation over the states of two open automata  $<\!J,\mathcal{S}_1, s_0,V_1,
   \mathcal{T}_1\!>$ and $<\!J,\mathcal{S}_2,V_2,t_0, \mathcal{T}_2\!>$ has the form $\mathcal{R}=\{(s,t|\Pred_{s,t})\}$, it relates states of $\mathcal{S}_1$ and 
...
\begin{minipage}{0.69\linewidth} 	Suppose that
   ...
   \mathcal{T}_1\!>$ and $A_2 = <\!J,\mathcal{S}_2,V_2,t_0, \mathcal{T}_2\!>$
...
%\end{figure}
\RAB{In the above example, notations should be corrected once  figure \ref{SimpleProtCounter:ImplWOA} selected}
