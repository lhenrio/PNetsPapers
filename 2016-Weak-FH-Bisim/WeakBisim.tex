...
\paragraph{Note on finite versus infinite open automata:} as
...
the semantics of pNets, and used in the implementation. Then we define
...
bisimulations, implicitely refer to their \emph{structural} versions.
...
decidable (see \cite{henrio:Forte2016}). Formaly:
