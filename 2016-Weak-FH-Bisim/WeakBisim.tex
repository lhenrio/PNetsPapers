...
~\qquad\qquad\quad\bigwedge_{i=0}^{m_1}({\Pred^{1b}_i}\land \alpha^1_i=\beta^1_{ij_0}) \bigotimes_{j=0}^{i-1}\subst{\Post_j^1}\big)\land({\Pred^{2b}}\land \alpha^2=\beta^2_{j_0})	\bigotimes_{i=0}^{m_1}\subst{\Post_i^1}\land\\
~\qquad\qquad\quad\bigwedge_{i=0}^{m_2} ({\Pred^{3b}_i}\land \alpha^3_i=\beta^3_{ij_0})\big(\bigotimes_{j=0}^{i-1}\subst{\Post^3_j}\subst{\Post^2}  \bigotimes_{i=0}^{m_1}\subst{\Post_i^1}\big)
$\\		
Therefore, we have:\\
$\Pred\iff \Pred^a \wedge\\
~~\qquad\qquad\quad\displaystyle{\big(\bigwedge_{i=0}^{m_2}{\Pred_i^{3a}}\bigotimes_{j=0}^{i-1}\subst{{\Post_j^{3a}}}\subst{{\Post^{2a}}}\bigotimes_{j=0}^{m_1}\subst{{\Post_j^{1a}}}\big) \land}\\	
~\qquad\qquad\quad\bigwedge_{i=0}^{m_1}({\Pred^{1b}_i}\land \alpha^1_i=\beta^1_{ij_0}) \bigotimes_{j=0}^{i-1}\subst{\Post_j^1}\big)\land({\Pred^{2b}}\land \alpha^2=\beta^2_{j_0})	\bigotimes_{i=0}^{m_1}\subst{\Post_i^1}\land\\
~\qquad\qquad\quad\bigwedge_{i=0}^{m_2} ({\Pred^{3b}_i}\land \alpha^3_i=\beta^3_{ij_0})\big(\bigotimes_{j=0}^{i-1}\subst{\Post^3_j}\subst{\Post^2}  \bigotimes_{i=0}^{m_1}\subst{\Post_i^1}\big)
$		
