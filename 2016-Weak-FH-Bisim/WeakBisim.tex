...
to the two processes connected simply through a perfect medium. \RAB{ 
The pNet has a tree-like structure.  The root node of the tree {\it SimpleSystemSpec} is the top level of the pNet structure. It acts
as the parallel operator. It consists of tree nodes: two Holes $P$ and $Q$ and one subnet, noted {\it PrefectMedium}. Nodes of the tree are synchronized using four synchronization vectors, that  express the possible synchronization between the parameterized actions of a subset of the nodes. For instance, in the vector "$< p\_send(m),in(m),\_> \rightarrow \underline{in(m)}$ both $P$ and {\it PrefectMedium} nodes are involved in the synchronization. In particular, this means the synchronization between these processes occurs when  process $P$  performs $p\_send(m)$  action sending a message, and  the medium accepts the message through $in(m)$ action  at the same time. And the result that will be returned at upper level is the internal action  $\underline{in(m)}$.
}
...
\TODO{Add initialisation of state vars: done in Defn of OA}
...
Figure \ref{SimpleProtCounter:ImplOA} shows the full open automaton of the implementation $SimpleSystem$. Here, in the open automaton drawing, we use a user-friendly notation for the OTs, in the form ``$\{<actions of holes\} [<guard>] <action> \{assignments\}$''.
\TODO{comment on difference from Exemple 1 page 15; and predicate simplification...}
\begin{figure}[h]
...
{P|->p_send(m:sva_SV6:1:1)},
[(msg=m:sva_SV0:12:1)/\((s_recv(msg))=(s_recv(m:sva_SV0:12:1)))],   {s1_msg := msg, s1_c := 0}
	OT:1 ------------------------------------------------------------
		<s0_a0_r0>-----_in(m:sva_SV6:1:1)_----><s1_a0_r0>

INFO  SimpleProtImpl2 - 
{P|->p_a:sva_SV7:1:2},
[(forall:m:sva_SV7:1:2. (p_a:sva_SV7:1:2!=(p_send(m:sva_SV7:1:2)))],   {}
	OT:2 ------------------------------------------------------------
		<s0_a0_r0>-----p_a:sva_SV7:1:2----><s0_a0_r0>

INFO  SimpleProtImpl2 - 
{Q|->q_a:sva_SV9:1:4},
[(forall:m:sva_SV9:1:4,c:sva_SV9:1:4. (q_a:sva_SV9:1:4!=(q_recv(m:sva_SV9:1:4, c:sva_SV9:1:4)))],   {}
	OT:3 ------------------------------------------------------------
...
INFO  SimpleProtImpl2 - 
{},   [(s1_msg=m:sva_SV1:114:2)/\(s1_c=c:sva_SV1:114:2)
  /\((s_send(s1_msg, s1_c))=(s_send(m:sva_SV1:114:2, c:sva_SV1:114:2)))
  /\(msg=m:sva_SV1:114:2)/\(c=c:sva_SV1:114:2)
  /\((m_recv(msg, c))=(m_recv(m:sva_SV1:114:2, c:sva_SV1:114:2)))],
...
INFO  SimpleProtImpl2 - 
{},   [(a1_msg=m:sva_SV2:114:3)/\(a1_c=c:sva_SV2:114:3)
  /\((m_send(a1_msg, a1_c))=(m_send(m:sva_SV2:114:3, c:sva_SV2:114:3)))
  /\(msg=m:sva_SV2:114:3)/\(c=c:sva_SV2:114:3)
  /\((r_recv(msg, c))=(r_recv(m:sva_SV2:114:3, c:sva_SV2:114:3)))],
{r1_msg := msg, r1_c := c}
	OT:9 ------------------------------------------------------------
...
[(forall:m:sva_SV7:1:2. (p_a:sva_SV7:1:2!=(p_send(m:sva_SV7:1:2)))],   {}
	OT:11 ------------------------------------------------------------
		<s2_a0_r1>-----p_a:sva_SV7:1:2----><s2_a0_r1>

INFO  SimpleProtImpl2 - 
{Q|->q_recv(m:sva_SV8:1:3, c:sva_SV8:1:3)},
[(r1_msg=m:sva_SV5:18:6)/\(r1_c=c:sva_SV5:18:6)
  /\((r_send(r1_msg, r1_c))=(r_send(m:sva_SV5:18:6, c:sva_SV5:18:6)))],   {}
	OT:12 ------------------------------------------------------------
		<s2_a0_r1>-----_out(m:sva_SV8:1:3, c:sva_SV8:1:3)_----><s2_a0_r2>

INFO  SimpleProtImpl2 - 
{Q|->q_a:sva_SV9:1:4},
[(forall:m:sva_SV9:1:4,c:sva_SV9:1:4. (q_a:sva_SV9:1:4!=(q_recv(m:sva_SV9:1:4, c:sva_SV9:1:4)))],   {}
	OT:13 ------------------------------------------------------------
		<s2_a0_r1>-----q_a:sva_SV9:1:4----><s2_a0_r1>
...
[(forall:m:sva_SV7:1:2. (p_a:sva_SV7:1:2!=(p_send(m:sva_SV7:1:2)))],   {}
	OT:17 ------------------------------------------------------------
		<s2_a0_r2>-----p_a:sva_SV7:1:2----><s2_a0_r2>

INFO  SimpleProtImpl2 - 
{Q|->q_a:sva_SV9:1:4},
[(forall:m:sva_SV9:1:4,c:sva_SV9:1:4. (q_a:sva_SV9:1:4!=(q_recv(m:sva_SV9:1:4, c:sva_SV9:1:4)))],   {}
	OT:18 ------------------------------------------------------------
		<s2_a0_r2>-----q_a:sva_SV9:1:4----><s2_a0_r2>
