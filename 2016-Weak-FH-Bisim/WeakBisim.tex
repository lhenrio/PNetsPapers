...
$\displaystyle{\gamma_{kj} }=\displaystyle{\mybigdotcup_{i=n_k-1}^{0} \vis{\set{\beta_{1ij}}\subst{\bigotimes_{j=i-1}^{0}\!\!\!\Post''_{1j}}}\dotcup \vis{\set{\beta_{2j}}\subst{\bigotimes_{j=0}^{n_k-1}\!\!\!\Post''_{1j}}}} \dotcup\\
