...
pNet (named SimpleProtSpec2 in the code), that was drawn in Figure \ref{SimpleProt:Impl}, page \pageref{SimpleProt:Impl}. This code should be intuitive enough to read, with the following
...
All the following transitions are parameterised by an integer $n\in \mathcal{N}$, meaning they stand for the corresponding (infinite) set of weak OTs. 
