...
%where both a component and  its environment (other components) can be designed, by automata we find the theory of interface automata \cite {deAlfaro:2001} and conditional transition systems \cite{Beohar:2020}. Our formalism open automata is different from 
