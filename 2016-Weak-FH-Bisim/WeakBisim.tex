...
\end{figure}
 ...
 For readability, we do not include the full details of the Implementation weak open transitions in Figure \ref{SimpleProtCounter:ImplWOA2}, but we show some examples below and the full list is included in Appendix \ref{}.
...
$ WI_{8c}(n) = \openrule
         ...
         {210 \OTWeakarrow {\nounderline{\texttt{out(r\_msg,r\_ec)}\subst{(\texttt{r\_msg}\gets \texttt{s\_msg}, \texttt{r\_ec}\gets \texttt{s\_msg}+n)}}} 202}\forall n\ge 0
        $
