...
\begin{figure}[ht]
   \centerline{\includegraphics[width=10cm]{XFIG/SPSpecOpen}}
   \caption{Specification OA}
   \label{SimpleProtCounter:SpecOA}
\end{figure}
...
\end{figure}
    ...
    \begin{figure}[ht]
  \centerline{\includegraphics[width=10cm]{XFIG/SPImplOpen}}
  \caption{Open Automaton of the Simple Protocol Implementation}  \label{SimpleProtCounter:ImplOA}
\end{figure}
