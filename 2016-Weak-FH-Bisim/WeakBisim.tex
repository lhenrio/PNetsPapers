...
\Bigg)        
       \bigvee\\   
 \Big(\alpha = \tau \wedge  \overline{\gamma}=\emptyset \wedge \Pred =\True \wedge \Post =\Id(s)\wedge s=s'\Big)  \Longleftrightarrow  {
\openrule
         {
           \overline{\gamma},
		\Pred, \Post
...
\displaystyle{\overline{\gamma_3}=\mybigdotcup_{i=0}^{m_1} \vis{\overline{\beta^3_i}}},
...
\displaystyle{\overline{\gamma_2}=\mybigdotcup_{i=0}^{n_2} \vis{\overline{\beta^1_i}} \dotcup  \vis{\overline{\beta^2}}  \mybigdotcup_{i=0}^{m_2} \vis{\overline{\beta^3_i}}}
\\
...
\displaystyle{\overline{\gamma}=\mybigdotcup_{i=0}^{n_1+n_2} \vis{\overline{\beta^1_i}}
\dotcup\vis{\overline{\beta^2}}\dotcup\!\mybigdotcup_{i=0}^{m_1+m_2}\vis{\overline{\beta^3_i}}
}\\
\displaystyle{\Pred=\bigwedge_{i=0}^{n_2}\Pred^1_i\land\Pred\,^2\subst{ \biguplus_{i=0}^{n_2}\Post^1_i}\land \Big(\bigwedge_{i=0}^{m_2}\Pred\,^3_i\subst{\Post^2}\Big)\subst{\biguplus_{i=0}^{n_1}\Post^1_i}}
\\
\displaystyle{\Post= ({x^3_k\gets (e^3_k\subst {\Post^2})\subst{\biguplus_{i=0}^{n_2} \Post^1_i}})^{k\in K}}
\end{array}
\]
\end{itemize}
