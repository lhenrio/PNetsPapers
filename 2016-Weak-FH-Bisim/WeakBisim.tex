...
\openrule
 ...
 \end{mathpar}
So we need to prove that the following holds:\\
$\Pred_{s,t} \land \Pred\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{z\in Z}}
...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
 \! \! \left( \forall j\in J_x. \vis{\beta^1_j}=\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     \land \alpha_x\!=\!\tau \land  
     \Pred_{s_1^1,t_x}\subst{\Post^1}\subst{\Post_{OT_x}}\right)$\\
The conjunction with the term $\Pred^2\subst{\Post^1}$ of the both sides of the implication, we get:\\  
...
$\forall p\! \in\! [0..(n'-1)] Q\models{\openrule
			{
				(\beta^1_{pj})^{j\in J\cap\Holes(Q)}, {{\Pred_p^{1b}}},  
				{{\Post_p^{1b}}}}
...
$Q\models{\openrule
			{
				(\beta^2_j)^{j\in J\cap\Holes(Q)}, {{\Pred^{2b}}},  
				{{\Post^{2b}}}}
				{\ostate{v_{n'l}^{l\in L_Q}} \OTarrow {\alpha'_k}
				\ostate{v_{(n'+1)l}^{l\in L_Q}}}
				}%\]
$
and
$\forall p \in [(n'+1)..(n_k-1)]\,\, Q\models{\openrule
			{
				(\beta^3_{pj})^{j\in J\cap\Holes(Q)}, {{\Pred_p^{3b}}},  
				{{\Post_p^{3b}}}}
				{\ostate{v_{pl}^{l\in L_Q}} \OTarrow {\tau}
...
\\
\Pred^b_k=\Big(\!\!\!\bigwedge_{i=0}^{(n'-1)}\!\!
{\Pred_i^{1b}}\bigotimes_{j=0}^{(i-1)}\subst{{\Post_j^{1b}}}\Big)
\land\Big({\Pred^{2b}}\bigotimes_{i=0}^{(n'-1)}\subst{{\Post_i^{1b}}}\Big)\land\\
~\qquad\qquad\Big(\!\!\!\bigwedge_{i=(n'+1)}^{(n_k-1)}\!\!\!{\Pred_i^{3b}}\bigotimes_{j=n'+1}^{(i-1)}\subst{{\Post_j^{3b}}}\subst{{\Post^{2b}}}\bigotimes_{i=0}^{(n'-1)}\subst{{\Post_i^{1b}}}\Big)\\
\Post^b_k=\bigotimes_{i=(n'+1)}^{(n_k-1)}\!\!\!{\Post_i^{3b}}\Big(\subst{{\Post^{2b}}}\bigotimes_{i=0}^{(n'-1)}\subst{{\Post_i^{1b}}}\Big)
$\\
