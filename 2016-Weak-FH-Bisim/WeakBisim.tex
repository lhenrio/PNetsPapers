...
\begin{figure}[ht]
   \centerline{\includegraphics[width=9cm]{XFIG/SPSpecOpen}}
   \caption{Specification OA}
   \label{SimpleProtCounter:SpecOA}
\end{figure}
...
\begin{figure}[h]
   \centerline{\includegraphics[width=15cm]{ATG/SPSpecWeakOpen}}
...
\begin{figure}[h]
   \centerline{\includegraphics[width=10cm]{XFIG/SPSpecWeakOpen}}
