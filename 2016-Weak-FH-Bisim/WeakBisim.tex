...
$
Note that we added  the substitution $\subst{\Post_{OT_x}}$ on the right side of the implication without affecting the validity of the statement, because of the domain independence of the substitution. Hence a little rewriting gives:\\
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
\!\!   \left(\forall j\in J_x. \vis{\beta_{1j}}\!=\!\gamma_{jx}\Rightarrow \Pred_{OT_x}
     \!\land\! \alpha_x\!=\!\tau\land(\Pred_{s_{11},t_x}\wedge\Pred_2)\subst{\Post_1\shortotimes\Post_{OT_x}} \right)$\\
By replacing the inner sub-term $(\Pred_{s_{11},t_x}\wedge\Pred_2)$ by the conclusion of the corresponding implication given in case 2,  the formula becomes: \\
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
...
Again note that because of the domain independence of the substitution, we deleted $\subst{\Post_1}$, and  we  added  $\subst{\Post_{OT_{x y}}\shortotimes\Post_{OT_x}}$ on the right side of the implication.\\

Finally, by replacing $(\Pred_{s_{21},t_{xy}} \land  \Pred_3)$
by the conclusion of the corresponding implication given in case 3, we get:\\
...
\tau \!\land \alpha\!=\!\alpha_{x y} \land \alpha_{x y z}\!=\!\tau \land \Pred_{s_{31},t_{x y z}}  \subst{\underbrace{\Post_3\shortotimes\Post_2\shortotimes\Post_1}_{\Post_{OT}}\shortotimes \,\Post_{OT_{x y z}}\shortotimes \Post_{OT_{x y}}\shortotimes\Post_{OT_x}} \Big)$
