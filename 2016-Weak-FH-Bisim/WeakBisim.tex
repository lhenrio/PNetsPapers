...
These works use the term \emph{parameter} to designate systems where variables defining the system have a strong influence on their behaviour: in parametrised systems, parameters can typically influence the number of processes in the system or the way they interact.
...
pNets is a convenient model to model concurrent systems in a hierarchical and parametrised way. The coordination between processes is expressed as synchronisation vectors that allow the definition of complex and expressive synchronisation patterns.
