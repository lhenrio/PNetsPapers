...
For the sake of simplicity, a single tau open transition will be considered; however the proof may be easily generalized to the multiple tau open transitions by using the same reasoning and (\WTTrois)~rule. By  Definition \ref{def-Weak-bisim} we have for an open transition:
\begin{mathpar}
%\inferrule{
 \openrule
    {
       \set{\beta^1_i},\Pred^1_i,\Post^1_i   }
         {s^1 \OTarrow {\tau} s'^1} \in \mathcal{T}          
\end{mathpar}
there exist weak open transitions $\symb{WOT}_x^{x\in X} \subseteq \WT_2$:
 \begin{mathpar}
    \openrule
...
%\inferrule{
 \openrule
    {
       \set{\beta^3_i},\Pred^3_i,\Post^3_i   }
         {s^3 \OTarrow {\tau} s'^3} \in \mathcal{T}          
\end{mathpar}
there exist weak open transition $\symb{WOT}_z^{z\in Z} \subseteq \WT_2$:
 \begin{mathpar}
    \openrule
         {
...
\end{mathpar}
 such that  $\forall z,\{j\in J^3|\beta^3_j\neq\tau\}=J_{3}, (s'^3,t_z|\Pred_{s'^3,t_z})\in \mathcal{R}$. \\
 $\Pred_{s^3,t''} \land \Pred_i^3\\
...
\end{mathpar}
 there exist weak open transitions $\symb{WOT}_y^{y\in Y} \subseteq \WT_2$:
 \begin{mathpar}
    \openrule
         {
...
\end{mathpar}
 such that  $\forall x,\{j\in J^2|\beta^2_j\neq\tau\}=J_{x}, (s'^2,t_y|\Pred_{s'^2,t_y})\in \mathcal{R}$; \\
