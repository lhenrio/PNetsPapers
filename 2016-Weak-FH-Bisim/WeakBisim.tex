...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
  \!\! \left( \forall j\in J_x.\vis{\beta_{1j}}=\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     ...
     \Pred_{s_{11},t_x}\subst{\Post_1\uplus\Post_{OT_x}}\right)$
...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{y\in Y}}
 \!\!  \left( \forall j\in J_{x y}. \vis{\beta_{2j}}\!=\!\gamma_{jx y}\Rightarrow \Pred_{OT_{x y}}\!\land \alpha\!=\!\alpha_{x y} \land  
     \Pred_{s_{21},t_{x y}}\subst{\Post_2\uplus\Post_{OT_{x y}}}\right)$
...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{z\in Z}}
   \!\left( \forall j\in J_{xyz}. \vis{\beta_{3j}}\!=\!\gamma_{j x y z} \! \Rightarrow\! \Pred_{OT_{x y z}}\!
     ...
     \Pred_{s_{31},t_{x y z}}\subst{\Post_3\uplus\Post_{OT_{x y z}}}\right)$
...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}}\displaystyle{\bigvee_{z\in Z}}
   \left( \forall j\in J_{x y z}. \gamma_j=\gamma_{j x y z}  \Rightarrow \Pred_{OT_{x y z}}
     ...
     \Pred_{s',t_{x y z}}\subst{\Post_{OT}\uplus\Post\,}\right)$
...
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
  \!\! \left( \forall j\in J_x. \vis{\beta_{1j}}=\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     \land \alpha_x\!=\!\tau \land  
     \Pred_{s_{11},t_x}\subst{\Post_1\uplus\Post_{OT_x}}\right) \wedge\Pred_2\subst{\Post_1\uplus\Post_{OT_x}}  \\
$
Note that  on the right side of the implication we added  the substitution  of $\Post_{OT_x}$ without affecting the validity of the statement, because of the domain independence of the substitution. Hence a little rewriting gives:\\
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
\!\!   \left(\forall j\in J_x. \vis{\beta_{1j}}\!=\!\gamma_{jx}\Rightarrow \Pred_{OT_x}
     \!\land\! \alpha_x\!=\!\tau\land(\Pred_{s_{11},t_x}\wedge\Pred_2)\subst{\Post_1\uplus\Post_{OT_x}} \right)$\\
...
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
   ...
   ( \forall j\in J_{x y}. \vis{\beta_{2j}}\!\!=\!\!\gamma_{jx y} \\ \Rightarrow \Pred_{OT_{x y}}\land \alpha\!=\!\alpha_{x y}\! \land \Pred_{s_{21},t_{x y}}\subst{\Post_2\uplus\Post_{OT_{x y}}})\Big)\subst{\Post_1\uplus\Post_{OT_x}} \Big)$\\
Furthermore, the rewriting of the formula  gives:\\
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}} 
\Big(\forall j\in J_x. \vis{\beta_{1j}}\!\!=\!\!\gamma_{jx} \land  \forall j \in J_{x y}. \vis{\beta_{2j}}\subst{\Post_1\uplus\Post_{OT_x}} \!=\!\gamma_{jx y}  \Rightarrow\Pred_{OT_x} \land  \Pred_{OT_{x y}} \subst{\Post_1\uplus\Post_{OT_x}} \land \alpha_x\!=\!\tau \land \alpha\!=\!\alpha_{x y} \subst{\Post_1\uplus\Post_{OT_x}} \land \Pred_{s_{21},t_{x y}}\subst{\Post_2\shortotimes\Post_1\uplus \Post_{OT_{x y}}\uplus \Post_{OT_x}}\Big)$\\ 
