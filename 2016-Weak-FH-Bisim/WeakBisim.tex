...
\\
\set{\gamma}=\set{\gamma_1}\dotcup \set{\gamma_2}\subst{\Post_1}\oplus\set{\gamma_3}\subst{\Post_2\shortodot \Post_1}\\
...
\gamma_j^{j\in J}=&\mybigoplus_{i=0}^{m_1} \vis{\set{\beta_{1i}}\subst{\bigodot_{j=i-1}^{0}\!\! \Post_{1j}}}\oplus\\&  \vis{\set{\beta_2}\subst{\bigodot_{j=m_1}^{0}\Post_{1j}}} \oplus  
