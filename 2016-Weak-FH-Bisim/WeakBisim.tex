...
\end{mathpar}
we have $(s,t|\Pred_{s,t})\in\mathcal{R}$ by hypothesis and $s=s_{10}$. Thus, by  Definition \ref{def-Weak-bisim} we  can deduce there exist weak open transitions $\symb{WOT}_x^{x\in X} \subseteq \WT_2$:
 \begin{mathpar}
    \openrule
         {
           \gamma_{j x}^{j\in J_{x}}, \Pred_{OT_x},\Post_{OT_x}}
         {u \OTWeakarrow {\alpha_x} u_x}
\end{mathpar}
 such that  $\forall x,J_{x}=\{j\in J_1'|\beta_{1j}\neq\tau\}, u=t,  (s_{11},t_x|\Pred_{s_{11},u_x})\in \mathcal{R}$ and \\
...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
  \!\! \left( \forall j\in J_x.\vis{\beta_{1j}}=\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     ...
     \Pred_{s_{11},u_x}\subst{\Post_1\uplus\Post_{OT_x}}\right)$
...
\end{mathpar}
we have  $(s_{11},u_x|\Pred_{s_{11},u_x})\in \mathcal{R}$  and $s_{11}=s_{20}$. Again 
 by Definition \ref{def-Weak-bisim} we can deduce there exist weak open transitions $\symb{WOT}_{y}^{y\in Y} \subseteq \WT_2$:
 \begin{mathpar}
    \openrule
         {
           \gamma_{y}^{j\in J_{y}}, \Pred_{OT_{y}},\Post_{OT_{y}}}
         {u_x \OTWeakarrow {\alpha_{y}} v_{y}}
\end{mathpar}
 such that  $\forall y, J_{y}=\{j\in J_2'|\beta_{2j}\neq\tau\}, 
(s_{21},v_{y}|\Pred_{s_{21},v_{y}})\in \mathcal{R}$; \\
 $\Pred_{s_{11},u_x} \land \Pred_2\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{y\in Y}}
 \!\!  \left( \forall j\in J_{y}. \vis{\beta_{2j}}\!=\!\gamma_{jy}\Rightarrow \Pred_{OT_{y}}\!\land \alpha\!=\!\alpha_{y} \land  
     \Pred_{s_{21},v_{y}}\subst{\Post_2\uplus\Post_{OT_{y}}}\right)$
...
\end{mathpar}
From previous case, we have $(s_{21},v_{y}|\Pred_{s_{21},v_{y}})\in \mathcal{R}$, and we have $s_{21}=s_{30}$. Then, by
 Definition \ref{def-Weak-bisim} there exist weak open transition $\symb{WOT}_{x}^{z\in Z} \subseteq \WT_2$:
 \begin{mathpar}
    \openrule
         {
           \gamma_{jz}^{j\in J_{z}}, \Pred_{OT_{z}},\Post_{OT_{z}}}
         {v_{y} \OTWeakarrow {\tau} w_{z}}
\end{mathpar}
 such that  $\forall z, J_{z}= \{j\in J_3'|\beta_{3j}\neq\tau\}, 
(s_{31},w_{z}|\Pred_{s_{31},w_{z}})\in \mathcal{R}$,  $w_z=t_x$ and \\
 $\Pred_{s_{21},v_{y}} \land \Pred_3\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{z\in Z}}
   \!\left( \forall j\in J_{z}. \vis{\beta_{3j}}\!=\!\gamma_{jz} \! \Rightarrow\! \Pred_{OT_{z}}\!
     \land\! \alpha_{z}\!=\!\tau \land  
     \Pred_{s_{31},t_{x}}\subst{\Post_3\uplus\Post_{OT_{z}}}\right)$
...
\openrule
         {
           \gamma_{j x}^{j\in J_{x}}, \Pred_{OT_x},\Post_{OT_x}}
         {t \OTWeakarrow {\tau} u_x}
\qquad
\openrule
         {
           \gamma_{j y}^{j\in J_{y}}, \Pred_{OT_{ y}},\Post_{OT_{y}}}
         {u_x \OTWeakarrow {\alpha_{y}} v_{y}}
\qquad
\openrule
         {
           \gamma_{jz}^{j\in J_{z}}, \Pred_{OT_{z}}, \Post_{OT_{z}}}
         {v_{y} \OTWeakarrow {\tau} t_{x}}
\\ 
...
\Post= \Post_{OT_{x y z}} \shortotimes \Post_{OT_{x y}}\shortotimes\Post_{OT_{x}}\quad \alpha'_{x y}=\alpha_{y}\subst{\Post_{OT_x}}\\
}
{
\openrule
         {
...
The conjunction of the predicate $\Pred_2\subst{\Post_1}$ with the both sides of the implication, we get:\\  
...
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
   \!\!(\forall j\in J_x. \vis{\beta_{1j}}\!\!=\!\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     \land \alpha_x\!=\!\tau \land\Big(\displaystyle{\bigvee_{y\in Y}}(
    \forall j\in J_{y}. \vis{\beta_{2j}}\!=\!\gamma_{jy} \\ \Rightarrow \Pred_{OT_{y}}\land \alpha'\!=\!\alpha_{y}\! \land \Pred_{s_{21},t_{y}'}\subst{\Post_2\uplus\Post_{OT_{y}}}\Big)\subst{\Post_1\uplus\Post_{OT_x}})$\\
Furthermore, the rewriting of the formula  gives:\\
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}} 
(\forall j\in J_x. \vis{\beta_{1j}}\!\!=\!\gamma_{jx} \land  \forall j \in J_{y}. (\vis{\beta_{2j}}\!=\!\gamma_{jy})\subst{\Post_1\uplus\Post_{OT_x}}   \Rightarrow\Pred_{OT_x} \land  \Pred_{OT_{x y}} \subst{\Post_1\uplus\Post_{OT_x}} \land \alpha_x\!=\!\tau \land (\alpha'\!=\!\alpha_{y}) \subst{\Post_1\uplus\Post_{OT_x}} \land \Pred_{s_{21},t_{y}'}\subst{\Post_2\shortotimes\Post_1\uplus \Post_{OT_{y}}\shortotimes \Post_{OT_x}})$\\ 
As $Post_1$  does not act on $\gamma_{jy}$, nor on $ \Pred_{OT_{y}}$ and $  \alpha_{y}$, as well $\Post_{OT_x}$  does not act on $\alpha'$, nor on  $\beta_{2j}$ the formula can be simplified as follows:\\
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}} 
(\forall j\in J_x. \vis{\beta_{1j}}\!=\!\gamma_{jx} \land  \forall j \in J_{y}. \vis{\beta_{2j}}\subst{\Post_1}=\gamma_{jy} \subst{\Post_{OT_x}}  \Rightarrow\Pred_{OT_x} \land  \Pred_{OT_{y}} \subst{\Post_{OT_x}} \land \alpha_x =\tau \land \alpha'\subst{\Post_1}=\alpha_{y} \subst{\Post_{OT_x}} \land \Pred_{s_{21},t_{y}'}\\\subst{\Post_2\shortotimes\Post_1\uplus \Post_{OT_{y}}\shortotimes \Post_{OT_x}})$\\ 
...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}} 
\Big(\forall j\in J_x.\vis{\beta^1_j}\!=\!\gamma_{jx} \land  \forall j \in J_{y}. \vis{\beta_{2j}}\subst{\Post_1}\!=\!\gamma_{jy} \subst{\Post_{OT_x}}\Rightarrow \Pred_{OT_x}\land\Pred_{OT_{y}}\subst{\Post_{OT_x}} \land \alpha_x=\tau \land \alpha'\subst{\Post_1}= \alpha_{y} \subst{\Post_{OT_x}} \land \\(\Pred_{s_{21},t_{y}'} \land  \Pred_3) \subst{\Post_2\shortotimes \Post_1\uplus \Post_{OT_{y}}\shortotimes\Post_{OT_x}})$\\ 
Again note that because of the domain independence of the substitution, we removed $\Post_1$ and  we  added the term $\Post_{OT_{y}}\shortotimes\,\Post_{OT_x}$ in the substitution of the right side of the implication.\\
Finally, by replacing the predicate $(\Pred_{s_{21},t_{y}} \land  \Pred_3)$
...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}} \displaystyle{\bigvee_{z\in Z}} 
\Big(\forall\! j\in\! J_x.\vis{\beta_{1j}}\!=\!\gamma_{jx} \land  \forall j \!\in\! J_{y}.\vis{\beta_{2j}\subst{\Post_{OT_x}}}\!=\!\gamma_{jy} \subst{\Post_{OT_x}}  \land 
 \forall j\!\in\! J_{z}. \vis{\beta_{3j} \subst{\Post_2\,\shortotimes\,\Post_1}} \!=\!\gamma_{jz} \subst{\Post_{OT_{y}}\shortotimes\Post_{OT_x}}  \Rightarrow  \Pred_{OT_x}\land\Pred_{OT_{y}} \subst{\Post_{OT_x}} \land\\ 
  \Pred_{OT_{z}}\subst{\Post_{OT_{y}}\shortotimes\Post_{OT_x}} \land \alpha_x\!=\!
\tau \land \alpha'\subst{\Post_1}=\alpha_{y} \subst{\Post_{OT_x}}\land \alpha_{z}\!=\!\tau \land \Pred_{s_{31},t_{z}}  \subst{\underbrace{\Post_3\shortotimes\Post_2\shortotimes\Post_1}_{\Post_{OT}}\uplus \underbrace{\Post_{OT_{z}}\shortotimes \Post_{OT_{y}}\shortotimes\Post_{OT_x}}_{\Post}} \Big)$\\
Having $s_{31}=s'$ and $\alpha= \alpha'\subst{\Post_1}$ and rewriting the formula:\\ 
$\Pred_{s,t} \land \Pred_{OT}\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}} \displaystyle{\bigvee_{z\in Z}} 
(\forall j\in J. \vis{\beta_{1j}}\dotcup \vis{\beta_{2j}\subst{\Post_{OT_x}}}\dotcup \vis{\beta_{3j} \subst{\Post_2\,\shortotimes\,\Post_1}}=\\\gamma_{j x} \dotcup \gamma_{jy} \subst{\Post_{OT_x}}  \dotcup \gamma_{jz} \subst{\Post_{OT_{y}}\shortotimes\Post_{OT_x}} \Rightarrow  \Pred \land \alpha_x=
\tau \land \alpha =\alpha_{y}\subst{\Post_{OT_x}} \land\\ \alpha_{z}=\tau \land \Pred_{s',t_{x}}\subst{\Post_{OT}\uplus\Post\,}$\\
we can conclude:\\
