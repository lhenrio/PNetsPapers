...
\paragraph{Open and Compositional systems}

\TODO{retravailler le paragraphe ci dessous: faire ref a Facs-2013 (reconfig ds pNets) - virer 14 (probabilistic) ?}
In
...
\paragraph{Symbolic and data-sensitive systems}
...
The challenges here, in the context of uour symbolic systems, is not so much algorithmic complexity,
as was the case with classical weak bisimulation on finite models, but decidability and termination.
Two main directions should be explored, either with an explicite construction of the weak transition, but this step in
