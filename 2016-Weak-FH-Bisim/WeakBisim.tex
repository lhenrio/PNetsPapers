...
Thus we define $\vis{\set\beta}$\footnote{\ERIC{La notation
    $\vis{\beta}$ n'est pas tres parlante, mais je n'ai pas vraiment
    de meilleure idee...}} as the mapping $\set\beta$  with only observable actions but where each element is either empty or a list of length 1:
