...
We consider the case $n'=n+1$ (because $m'=m+1$ is similar).  We first focus on the left part of the disjunction. Let us consider the sequence of ($n+m+1$) open transitions: \TODO{sur cette page coorection non faite}
\begin{mathpar}
...
\end{mathpar}
we have $(s,t|\Pred_{s,t})\in\mathcal{R}$ by hypothesis, and $s=s_{10}$ the we have $(s_{10},t|\Pred_{s_{10},t})\in\mathcal{R}$. Thus, by  Definition \ref{def-Weak-bisim} we  can deduce there exist weak open transitions $\symb{WOT}_x^{x\in X} \subseteq \WT_2$:
 \begin{mathpar}
    \openrule
         {
           \gamma_{j x}^{j\in J_{x}}, \Pred_{OT_x},\Post_{OT_x}}
         {t \OTWeakarrow {\alpha_x} t_x}
\end{mathpar}
 such that  $\forall x,J_{x}=\{j\in J_1'|\beta_{1j}\neq\tau\}, (s_{11},t_x|\Pred_{s_{11},t_x})\in \mathcal{R}$. \\
 $\Pred_{s,t} \land \Pred_1\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
  \!\! \left( \forall j\in J_x.\vis{\beta_{1j}}=\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     \land \alpha_x\!=\!\tau \land  
     \Pred_{s_{11},t_x}\subst{\Post_1\shortotimes\Post_{OT_x}}\right)$
...
\end{mathpar}
\item Concerning the middle open transition in $\mathcal{T}_1$, we have:
 \begin{mathpar}
     \openrule
         {
           \beta_{2j}^{j \in J_2'},\Pred_2,\Post_2 }
...
\end{mathpar}
For each of the weak open transition obtained above, we have  $(s_{11},t_x|\Pred_{s_{11},t_x})\in \mathcal{R}$  and $s_{11}=s_{20}$, so we have  $(s_{20},t_x|\Pred_{s_{20},t_x})\in \mathcal{R}$. Again 
...
\end{mathpar}
 such that  $\forall x,\forall y, J_{xy}=\{j\in J_2'|\beta_{2j}\neq\tau\}, 
(s_{21},t_{x y}|\Pred_{s_{21},t_{x y}})\in \mathcal{R}$; \\
 $\Pred_{s_{11},t_x} \land \Pred_2\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{y\in Y}}
 \!\!  \left( \forall j\in J_{x y}. \vis{\beta_{2j}}\!=\!\gamma_{jx y}\Rightarrow \Pred_{OT_{x y}}\!\land \alpha\!=\!\alpha_{x y} \land  
     \Pred_{s_{21},t_{x y}}\subst{\Post_2\shortotimes\Post_{OT_{x y}}}\right)$


\item Similarly to the case 1,  the third  open transition in $\mathcal{T}_1$:
     \begin{mathpar}
%\inferrule{
 \openrule
    {
...
\end{mathpar}
From previous case, we have $(s_{21},t_{x y}|\Pred_{s_{21},t_{x y}})\in \mathcal{R}$, and we have $s_{21}=s_{30}$ then we have $(s_{30},t_{x y}|\Pred_{s_{30},t_{x y}})\in \mathcal{R}$. By
 Definition \ref{def-Weak-bisim} there exist weak open transition $\symb{WOT}_{x y z}^{x\in X,y\in Y,z\in Z} \subseteq \WT_2$:
 \begin{mathpar}
    \openrule
         {
...
\end{mathpar}
 such that  $\forall x, \forall y, \forall z,J_{xyz}= \{j\in J_3'|\beta_{3j}\neq\tau\}, 
(s_{31},t_{x y z}|\Pred_{s_{31},t_{x y z}})\in \mathcal{R}$. \\
 $\Pred_{s_{21},t_{x y}} \land \Pred_3\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{z\in Z}}
   \!\left( \forall j\in J_{xyz}. \vis{\beta_{3j}}\!=\!\gamma_{j x y z} \! \Rightarrow\! \Pred_{OT_{x y z}}\!
     \land\! \alpha_{x y z}\!=\!\tau \land  
     \Pred_{s_{31},t_{x y z}}\subst{\Post_3\shortotimes\Post_{OT_{x y z}}}\right)$
...
\\
\set{\gamma}=\gamma_{j x}^{j\in J_{x}} \dotcup \gamma_{j x y}^{j\in J_{x y}} \subst{\Post_{OT_x}} \dotcup\gamma_{j x y z}^{j\in J_{x y z}} \subst{\Post_{OT_{x y}}\shortotimes\Post_{OT_x}}\\
\Pred=\Pred_{OT_x}\land\Pred_{OT_{x y}}\subst{\Post_{OT_x}}\land \Pred_{OT_{x y z}}\subst{\Post_{OT_{x y}}\shortotimes\Post_{OT_x}}\\
\Post= \Post_{OT_{x y z}} \shortotimes \Post_{OT_{x y}}\shortotimes\Post_{OT_{x}}\quad \alpha'_{x y}=\alpha_{x y}\subst{\Post_{OT_x}}\\
}
{
\openrule
         {
           \set{\gamma},
		\Pred, \Post}  
         {t \OTWeakarrow {\alpha'_{x y}} t_{x y z}} 
} 
 \end{mathpar}
...
Let's start with the hypothesis we have:\\
...
Moreover, we have the following the statement:\\
$\Pred_{s,t} \land \Pred_1\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
 \! \! \left( \forall j\in J_x. \vis{\beta_{1j}}=\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     \land \alpha_x\!=\!\tau \land  
     \Pred_{s_{11},t_x}\subst{\Post_1\shortotimes\Post_{OT_x}}\right)$\\
The conjunction of the term $\Pred_2\subst{\Post_1}$ with the both sides of the implication, we get:\\  
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
  \!\! \left( \forall j\in J_x. \vis{\beta_{1j}}=\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     \land \alpha_x\!=\!\tau \land  
     \Pred_{s_{11},t_x}\subst{\Post_1\shortotimes\Post_{OT_x}}\right) \wedge\Pred_2\subst{\Post_1\shortotimes\Post_{OT_x}}  \\
$
Note that  on the right side of the implication we added  the substitution  of $\Post_{OT_x}$ without affecting the validity of the statement, because of the domain independence of the substitution \TODO{l'argument ne me convainc pas}. Hence a little rewriting gives:\\
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
\!\!   \left(\forall j\in J_x. \vis{\beta_{1j}}\!=\!\gamma_{jx}\Rightarrow \Pred_{OT_x}
     \!\land\! \alpha_x\!=\!\tau\land(\Pred_{s_{11},t_x}\wedge\Pred_2)\subst{\Post_1\shortotimes\Post_{OT_x}} \right)$\\
By replacing the inner sub-term $(\Pred_{s_{11},t_x}\wedge\Pred_2)$ by the conclusion of the  implication given in case 2,  the formula becomes: \\
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
 \hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}}
   \!\!\Big(\forall j\in J_x. \vis{\beta_{1j}}\!\!=\!\gamma_{jx}  \Rightarrow \Pred_{OT_x}
     \!\land\! \alpha_x\!=\!\tau \land\Big(\displaystyle{\bigvee_{y\in Y}}
   ( \forall j\in J_{x y}. \vis{\beta_{2j}}\!\!=\!\!\gamma_{jx y} \\ \Rightarrow \Pred_{OT_{x y}}\land \alpha\!=\!\alpha_{x y}\! \land \Pred_{s_{21},t_{x y}}\subst{\Post_2\shortotimes\Post_{OT_{x y}}})\Big)\subst{\Post_1\shortotimes\Post_{OT_x}} \Big)$\\
Furthermore, the rewriting of the formula  gives:\\
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}} 
\Big(\forall j\in J_x. \vis{\beta_{1j}}\!\!=\!\!\gamma_{jx} \land  \forall j \in J_{x y}. \vis{\beta_{2j}}\subst{\Post_1\shortotimes\Post_{OT_x}} \!=\!\gamma_{jx y}  \Rightarrow\Pred_{OT_x} \land  \Pred_{OT_{x y}} \subst{\Post_1\shortotimes\Post_{OT_x}} \land \alpha_x\!=\!\tau \land \alpha\!=\!\alpha_{x y} \subst{\Post_1\shortotimes\Post_{OT_x}} \land \Pred_{s_{21},t_{x y}}\subst{\Post_2\shortotimes\Post_1\shortotimes \Post_{OT_{x y}}\shortotimes \Post_{OT_x}}\Big)$\\ 
As $Post_1$  does not act on $\gamma_{jx y}$, nor on $ \Pred_{OT_{x y}}$ and $  \alpha_{x y}$, the formula can be simplified as follows:\\
$(\Pred_{s,t} \land \Pred_1)\wedge\Pred_2\subst{\Post_1}\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}} 
\Big(\forall j\in J_x. \vis{\beta_{1j}}\!=\!\gamma_{jx} \land  \forall j \in J_{x y}. \vis{\beta_{2j}}\subst{\Post_{OT_x}}\!=\!\gamma_{jx y}   \Rightarrow\Pred_{OT_x} \land  \Pred_{OT_{x y}} \subst{\Post_{OT_x}} \land \alpha_x\!=\!\tau \land \alpha\!=\!\alpha_{x y} \subst{\Post_{OT_x}} \land \Pred_{s_{21},t_{x y}}\subst{\Post_2\shortotimes\Post_1\shortotimes \Post_{OT_{x y}}\shortotimes \Post_{OT_x}}\Big)$\\ 
...
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}} 
\Big(\forall j\in J_x.\vis{\beta^1_j}\!=\!\gamma_{jx} \land  \forall j \in J_{x y}. \vis{\beta_{2j}}\subst{\Post_{OT_x}} \!=\!\gamma_{jx y} \Rightarrow \Pred_{OT_x}\land\Pred_{OT_{x y}}\subst{\Post_{OT_x}} \land \alpha_x\!=\!
\tau \land \alpha\!=\! \alpha_{x y} \subst{\Post_{OT_x}} \land (\Pred_{s_{21},t_{xy}} \land  \Pred_3) \subst{\Post_2\shortotimes \Post_1\shortotimes \Post_{OT_{x y}}\shortotimes\Post_{OT_x}} \Big)$\\ 
Again note that because of the domain independence of the substitution, we removed $\Post_1$ and  we  added  $\Post_{OT_{x y}}\shortotimes\,\Post_{OT_x}$ on the right side of the implication.\\
Finally, by replacing $(\Pred_{s_{21},t_{xy}} \land  \Pred_3)$
by the conclusion of the  implication given in case 3, we get:\\
$(\Pred_{s,t} \land \Pred_1)\land \Pred_2\subst{\Post_1} \land \Pred_3\subst{\Post_2\shortotimes\Post_1}\\
\hspace{1cm} \implies\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}} \displaystyle{\bigvee_{z\in Z}} 
\Big(\forall j\in J_x.\vis{\beta_{1j}}\!=\!\gamma_{jx} \land\!  \forall j \!\in\! J_{x y}.\vis{\beta_{2j}}\subst{\Post_{OT_x}}\!=\!\gamma_{jx y}   \land \\
 \forall j\!\in\! J_{x y z}. \vis{\beta_{3j}} \subst{\Post_{OT_{x y}}\shortotimes\Post_{OT_x}} \!=\!\gamma_{j x y z}  \Rightarrow  \Pred_{OT_x}\land\Pred_{OT_{x y}} \subst{\Post_{OT_x}} \land \\
  \Pred_{OT_{x y z}}\!\subst{\Post_{OT_{x y}}\shortotimes\,\Post_{OT_x}} \land \alpha_x\!=\!
\tau \!\land \alpha\!=\!\alpha_{x y} \subst{\Post_{OT_x}}\land \alpha_{x y z}\!=\!\tau \land \Pred_{s_{31},t_{x y z}}  \subst{\underbrace{\Post_3\shortotimes\Post_2\shortotimes\Post_1}_{\Post_{OT}}\shortotimes \,\Post_{OT_{x y z}}\shortotimes \Post_{OT_{x y}}\shortotimes\Post_{OT_x}} \Big)$\\
Having $s_{31}=s'$ we can conclude:\\
$(\Pred_{s,t} \land \Pred_1)\land \Pred_2\subst{\Post_1} \land \Pred_3\subst{\Post_2\shortotimes\Post_1}\\
\hspace{1cm} \implies\!\!\! \displaystyle{\bigvee_{x\in X}} \displaystyle{\bigvee_{y\in Y}} \displaystyle{\bigvee_{z\in Z}} 
\Big(\forall j\in J_{x y z}. \vis{\beta^1_j}.\vis{\beta_{2j}}\subst{\Post_{OT_x}}.\vis{\beta_{3j}}\subst{\Post_{OT_{x y}}\shortotimes\Post_{OT_x}} \!=\!\gamma_{j x y z} \Rightarrow  \Pred_{OT_x}\land\Pred_{OT_{x y}}\subst{\Post_{OT_x}} \land \Pred_{OT_{x y z}}\subst{\Post_{OT_{x y}}\shortotimes\Post_{OT_x}} \land \alpha\!=\!\alpha_{x y}\subst{\Post_{OT_x}} \land \Pred_{s',t_{x y z}}\subst{\Post_{OT}\shortotimes\Post_{OT_{x y z}}\shortotimes\Post_{OT_{x y}}\shortotimes\Post_{OT_x}} \Big)$\\
 \TODO{gamma ne me convainc pas et je dois generaliser}
