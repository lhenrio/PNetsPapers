...
In this configuration we can garanty that they are Weak Bisimilar, and merge their (incoming and outgoing) transitions in the Figure.
...
$ WI_{3c}(n) = \openrule
  ...
  {000 \OTWeakarrow {\underline{\texttt{in(m)}}} 201}
$
...
The next two  transitions show the same problem, as they include dependencies on $s1\_msg$:
