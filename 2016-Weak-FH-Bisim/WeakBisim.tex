...
$\alpha=\alpha'\displaystyle{\subst{\bigotimes_{j=m_1}^{0}\Post_{1j}}}$\\
%\begin{multline*}
$\gamma_j^{j\in J}=\displaystyle{\mybigdotcup_{i=0}^{m_1} \vis{{\beta_{1ij}^{j\in J_{1p}}}\subst{\bigotimes_{j=i-1}^{0} \Post_{1j} } }  \dotcup \, \vis{{\beta_{2j}^{j\in J_{2}}}\subst{\bigotimes_{j=m_1}^{0}\Post_{1j}}}} \\
~~\qquad~\dotcup \mybigdotcup_{i=0}^{m_2} \vis{\beta_{3ij}^{j\in J_{3p}} \subst{\bigotimes_{j=i-1}^{0}\Post_{3j}\shortotimes\Post_2\shortotimes\bigotimes_{j=m_1}^{0}\Post_{1j}}}$\\
%\end{multline*}
%\begin{multline*}
...
By definition of weak open transition (Definition~\ref{def:buildweakOT}),
 we obtain:
