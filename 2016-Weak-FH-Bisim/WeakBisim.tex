...
$
\TODO{from here simplify the double indices in beta and gamma}
...
\end{mathpar}
where for all $l\in L$:\\
\TODO{a reprendere avec la nouvelle decomp ; add the v of visible}
...
({\Pred_i^1}'\bigotimes_{i=0}^{i-1}\subst{{\Post_i^1}'})
\land{\Pred^2}'\bigotimes_{i=0}^{m_1}\subst{{\Post_i^1}'}\land (\bigwedge_{i=0}^{m_2}{\Pred\,^3_i}'(\bigotimes_{i=0}^{m_1}\subst{{\Post^1_i}'})\subst{{\Post^2}'}(\bigotimes_{j=0}^{i-1}\subst{{\Post^3_j}'}))\\
\Post'=(\bigotimes_{i=0}^{m_2}{\Post^3_i}')\subst{{\Post^2}'}\bigotimes_{i=0}^{m_1}\subst{{\Post^1_i}'}
$
...
\end{mathpar}
$\forall l. v_l=v_{0l} \wedge v_l'=v_{n_kl}$\\
