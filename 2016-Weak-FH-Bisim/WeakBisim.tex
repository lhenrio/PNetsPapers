...
\TODO{Define $\tau = \openrule{\{\}, True, ()}{xxx \OTWeakarrow {\tau} xxx}$}
...
Here we denote as $post_n$ the effect of the Strong transition $OT_n$ from Figure \ref{}:
\smallskip

$post_1 = post_2 = ()$

$post_3 = (s1\_c\gets 0, s1\_m\gets m)$

$post_4 = (m1\_msg\gets s1\_msg, m1\_c\gets s1\_c)$

$post_5 = (m2\_c\gets m1\_c)$

$post_6 = (s1\_c\gets m2\_c+1)$

$post_7 = (r1\_msg\gets m1\_msg, r1\_c\gets m1\_c)$

$post_8 = ()$
\medskip

Then the effect of one single $100 \rightarrow{4} 210 \rightarrow{5} 220 \rightarrow{6} 100$ loop as:
\smallskip

$Post_{456} = post_6\shortotimes post_5\shortotimes post_4$, that can be simplified as: $(s1\_c\gets s1\_c+1)$
\medskip

Iterating as: ${Post_{456}}^*$ =  $(s1\_c\gets s1\_c+n)$ for some $n\ge 0$
\medskip

Finaly WOT 3 has a substitution $\shortotimes {Post_{456}}^*\shortotimes\ post_3$ = $(s1\_c\gets 0+n)$
\medskip

and WOT 3' has $post_4\shortotimes {Post_{456}}^*\shortotimes\ post_3$
= $(m1\_msg\gets m, m1\_c\gets 0+n)$
\medskip

We can now define the weak OTs:
\smallskip

$ 1 = \openrule
{\{P\mapsto p\_a\}, [\forall m. p\_a \neq p\_send(m)], ()}
{000 \OTWeakarrow {\tau} 000}
$

$ 3 = \openrule
         {\{P\mapsto p\_send(m)\}, True, {Post_{456}}^*\shortotimes\ post_3}
         {000 \OTWeakarrow {\texttt{in(m)}} 100}$

$ 3' = \openrule
         {\{P\mapsto p\_send(m)\}, True, post_4\shortotimes {Post_{456}}^*\shortotimes\ post_3}
         {000 \OTWeakarrow {\texttt{in(m)}} 210}$

$ 4 = \openrule
         {\{\}, True, post_4\shortotimes {Post_{456}}^* }
...
$ 6 = \openrule
         {\{\}, True, {Post_{456}}^*\shortotimes post_6 }
         {220 \OTWeakarrow {\tau} 100}
         $

$ 7 = \openrule
         {\{\}, True, post_7\shortotimes {Post_{564}}^* }
         {220 \OTWeakarrow {\tau} 100}
         $
