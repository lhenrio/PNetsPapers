...
\TODO{A revoir pas correct!: From cases 1, 2 and 3 we have for all $k\in [0\ldots n]$, $\beta_{kj_0}=\alpha_k$. Moreover,} \\

We have: 
$\displaystyle{\gamma_{j_0}}=\mybigdotcup_{i=0}^{m_1}  \vis{\beta^1_{i{j_0}}} \dotcup  \vis{\set{\beta^2_i}} \dotcup \mybigdotcup_{i=0}^{m_2} \vis{\beta^3_{i{j_0}}}=[\alpha'_0.. \alpha'_n]$, indeed $\displaystyle{\gamma_{j_0}}$ is a a list of $\alpha_p$ such that $p\in [0..(n_1\!+\!n_2\!+\!1)] \land \alpha_p\neq \tau$.
...
For  $\gamma_{j_0}=[\beta_0..\beta_n]$ such that $\beta_i=\alpha'_i$ we have $n$ weak open transitions  $\symb{WOT}_k$ such that $k\in [0..n]$.
...
By replacing ${\Post^{1}_i}$,  $\Post^2$, and ${\Post^{3}_j}$ we obtain:\\
...
~~\qquad= \Post' \uplus \bigotimes_{j=0}^{n} \Post_j $\\
 where $n=m_1+m_2+1$	
\end{proof}
\TODO{Pour le post j'ai fait court, je n'ai pas developpe...?}
...
\[ P[Q]_{j_0}  
	...
	{\openrule
		{
			\beta_j^{(j\in J\setminus\{j_0\}) \uplus J_Q}, 
			\Pred^2\land\Pred^{2b}\land \alpha'_p=\beta_{j_0},  
