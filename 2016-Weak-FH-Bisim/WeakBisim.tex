...
transitivity of the strong FH-bisimulation on states of their Open Automata. Consider 3 open automata 
$\mathcal{T}_1$, $\mathcal{T}_2$, $\mathcal{T}_3$ and states $s^1$, $s^2$, $s^3$ in those 
