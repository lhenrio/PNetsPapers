...
Note that for all $k\in[0..n-1]$, $v_{kl}'=v_{(k+1)l}$, and $v_{0l}=s_{0l}=s_l$ and $v'_{nl}=v_{(n_1+n_2+3) l}=u_{(n_2+1) l} = s'_l$.
...
Consequently \[\alpha_{n_k}\displaystyle{\subst{\bigotimes_{j=n_k-1}^{0}\!\!\Post''_{j}}} =
...
&\iff\bigwedge_{i=0}^{m_1}\left(\Pred'_{1p}
		\land {\Pred''_{1p}}\land \alpha_{1p}=\beta_{1pj_0}\right)\subst{\bigotimes_{j=i-1}^{0}\!\!\Post_{1j}} \\
&\qquad\land\left(\Pred'_{2}
		\land {\Pred''_{2}}\land \alpha_{2}=\beta_{2j_0}\right)\subst{\bigotimes_{j=m_1}^{0}\!\!\Post_{1j}}\\
&\qquad\land\bigwedge_{i=0}^{m_2} \left(\Pred'_{3p}
		\land {\Pred''_{3p}}\land \alpha_{3p}=\beta_{3pj_0}\right) \subst{\bigotimes_{j=i-1}^{0}\!\!\Post_{3j}\shortotimes\Post_2\shortotimes\bigotimes_{j=m_1}^{0}\!\!\Post_{1j}}\\
...
&\qquad\land\bigwedge_{i=0}^{m_2} \Bigg(\Pred'_{3p} \subst{\bigotimes_{j=i-1}^{0}\!\!\Post_{3j}\shortotimes\Post_2\shortotimes\bigotimes_{j=m_1}^{0}\!\!\Post_{1j}} 
		\land {\Pred''_{3p}} \subst{\bigotimes_{j=i-1}^{0}\!\!\Post_{3j}\shortotimes\Post_2\shortotimes\bigotimes_{j=m_1}^{0}\!\!\Post_{1j}}  \\
		 & \qquad \land (\alpha_{3p}=\beta_{3pj_0}) \subst{\bigotimes_{j=i-1}^{0}\!\!\Post_{3j}\shortotimes\Post_2\shortotimes\bigotimes_{j=m_1}^{0}\!\!\Post_{1j}}\Bigg)  \\
...
with 
\begin{mathpar}
\set{\beta'_{1p}}=\gamma_{i j}^{j\in J_i}\uplus\vis{\beta_{1pj}^{j\in J_{1p}\setminus \{j_0\}}}\\
...
\[P[Q]_{j_0}\models\openrule
         {	\gamma_{m j}^{j\in J_m}\uplus\vis{\beta_{2j}^{j\in J_2\setminus \{j_0\}}},\Pred_2',\Post_2' }
         {\ostate{{s_{20j}}^{j\in L}\uplus s_{mj}^{j\in L_Q}}\OTarrow {\alpha'} \ostate{{(s_{21j})}^{j\in L}\uplus s_{(m+1)j}^{j\in L_Q}}}\]
with 
\begin{mathpar}
\Pred_{2}\,'=\Pred_{2}\land (\beta_{2j_0}=\alpha_m\land \Pred_m)
\\
%\forall j\in J_t,\,\gamma_j= \displaystyle{\mybigdotcup_{t=0}^n \gamma_{t j}}\text{\quad and\quad}
\Post_{2}\,'=\Post_{2}\uplus\Post_m
\end{mathpar}

\item and for the last $\tau$ OTs:
for $p\in [0..m_2]$. Either there is $i$ such that $p=n'_i$, and thus $\beta_i=\beta_{1 p j_0}$. In this case by Lemma~\ref{lem-Weakcompose1}, we have: 
...
Then, we have\\[-2ex]
	...
	{\openrule
		{
			\gamma_{i j}^{j\in J_i}\uplus\vis{\beta_{3pj}^{j\in J_{3p}\setminus \{j_0\}}}, 
			\Pred_{3p}\,',  \Post_{3p}\,'
			 }
...
with 
\begin{mathpar}
\Pred_{3p}\,'=\Pred_{3p}\land (\beta_{3pj_0}=\alpha_i\land \Pred_i)
\\
%\forall j\in J_t,\,\gamma_j= \displaystyle{\mybigdotcup_{t=0}^n \gamma_{t j}}\text{\quad and\quad}
\Post_{3p}\,'=\Post_{3p}\uplus\Post_i
\end{mathpar}
...
\alpha''=\alpha'\displaystyle{\subst{\bigotimes_{j=m_1}^{0}\Post'_{1j}}}\\
\displaystyle{
\set{\gamma'}=\mybigdotcup_{i=0}^{m_1} (\gamma_{i j}^{j\in J_i}\uplus\vis{\beta_{1pj}^{j\in J_{3p}\setminus \{j_0\}}})\subst{\bigotimes_{j=i-1}^{0} \Post_{1j}' }  
...
\TODO{I think the rest is useless (old proof sketch)}
