...
%	equations of a predicate.
	...
	sets, $I_2$ for subnets that are pLTSs, and $I_1$ for the others.
	...
	\noindent
    $\inferrule
    {k\!\in\! K \\SV_k \!=\! \SV{\alpha_m^{m \in I_1\uplus I_2\uplus J}}{\alpha'}{e_b} \\
...
\TODO{Eric: full result of the tool execution on the running
  example. Full ? certainly not, just a subset...}
...
Consider rule TR2 in 
	...
	\noindent
    $\inferrule
    {k\!\in\! K \\SV_k \!=\! \SV{\alpha_m^{m \in I_1\uplus I_2\uplus 
    J}}{\alpha'}{e_b} \\
    	Leaves(\mylangle \pNet_i^{i\in I}, \overline{\Sort}, \symb{SV}_k^{k\in 
    	K}\myrangle) \!=\! \pLTS_l^{l\in L} \\    	
    	\forall m\!\!\in\!\! I_1. {\pNet_m \models\inferrule*[myfraction=\reddottedrule]
...
the OT of $P$ let $I'= 
\biguplus I_m=I\setminus L_Q$, $J'=\biguplus J_m\uplus J
...
Let $I''=\biguplus_{m\in I} I_m \uplus I_Q = I' \uplus I_Q$ and $J''= \biguplus_{m\in I} 
