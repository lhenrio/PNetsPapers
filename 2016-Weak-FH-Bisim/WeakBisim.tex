...
\medskip
       	...
       	More precisely, $t_{px} \in ({t_p}')^{p\in P'}$ where $({t_p}')^{p\in 
       		P'}$ \TODO{Pas sure prime utile t, or p, or P ; SI:  $P\neq P'$ et 
       		les $t_p'$ sont pas les $t_p$}
       	is 
...
\end{small}
 ...
 \TODO{Ludo: switch the proof to new notations : s,t instead of 21 s2, and Pred s,t}
