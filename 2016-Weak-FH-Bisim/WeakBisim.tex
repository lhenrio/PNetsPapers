...
\begin{equation*}
\begin{split}
\Pred&g=\bigwedge_{p=0}^{m_1}\!\big(\Pred_{1p}\bigotimes_{j=p-1}^{0}\subst{\Post_{1j}}\big)\land\Pred^2\bigotimes_{p=m_1}^{0}\subst{\Post_{1p}}\land \bigwedge_{p=0}^{m_2}\!\Pred_{3p}\big(\!\!\bigotimes_{j=p-1}^{0}\subst{\Post_{3j}}\subst{\Post_2}\!\! \bigotimes_{p=m_1}^{0}\subst{\Post_{1p}}\big)
\\
