...
This is similar to the early and late symbolic bisimulation equivalences for value-passing CCS \cite{HENNESSY:1995}, though we use more general definitions in our setting.
...
Indeed, our definition uses both hypotheses on the behaviour of holes, as in \cite{deSimone85}, and symbolic manipulation of action expressions, as in symbolic bisimulations of \cite{HENNESSY:1995}. 
