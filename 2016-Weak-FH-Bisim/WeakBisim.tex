...
Here I denote as $post_n$ the effect of the Strong transition $OT_n$ from Figure \ref{}:
...
And $WOT_4$ becomes:
$$ 3 = \openrule
         {\{P\mapsto\texttt{p\_send(m)}\}, True, post_4\shortotimes {Post_{456}}^*\shortotimes\ post_3}
