...
to the two processes connected simply through a perfect medium. \TODO{Decrire syntaxe graphique}
...
Finaly, we list here, in raw format, the 12 OTs computed by the tool
\TODO{BUG! We should have 19 OTs...}:

\begin{lstlisting}[basicstyle=\scriptsize\ttfamily, language=java, frame=single]
INFO  SimpleProtImpl2 - 
	{P|->p_send(m:sva_SV6:1:1)},
	[(msg=m:sva_SV6:1:1)/\((in(msg))=(in(m:sva_SV6:1:1)))],
	{s1_msg := msg, s1_c := 0}
OT:1 ------------------------------------------------------------
...
INFO  SimpleProtImpl2 - 
	{P|->p_a:sva_SV7:1:2},
	[(forall:m:sva_SV7:1:2.
          (p_a:sva_SV7:1:2!=(p_send(m:sva_SV7:1:2)))],   {}
OT:2 ------------------------------------------------------------
	<s0_a0_r0>-----p_a:sva_SV7:1:2----><s0_a0_r0>

INFO  SimpleProtImpl2 - 
	{Q|->q_a:sva_SV9:1:4},
	[(forall:m:sva_SV9:1:4,c:sva_SV9:1:4.
          (q_a:sva_SV9:1:4!=(q_recv(m:sva_SV9:1:4, c:sva_SV9:1:4)))],   {}
OT:3 ------------------------------------------------------------
...
INFO   SimpleProtImpl2 - State variables:
...
===================
pLTS States: <s1 vars: { s1_c <-{0, s2_c+1, } s1_msg <-{msg, }}> <a0 vars: {}> <r0 vars: {}>

Global State: <s2_a1_r0>
===================
pLTS States: <s2 vars: {}> <a1 vars: { a1_msg <-{msg, } a1_c <-{c, }}> <r0 vars: {}>

Global State: <s2_a2_r0>
===================
pLTS States: <s2 vars: {}> <a2 vars: {}> <r0 vars: {}>

INFO  SimpleProtImpl2 - Total: 12 SATISFIABLE OTs
INFO  SimpleProtImpl2 -        122 UNSATISFIABLE OTs
INFO  SimpleProtImpl2 - Total Time: 657 ms
