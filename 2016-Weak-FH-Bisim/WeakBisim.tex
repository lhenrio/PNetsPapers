...
We need now to show that this set of WOT verify the lemma.

We have by 	hypothesis: 	$s_{0l}=s_l$, $s_{(n+1)l}=s'_l$ for all $l\inL_Q$
...
\\
\Pred_Q=\bigwedge_{h=0}^{k}\!\big(\Pred^1_h\bigotimes_{j=h-1}^{0}\subst{\Post_j^1}\big)\land \Pred^2\bigotimes_{h=k}^{0}\subst{\Post_h^1}\land\\~\qquad\qquad \bigwedge_{h=0}^{k'}\!\Pred_h^3\big(\bigotimes_{j=h-1}^{0}\subst{\Post^3_j}\subst{\Post^2}  \bigotimes_{h=k}^{0}\subst{\Post_h^1}\big)
\\
\Post_Q=\bigotimes_{h=k'}^{0}\Post^3_h\subst{\Post^2}\bigotimes_{j=k}^{0}\subst{\Post^1_j}
$
...
\left(Pred\land\Pred^2\land \alpha_Q=\beta_{j_0 }\right)\subst{\bigotimes_{i=k}^{0}{\Post_i^1}}\land\\\displaystyle
\bigwedge_{h=0}^{k'}{\Pred^3_h}\subst{\bigotimes_{i=h-1}^{0}{\Post_i^3}\shortotimes({\Post\uplus \Post^2})\shortotimes\bigotimes_{i=k}^{0}{\Post_i^1}}
\end{array}
\]

\[\Post_c=(\bigotimes_{i=k'}^{0}{\Post_i^3})\shortotimes({\Post\uplus \Post^2})\shortotimes\bigotimes_{i=k}^{0}{\Post_i^1}
\]
...
\Pred=\bigwedge_{p=0}^{m_1}\!\big(\Pred^1_p\bigotimes_{j=p-1}^{0}\subst{\Post_j^1}\big)\land\Pred^2\bigotimes_{p=m_1}^{0}\subst{\Post_p^1}\land \bigwedge_{p=0}^{m_2}\!\Pred_p^3\big(\!\!\bigotimes_{j=p-1}^{0}\subst{\Post^3_j}\subst{\Post^2}\!\! \bigotimes_{p=m_1}^{0}\subst{\Post_p^1}\big)\\
\Post=\bigotimes_{p=m_2}^{0}\Post^3_p\subst{\Post^2}\bigotimes_{j=m_1}^{0}\subst{\Post^1_j}
$\\
