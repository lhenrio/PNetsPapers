...
$\set{\gamma}_j=\displaystyle{\mybigdotcup_{i=0}^{m_1} \vis{\set{\beta_{1i}}\subst{\bigotimes_{j=i-1}^{0}\!\!\Post'_{1j}}}\dotcup  \vis{\set{\beta_{2}}\subst{\bigotimes_{j=m_1}^{0}\Post'_{1j}}}} \dotcup\\
...
$\forall p\! \in\! [0..n_1] Q\models{\openrule
			{
				(\beta'_{1pj})^{j\in J\cap\Holes(Q)}, {{\Pred''_{1p}}},  
				{{\Post''_{1p}}}}
				{\ostate{s_{pl}^{l\in L_Q}} \OTarrow {\alpha_{1p}}
				\ostate{s_{(p+1)l}^{l\in L_Q}}}
				}%\]
...
\end{mathpar}
$\alpha_k'=\alpha_{n_k}\displaystyle{\subst{\bigotimes_{j=n_k-1}^{n'{k-1}}\!\!\Post''_{p}}}$\\
