...
and $\displaystyle{\bigcup_{p=0}^nJ_{p}} = J\cap\Holes(Q)$, $\forall j\in J_p,\,\gamma_j= \displaystyle{\mybigdotcup_{p=0}^n \gamma_{p j}}$, $\forall l\in L_Q,\, s_{0l}=s_l$, $s_{(n+1)l}=s'_l$  \\
  $\Pred = \Pred\,'
		\land \displaystyle{\bigwedge_{p=0}^n}((\alpha_p= \beta_{pj_0}\land \Pred_p)\bigotimes_{i=p-1}^{0}\Post_i),\text{and~}$\\
$\displaystyle{\Post=\Post\,'\uplus\bigotimes_{p=n}^0
		\Post_p}$  \\
We have:\\
...
~~\qquad\qquad\qquad({\Pred'_2}\land {\Pred''_2}\land \alpha_2=\beta_{2j_0})	\bigotimes_{i=m_1}^{0}\subst{\Post_{1i}}\land\\
...
~~\qquad\qquad\quad\big(\bigwedge_{i=0}^{m_2}{\Pred'_{3i}}\bigotimes_{j=i-1}^{0}\subst{{\Post'_{3j}}}\subst{{\Post'_2}}\bigotimes_{j=m_1}^{0}\subst{{\Post'_{1j}}}\big) \land\\	
~\qquad\qquad\quad\bigwedge_{i=0}^{m_1}({\Pred''_{1i}}\land \alpha_{1i}=\beta_{1ij_0}) \bigotimes_{j=i-1}^{0}\subst{\Post_{1j}}\land({\Pred''_2}\land \alpha_2=\beta_{2j_0})	\bigotimes_{i=m_1}^{0}\subst{\Post_{1i}}\land\\
~\qquad\qquad\quad\bigwedge_{i=0}^{m_2} ({\Pred''_{3i}}\land \alpha_{3i}=\beta_{3ij_0})\bigotimes_{j=i-1}^{0}\subst{\Post_{3j}}\subst{\Post_2}  \bigotimes_{i=m_1}^{0}\subst{\Post_{1i}}
$\\		
Therefore, we have:\\
$\Pred= \Pred\,' \wedge \displaystyle{\bigwedge_{p=0}^{n}}((\alpha_p= \beta_{pj_0}\land \Pred_p)\bigotimes_{i=p-1}^{0}\Post_i)$\\ where $n=m_1+m_2+1$	\\
