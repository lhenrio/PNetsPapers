...
To illustrate this work, we use a simple communication protocol, that provides safe transport of data between two processes, over unsafe media. The alternating bit protocol was first described in \cite{Bartlett:1969}.  Our specification  of the ABP is based on the one given in \cite{Vergamini:1986}.
...
(s_{21},v_{b}|\Pred_{s_{21},v_{b}})\in \mathcal{R}$; \\
 $\Pred_{s_{11},u_a} \land \Pred_2\implies\\
...
(s_{31},w_{c}|\Pred_{s_{31},w_{c}})\in \mathcal{R}$ and \\
 $\Pred_{s_{21},v_{b}} \land \Pred_3\implies\\
...
\displaystyle{\bigvee_{a\in A}}
   \!\!(\forall j\in J_a. \vis{\beta_{1j}}\!\!=\!\gamma_{ja}  \land \Pred_{OT_a}
    ...
    \alpha'\!=\!\alpha_{2 b} \land\\ \Pred_{s_{21},v_{b}}\subst{\Post_2\uplus\Post_{OT_{b}}})\subst{\Post_1\uplus\Post_{OT_a}})$\\
