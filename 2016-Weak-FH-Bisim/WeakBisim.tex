...
Additionally, the Post renamings do not modify the predicates that only use non-renamed 
variables, and because of the domain of the renamings:\\
...
This allows us to conclude: using $\Pred\,'' = \bigvee_{p\in P} \Pred_p\land\Pred_p\,'$ 
and the assertions above we obtained the needed property.
