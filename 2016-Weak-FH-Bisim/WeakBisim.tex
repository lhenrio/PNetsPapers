...
\Pred=\bigwedge_{i=0}^{m_1}\big(\Pred^1_i\bigotimes_{j=0}^{i-1}\subst{\Post_j^1}\big)\land\Pred^2\bigotimes_{i=0}^{m_1}\subst{\Post_i^1}\land \bigwedge_{i=0}^{m_2}\Pred_i^3\big(\bigotimes_{i=0}^{m_1}\subst{\Post_i^1}(\subst{\Post^2}  \bigotimes_{j=0}^{i-1}\subst{\Post^3_i})\big)\\
\Post=\bigotimes_{i=0}^{m_2}\Post^3_i\big(\subst{\Post^2}\bigotimes_{i=0}^{m_1}\subst{\Post^1_i}\big)
$\\
...
$\forall j \in {j\in (J\cap\Holes(Q))},\,
\displaystyle{\gamma_{kj} }=\mybigdotcup_{i=0}^{(n'-1)}\!\!\vis{\beta^1_{ij}}\,\dotcup\,\vis{\set{\beta^2_j}}\,\dotcup\!\!\!\mybigdotcup_{i=(n'+1)}^{(n_k-1)}\!\!\!\vis{\beta^3_{ij}}
\\
...
\mbox{~~~~~~~~~~~~~~~~~~~~~~~~~~~~}\Big(\!\!\!\bigwedge_{i=(n'+1)}^{(n_k-1)}\!\!\!{\Pred^3_i}''\bigotimes_{i=0}^{(n'-1)}\subst{{\Post^1_i}''}\subst{{\Post^2}''}\Big)\bigotimes_{j=0}^{(i-1)}\subst{{\Post^3_j}''}\\
...
From cases 1, 2 and 3 we have for all $k\in [0\ldots n]$, $\beta_{kj_0}=\alpha_k$. Moreover, we have: $\displaystyle{\gamma_{kj_0} }=\mybigdotcup_{i=0}^{(n'-1)}\!\!\vis{\beta^1_{ij_0}}\,\dotcup\,\vis{\set{\beta^2_{j_0}}}\,\dotcup\!\!\!\mybigdotcup_{i=(n'+1)}^{(n_k-1)}\!\!\!\vis{\beta^3_{ij_0}}$ \TODO{?????}\\
