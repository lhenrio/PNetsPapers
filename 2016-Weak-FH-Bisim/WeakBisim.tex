...
%\begin{minipage}{\linewidth}
  ...
  \hspace{0.5cm}
 \includegraphics[width=4.5cm]{XFIG/TransportSchema}
  \caption{Schema and specification of the protocol }  \label{schema:enable-pnets}
%\end{minipage}
  \vspace{1cm}
%\begin{minipage}{6cm}
  \includegraphics[width=10cm]{XFIG/ABPSchema}
...
%         \right)
\end{mathpar}
 such that  $\forall x, J_1=J_{x}, (s',t_x|\Pred_{s',t_x})\in 
 \mathcal{R}$; 
 and  \\
 $\Pred \land \Pred_{OT}\\
...
\TODO{Ludo: define are equivalent : is in the relation les valeurs des variables des 
etats initiaux verifient le predicat associe aux etats initiaux}
 \end{definition}
...
satisfiability of the predicate relating the first state to the last one.
       	...
       	$\mathcal{T}_2$ relating $s$ and $u$, let $(t_p)^{p\in P}$ be this family.  
       	       	We have $\Pred\,'' = \bigvee_{p\in P} \Pred_p\land\Pred_p\,'$.
...
variable in $\mathcal{T}_1$.
       	...
       	Second, by definition of bisimulation we need (recall that $\Pred\,''$ is the 
       	...
       	We have, for all $p$
       	\begin{small}
       		$\Pred_p \land \Pred_{OT}\land\Pred_p\!'\\
       		\hspace{1cm} \implies\!\!\! \bigvee_{x\in X}
       		\left( \forall j. b_j=b_{jpx}  \Rightarrow \Pred_{OT_{px}}
       		\land v\!=\!v_{px} \land
       		\Pred_{{px}}\subst{\Post_{OT}}\subst{\Post_{OT_{px}}}\right)\land\Pred_p\!'\\
       		%
       		\hspace{1cm} \implies\!\!\! \bigvee_{x\in X}
       		\left( \forall j. b_j=b_{jpx}  \Rightarrow (\Pred_{OT_{px}}\land\Pred_p\!')
       		\land v\!=\!v_{px} \land
       		\Pred_{{px}}\subst{\Post_{OT}}\subst{\Post_{OT_{px}}}\right)\\
       		%
       		\hspace{1cm} \implies\!\!\! \bigvee_{x\in X}
