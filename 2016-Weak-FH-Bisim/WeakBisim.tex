...
\TODO{[LUDO->ERIC] D'accord: tu ecris comme tu connais le mieux le
  papier PEPM?}
\TODO{Ludo, tu peux relire, stp ?}
...
the semantics of pNets (see Def. \ref{def:operationalSemantics}), and used in the implementation. Then we define
