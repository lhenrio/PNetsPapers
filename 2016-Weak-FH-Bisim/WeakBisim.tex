...
\end{enumerate}
By using  Lemma \ref{lem-rel-OT-WOT} we can conclude from case 1 and 2 that we have:
\begin{mathpar}
		P\models{\openrule
			{
...
\TODO{We will add side conditions ?? }\\
Concerning $Q$ if it moves, for each  $\symb{OT}_p$ of $Q$ such that $p \in S$ and $S \subseteq [0\ldots (m_1\!+\!m_2)\!+\!1]$ in the form:
\begin{mathpar}
Q\models{\openrule
			{
...
\end{mathpar}
By rule (\WTTrois)  we can conclude that  we have:
\begin{mathpar}
Q\models{\openrule
			{
