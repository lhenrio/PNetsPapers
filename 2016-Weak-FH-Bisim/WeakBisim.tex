...
=J\cup{\displaystyle \bigcup_{i\in 
I}\Holes(\pNet_i)}\\
...
\overline{\Sort}\!, \overline{\symb{SV}}\myrangle) = {\displaystyle \bigcup_{i\in 
I}\Leaves(\pNet_i)}
\end{array}\]
\end{itemize}
\end{definition}
...
{\{s_{i}\xrightarrow{a_{i}}_i s_{i}'\}^{i\in I'_m},
	\{\xrightarrow{b_{j}}_j\}^{j\in J'_m}, \Pred_m, \Post_m}
{\ostate{s_{i}^{i \in L_k}} \OTarrow {v_m}
...
\end{small}
 ...
 { \ostate{s_{1 i}^{i \in L_P\uplus L}}\OTarrow {v} \ostate{{s'}_{1 i}^{i \in 
 			L_P\uplus 
 			L}}}\]
 ...
 P\models{\inferrule*[myfraction=\reddottedrule]
 	{\{s_i\xrightarrow{a_i}_i s_i'\}^{i\in I\setminus L},
 		...
 		\Pred\,',  
 		\Post'}
 	{\ostate{s_{1 i}^{i\in L_P}} \OTarrow {v}
 ...
 Q\models{\inferrule*[myfraction=\reddottedrule]
 	{\{s_i\xrightarrow{a_i}_i s_i'\}^{i\in I\cap L},
 		\{\xrightarrow{b_j}_j\}^{j\in J\cap\Holes(Q)}, \Pred\,'',  
 		\Post''}
 	{\ostate{s_{1 i}^{i\in L}} \OTarrow {v_Q}
 ...
 {\ostate{s_{2 i}^{i\in L'}} \OTarrow {v_x} \ostate{s_{2 i x}^{i\in L'}}}
 \end{mathpar}
 ...
 {\inferrule*[myfraction=\reddottedrule]
 	...
 	{\ostate{s_{2 i }^{i\in L'\uplus L_Q}} \OTarrow {v_x}
...
\\[-2ex]     
	...
	{\{s_i\xrightarrow{a_i}_i s'_i\}^{i\in I}, % , s^1_i,s^{1'}_i\in 
		%States(I_1)
		\{\xrightarrow{b_j}_j\}^{j\in J},\Pred_{OT},\Post_{OT}}
	{ \ostate{s_{1 i}^{i \in L\uplus L_Q}}\OTarrow {v} \ostate{{s'}_{1 i}^{i \in 
	L\uplus 
	L_Q}}}\]
Let $J'=J\setminus \Holes(Q) \cup \{j_0\}$.	 By 
	Lemma~\ref{lem-decompose} we have :\\[-2ex]
			\begin{mathpar}
				...
				{\{s_i\xrightarrow{a_i}_i s_i'\}^{i\in I\setminus L_Q},
					...
					\Pred\,',  
					\Post'}
				{\ostate{s_{1 i}^{i\in L}} \OTarrow {v}
					\ostate{s_{1 i}'^{\, i\in L}}}
			}\\
			Q\models{\inferrule*[myfraction=\reddottedrule]
				{\{s_i\xrightarrow{a_i}_i s_i'\}^{i\in I\cap L_Q},
					\{\xrightarrow{b_j}_j\}^{j\in J\cap\Holes(Q)}, \Pred\,'',  
					\Post''}
				{\ostate{s_{1 i}^{i\in L_Q}} \OTarrow {v_Q}
