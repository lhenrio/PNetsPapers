...
\TODO{change composition of post}
...
\TODO{les variables d un automate ou d un plts  cest les variables utilisees dans tous les etats de l automate}
...
\TODO{switch to variables of open automata instead of state variables + introduce automata}
...
A pLTS being its own single leave:
  $States(\mylangle S,s_0, \to\myrangle) = \{\triangleleft s \triangleright| s \in S, \}$. Formally, the state of a pNet is not reduced to one of its state, it also contains the value of its variables. This could be encoded as a mapping from variables of the pNet to expressions, of the form: $\sigma=\{x_i\to e_i\}^{i\in I},\,(x_i\in vars(S))$.
