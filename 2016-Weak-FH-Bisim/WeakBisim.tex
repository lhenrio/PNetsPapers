...
\\
\Pred_2=\bigwedge_{i=0}^{n_2}\Pred^1_i\land\Pred\,^2\subst{\Post_1}\land (\bigwedge_{i=0}^{m_2}\Pred\,^3_i\subst{\Post^2})\subst{\Post^1_i}
...
\\
\Pred=\bigwedge_{i=0}^{n_2}\Pred^1_i\land\Pred\,^2\subst{\Post_1}\land (\bigwedge_{i=0}^{m_2}\Pred\,^3_i\subst{\Post^2})\subst{\Post^1_i}
\end{mathpar}
...
\begin{mathpar}
\forall i \in [0\ldots m_1].\openrule
    {
       \overline{\beta^3_i},\Pred^3_i,\Post^3_i   }
         {s^3_i \OTarrow {\tau} s^3_{i+1}} \in \mathcal{T}         
\end{mathpar}
...
\begin{mathpar} 
s_2=s^3_0 \wedge s^1_{m_1}=s' \quad
\overline{\gamma_3}=\biguplus_{i=0}^{m_1} \vis{\overline{\beta^3_i}} 
\quad
\Pred_3=\bigwedge_{i=0}^{m_1}\Pred^3_i\quad \Post_3= \biguplus_{i=0}^{m_1} \Post_i^3
\end{mathpar}
