...
Let us build a relation
    ...
    $$ \delta(x_1)=\delta(y_1) \land acc(x_1)=acc(y_1)
       ...
       \section{Bisimulation is an equivalence: Proof of Theorem~\ref{thm-equiv}}
