...
paper of 66 pages)  because they are important to understand the paper and contain the proofs.
The other appendix  will be available as a research report, we keep
them in the submission to ease the work of the reviewers. 
Of course, depending on the opinion of the reviewers, we could also move more material to  the body of the paper, or remove more proofs from the published version and only keep them in the report for example.
