...
\input{macros.tex}         % Definitions of macros used in XFig figures
...
\begin{minipage}{6.1cm}
  ...
  \includegraphics[width=\linewidth]{Enable1}
  \\[1.3ex]
 \includegraphics[width=\linewidth]{Enable2}
  \caption{Two pNet encodings for  Enable }  \label{schema:enable-pnets}
\end{minipage}
  \hspace{2mm}
\begin{minipage}{6cm}
  \includegraphics[width=\linewidth]{P-QR}
...
\begin{figure}[t]
    \centerline{\includegraphics[width=0.8\linewidth]{rise4fun1}}
...
\begin{figure}[ht]
\centerline{ 
  \includegraphics[width=0.25\linewidth]{Enable1-aut}
  \hspace{25mm}
  \includegraphics[width=0.20\linewidth]{Enable2-aut}}
...
\begin{figure}[h]
  \begin{minipage}{2cm}
  \includegraphics[width=0.9\linewidth]{PQR-automaton}
  \end{minipage}
  \hspace{10mm}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{BIPspec-ArchFailureTimer-v2-2}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.9\columnwidth]{FailureTimerPNET-v2-2}
...
\begin{figure}[t]
  \centerline{\includegraphics[width=12cm]{FailureTimerOA-v2-2}}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\columnwidth]{BIPspec-DoubleArchFailureTimer-v2-2}
...
\begin{figure}[ht]
  \centering
  %% \includegraphics[width=0.9\columnwidth]{Double-OA}
