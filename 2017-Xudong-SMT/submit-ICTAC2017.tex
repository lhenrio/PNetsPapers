...
\QIN{
This CCS expression composing two operators, parallel and prefix. 
...
The input variables $v_1$, $v_2$ are the data transmitting between two components, 
...
encoding each operator. It is parameterized both at the level of
...
\QIN{[How about reduce the example of OT? But we still need keep the proof tree example.]}
