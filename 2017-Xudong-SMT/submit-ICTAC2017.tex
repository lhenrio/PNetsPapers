...
The prover we used, also is Z3, is developed by Microsoft Research
...
To sum up, from the pNet encoding LOTOS expression, inputed by the user, we
...
possible movements of the LOTOS example. They can exactly construct
the open automaton for the given example. 
