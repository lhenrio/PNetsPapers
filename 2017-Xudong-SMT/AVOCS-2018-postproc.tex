...
\short{Using an SMT engine to generate Symbolic Automata}
\author{ Xudong Qin\autref{1}\sponsor{This work was partially funded by the Associated Team FM4CPS between INRIA and ECNU, Shanghai},
  Simon Bliudze\autref{2}, Eric Madelaine\autref{3}, and Min Zhang\autref{4}} 
\institute{\autlabel{1} \email{steven\_qxd@126.com}\\
