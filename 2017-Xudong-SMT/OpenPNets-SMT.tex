...
Our contribution in the article is:
\begin{itemize}
\item We have refined the open automaton generation algorithm, to make
  ...
  \item parameterisation over the action algebra operators in the
    VerCors ECORE and library
  \item interaction with the Z3 SMT solver
    \item validation on several use-cases
\end{itemize}

\TODO{I have not described the items above after th efirst one, left
  it to you...} 
...
possible movement of the formula.   
