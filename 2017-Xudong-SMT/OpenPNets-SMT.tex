...
\begin{example} \emph{Using the operational rules to compute
  ...
  open transition $OT_2$ of \texttt{EnableCompL} (see example page
  \pageref{OT:enable-composed}).
...
%\begin{figure}[t]
%  \includegraphics[width=\linewidth]{XFIG/SMTLIB1}
...
\QIN{
\TODO{1. example input of Z3 in SMT-LIB 2. software architecture.}
}
