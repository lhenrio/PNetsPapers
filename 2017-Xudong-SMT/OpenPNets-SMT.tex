...
\QIN{There are several former papers already have illustrated many examples in closed pNets show that pNets can properly simulate the original construct. In this section, we encode the operators from other algebras into the pNets present the feature of the open pNet. They will be the running examples in the whole paper. }
