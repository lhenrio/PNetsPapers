...
\begin{figure}[h]
  \centerline{\includegraphics[width=12cm]{XFIG/LOTOSFormula.eps}}
...
$\begin{array}{@{}r@{}l@{}}
    ot_1  = &\openrule{\{0 \xrightarrow{l}_{C_1} 0\}, ~~\{\xrightarrow{hb_{11}}_P\}, ~~[hb_{11}=a_1 \!\land\! a_1\neq \delta(x) \!\land\! v_1=a_1]}
    {\ostate{00} \xrightarrow{v_1} \ostate{00}}\\
  \end{array}$

$\begin{array}{@{}r@{}l@{}}
    ot_2  = &\openrule{\{0 \xrightarrow{\delta}_{C_1} 1, 0 \xrightarrow{acc(x)}_{C_2} 1\}, ~~\{\xrightarrow{hb_{12}}_P\}, ~~[hb_{12}=\delta(x) \!\land\! v_2=\underline{\delta(x)}], ~~\{s_0 \xleftarrow{} 1\}}
    {\ostate{00} \xrightarrow{v_2} \ostate{01}}\\
  \end{array}$

$\begin{array}{@{}r@{}l@{}}
    ot_3  = &\openrule{\{0 \xrightarrow{l}_{C_1} 0\}, ~~\{\xrightarrow{hb_{13}}_P\}, ~~[hb_{13}=a_1 \!\land\! a_1\neq \delta(x) \!\land\! v_3=a_1]}
    {\ostate{01} \xrightarrow{v_3} \ostate{01}}\\
  \end{array}$

$\begin{array}{@{}r@{}l@{}}
    ot_4  = &\openrule{\{0 \xrightarrow{\delta}_{C_1} 1, 1 \xrightarrow{acc(x)}_{C_2} 1\}, ~~\{\xrightarrow{hb_{14}}_P\}, ~~[hb_{14}=\delta(x) \!\land\! v_4=\underline{\delta(x)}], ~~\{s_0 \xleftarrow{} 1\}}
    {\ostate{01} \xrightarrow{v_5} \ostate{01}}\\
  \end{array}$
  
  $\begin{array}{@{}r@{}l@{}}
    ot_5  = &\openrule{\{1 \xrightarrow{r}_{C_1} 1, 1 \xrightarrow{q}_{C_2} 1\}, ~~\{\xrightarrow{hb_{15}}_Q\}, ~~[hb_{15}=a_2 \!\land\! a_2\neq acc(x) \!\land\! v_5=a_2]}
    {\ostate{01} \xrightarrow{v_5} \ostate{01}}\\
  \end{array}$
