...
\thanks{This work was partially funded by the Associated Team FM4CPS between INRIA and ECNU, Shanghai}
\maketitle
...
\begin{proof}
  \TODO{I tentatively copied the proof here, from RR-8898. We should
...
\TODO{This is the original example from the Avocs paper}
...
\TODO{Here we have extended the FailureTimer architecture using time intervals,
