...
\paragraph{States:} for each of these, define $States: \langle OT\rangle\rightarrow\langle State\rangle$ which is the function computing the set of states in a
set of OTs. 
