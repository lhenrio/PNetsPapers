...
\end{itemize}
Consider the first  vector of $EnableState$, written as $\langle a_1, \text{-}, l\rangle\rightarrow a_1[\forall y_1. a_1\neq \delta(y_1)]$. It denotes a possible behavior of $P>>Q$, for any possible action of the hole $P$ that respects the vector predicate, that is, any action that does not match $\delta(y1)$, for any value of the variable $y1$.
