...
\ERIC{The original specification of the nanosatellite software, using BIP architecture patterns, was handling data in the BIP components behavior, but was not able to use data in the synchronisation between components. We have shown in \cite{BHM19:Coordination} how to overcome this limit, allowing data constraints in BIP architecture connectors, and providing an encoding of such architectures in terms of open pNets.}

Figure~\ref{schema:ArchFailure:BIP} shows this refined version of the
