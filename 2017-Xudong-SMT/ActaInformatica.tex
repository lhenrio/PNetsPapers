...
that when the fixed points are reached, then they are the same. 
...
inclusion of the fixed points $L_2^*\ \subseteq L_1^*$.

Suppose there exists an OT $l$ in $L_1^*$ that is not in $L_2^*$. This
means that $Pred(l,L_1^*)$ is satisfiable, but
$Pred(l,L_2^*)$ is not satisfiable, that is a contradiction; or as in the
