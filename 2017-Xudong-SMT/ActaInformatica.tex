...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{ActaXFIG/BIPspec-ArchFailureTimer-v2-1a}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.9\columnwidth]{ActaXFIG/FailureTimerPNET-v2-1a}
...
For this example, the tool (using Algorithm 1) builds 218 open transitions, whereof 206
are detected unsatisfiable by Z3.  The resulting open automaton, with
4 reachable global states (out of the possible 6) and 12 open
transitions, is shown in Fig.~\ref{schema:resultOA1}.

\begin{figure}[t]
  \centerline{\includegraphics[width=12cm]{ActaXFIG/FailureTimerOA-v2-1a}}
