...
\end{figure}
	...
	statements \texttt{exit} and \texttt{accept}. Both $\delta(x)$
	...
	composing 2 occurences of the EnableState pNet. In section
        \ref{section:use-case:Enable} we show how these encodings can
...
\begin{example}[Open transitions]
  ...
  trivialy true. The global states shows that controler $CState1$ has
...
In the conception of the Nano satellite Software \cite[], the Failure
