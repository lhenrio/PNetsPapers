...
action algebra is realized by the definition of an many-sorted ``algebra
...
inapplicable. Here we tried a
slighly bigger example, assembling 2 Failure controlers. In
