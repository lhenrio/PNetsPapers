...
Every time we choose a synchronization vector for matching, we clone it and use the cloned one. We construct the predicates using the constraint declared before 
\begin{algorithm}
\caption{Matching}
\begin{algorithmic}[1]
