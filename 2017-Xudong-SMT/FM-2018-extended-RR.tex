...
\title{Using SMT engine to generate Symbolic Automata - Extended version\thanks{This work was partially 
...
Before:
\ERIC{Also this OT is not the real original one (as in RoughResult.log), pieces have already been simplied...}
