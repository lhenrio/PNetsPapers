...
\newcommand{\noteSB}[2][color=green!40, size=\tiny]{\todo[#1]{{\bf Note: } {#2}}}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\columnwidth]{XFIG/FailureTimerPNET}
  \caption{pNet encoding of the FailureTimer architecture}
  \label{schema:ArchFailure:pNet}
\end{figure}


\noteSB{SV2 should not be closed;\\SV0, SV1: $\cup \rightarrow \lor$}\hl{%
%
