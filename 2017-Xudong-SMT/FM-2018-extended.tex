...
%
  \hl{We omit detailed presentation of this case for the sake of brevity.}
%
}
...
\noteSB{Is this still relevant or has it been replaced by the Failure Monitor example?}%
\hl{tested the algorithm on available examples, such as encoding expressions from various process algebras}.
%
\noteSB{New text}%
%
\hl{%
%
In this paper, we used an additional running example, based on a BIP
...
successfully identifies \noteSB{Is this, indeed, the case?}\hl{all} unsatisfiable open transitions and that
