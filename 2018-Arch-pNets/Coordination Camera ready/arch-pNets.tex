...
\newCoord{The red dotted rule somehow expresses an implication, stating that if actions of the holes perform the designed actions and the condition is verified, then the variables are modified and the state changes. This implication however  uses a simple logic with the 
