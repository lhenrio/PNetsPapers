...
The parameters of actions that appear on pLTS transitions are either input variables, bound when the action occurs, or expressions using the value of other (i.e. output) variables.
...
The red dotted rule expresses an implication, stating that if actions of the holes perform the designed actions and the condition is verified, then the variables are modified and the state changes. This implication however occurs in a restricted logic with predefined syntax, at a different logical level compared to  a classical
...
\add{Model-checking of open-automaton is out of the scope of this paper,
