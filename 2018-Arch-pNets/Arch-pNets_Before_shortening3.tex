...
\addSB{This section presents the extension of the theory of
...
%
  ...
  \defn{im}).  In the context of this paper, we can simplify
...
\addSB{In addition to interaction models, BIP relies on the so-called
  \emph{priority models}, imposing a strict partial order on
...
%
In the results and the running example of this paper, we will implicitly assume application of the so-called \emph{maximal
...
In \secn{conclusion}, we discuss the possibility of generalising the
