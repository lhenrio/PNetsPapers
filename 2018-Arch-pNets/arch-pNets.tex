...
%
$\NameCtrl$ and $\NameTimer$, with interfaces
\[\bigl(
\{\mathit{zone}\},
...
\cstate{1}, \cstate{2}$, for $\NameCtrl$, and $\tstate{0}$, for
...
omitted.  The default values are the constant predicate $\true$ and
the empty assignment {\emptyassign}, respectively.  The initial states
