...
%
  \begin{multline*}
    ...
    \\
    \begin{aligned}
      \exists \bigl(q^1_C \goesto{b_1 \cap P_C, g^{b_1}_C, e^{b_1}_C}\bigr)^{C \in \supp{b_1} \cap \cC_1}:
      & \quad \left.
...
%
  \begin{multline*}
    ...
    \exists (q^2_C)^{C \in (\supp{b_2}\setminus\supp{a_2}) \cap \cC_2}:
            ...
            \\
            \left.
            \exists \bigl(q^2_C \goesto{b_2 \cap P_C, g^{b_2}_C, e^{b_2}_C}\bigr)^{C \in \supp{b_2} \cap \cC_2}:
            h_2 \land
