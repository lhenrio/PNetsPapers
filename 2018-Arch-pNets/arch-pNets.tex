...
\emph{data expressions} $\exprs{\variables}$; $e_i$ ranges over boolean expressions, and a set of \emph{Boolean
expressions} 
...
\]
to denote the set of \emph{variable assignments}.  $u$ ranges over sets of assignments.
