...
\keywords{Verification, composition, safety, interaction
  models.}
\end{abstract}
...
Wwe propose   to encode BIP architectures
into open pNet and to verify, using SMT techniques,
the coordination capabilities of the architecture, and 
its properties. The encoding will  give us feedback on the
...
expressed in the two formalisms. This  also gives the opportunity
to
% investigate further on  compositional verification by
relate two  different
visions on compositional verification. 
...
With pNets, we can define a behavioural semantics for distributed components~\cite{AmeurBoulifa2017} where correctness properties are verified by model-checking. 
...
Basic models for data-sensitive infinite systems: Hennesy \& Lin's value-passing systems with assignments \cite{CONCUR::Lin1996,HennessyL1995:353,APSEC::Lin2001}

various classe infinite-state systems and/or paramaterized topologies
via predicate abstraction and SMT satisfiability:
\cite{BruniEtAl-Tiles-Concur2000,DBLP:conf/cade/GhilardiNRZ08,DBLP:journals/corr/CimattiGMT13,DBLP:journals/corr/abs-1806-11459}
