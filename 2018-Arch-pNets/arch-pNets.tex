...
\begin{example}\emph{An open-transition.}
  ...
  \todoEM{Commenter...
  Questions: les $\alpha$ n'apparaissent pas dans l'archi Bip; la
  synchro des initialisations non plus... OT3 est un peu plus facile a
  expliquer (;-).}
  The \texttt{Failure TimerMonitor} pNet of \Fig{FailureTimer:pNet} has 2 controllers 
  and 2 holes. Two of its possible open-transitions are:
