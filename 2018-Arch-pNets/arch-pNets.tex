...
by the initial valuation $\val{0}{C}$ of $C$ and 2)~associate an
additional Boolean value to each port, with original transitions of
$C$ marked by $\true$ and additional loop transitions marked by
$\false$.
