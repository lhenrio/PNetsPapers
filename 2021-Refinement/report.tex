...
This allows us to define the simultaneous composition \(A\psubst{A_j^{j \in J'}}\) as the result of any order of (sequential) composition where each \(A_j\) is composed in the hole \(j\). % psubst to pcomp macro [[]]
