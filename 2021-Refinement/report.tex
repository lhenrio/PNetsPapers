...
\begin{proof}
	...
	\begin{gather}
		J_1 \cup J_3 \setminus \mbrc{k} = J_2 \cup J_3 \setminus \mbrc{k} \goal{1a} \\
		\sigma_{013} \uplus \sigma_{023} \vdash R\mpar{s_{013}, s_{023}} \goal{1b}
	\end{gather}\vspace{-1cm}
	\begin{multline}
		\forall \mpar{s_{13}, s_{23}} \in S_{13} \times S_{23}, \\
		\mpar{\everymath{\displaystyle}\begin{array}{l}
			...
			\nwedge V_{13} \uplus V_{23} \uplus \fvars{t_{13}} \vdash R\mpar{s_{13}, s_{232}} \wedge g_{13} \implies \operatorname*{\bigsymb{\bigvee}}_{x \in X} \mpar{\begin{array}{l}
			...
			\end{array}}
		\end{array}} \\
		\wedge V_{13} \uplus V_{23} \uplus \biguplus_\subbox{t_{23} \in \fOT{s_{23}}} \fvars{t_{23}} \vdash R\mpar{s_{13}, s_{23}} \wedge \bigvee_\subbox{t_{23} \in \fOT{s_{23}}} \fguard{t_{23}} \implies \bigvee_\subbox{t_{13} \in \fOT{s_{13}}} \fguard{t_{13}} \goal{1c}
	\end{multline}
	\goal{1a} is proved by rewriting using the hypothesis \(J_1 = J_2\) from the simulation.
	For \goal{1b} we use the fact that \(R_{12}\) relates inital configurations:
	\begin{align*}
	...
	\end{align*}
	Let \(s_{13} \defobject \mpar{s_1, s_{31}} \in S_{13}\) and \(s_{23} \defobject \mpar{s_2, s_{32}} \in S_{23}\).
	The goals left to prove are
	\begin{align*}
		& \bigsymb{\forall} t_{13} \defobject \OTx{13}{}{13}{13} \in \fOT{s_{13}}, \bigsymb{\exists} \mpar{t_{23x} \defobject \OTx{23}{x}{23x}{23x} \in \fOT{s_{23}}}^{x \in X}, \\
		& \quad \mpar{\forall x \in X, J'_{23x} \cap J_{13} = J'_{13} \cap J_{23}} \\[-10pt]
		& \nwedge V_{13} \uplus V_{23} \uplus \fvars{t_{13}} \vdash R\mpar{s_{13}, s_{232}} \wedge g_{13} \Rightarrow \operatorname*{\bigsymb{\bigvee}}_{x \in X} \mpar{\!\!\everymath{\displaystyle}\begin{array}{l}
			\alpha_{13} = \alpha_{23x} \wedge \bigwedge_\subbox{j \in J'_{23x} \cap J_{13}} \beta_{13j} = \beta_{23xj} \\[12pt]
			\nwedge g_{23x} \wedge R\mpar{s'_{13}, s'_{23x}}\psubst{\psi_{13} \uplus \psi_{23x}}
		\end{array}\!\!} \goal{2}
	\end{align*}
	\[ V_{13} \uplus V_{23} \uplus \biguplus_\subbox{t_{23} \in \fOT{s_{23}}} \fvars{t_{23}} \vdash R\mpar{s_{13}, s_{23}} \wedge \bigvee_\subbox{t_{23} \in \fOT{s_{23}}} \fguard{t_{23}} \implies \bigvee_\subbox{t_{13} \in \fOT{s_{13}}} \fguard{t_{13}} \goal{3} \]
\item[\goal{2}:] % TODO: introduce t_... then hyps
\item[\goal{3}:] % TODO: introduce hyps
\end{proof}
...
\begin{proof}
	Let \(A_1 \defobject \OAg[1]\) and \(A_2 \defobject \OAg[2]\) be open automata.
	Let \(k \in J_1\) and \(A \defobject A_1\subst{A_2}{k}\).
	Let \(\reach{A}\) be a witness that \(A\) is non-locking.
	The idea for the relation on configurations is that the copy of \(A_1\) in \(A\) do the same things as if we were to try proving reflexivity.
	We pose
	\[ R \defobject \mpar{\mpar{s_1, s_2}, s'_1} \mapsto \choice{\bigwedge_{v \in V_1} v = v' & \text{if } s_1 = s'_1 \\ \bot & \text{otherwise}} \]
	% TODO: proove A \leq A_1
\end{proof}
...
\item[\goal{3}:] Let \(\sigma_1: V_1 \uplus \fvars{t_1} \to \values\) and \(\sigma_3: V_3 \to \values\).
	...
	\end{align}
	\goal{3a} is proved by transitivity using \hyp{5a} and \hyp{5a}.
	\goal{3b} is proved using \hyp{5b} and \hyp{6b}, but depending on \(\triangle\) the equality are obtained for the interesting values \(j\) using either \hyp{2} and \hyp{2'} or \hyp{3} and \hyp{3'}.
	\goal{3c} is exactly \hyp{6c}.
	We prove \goal{3d} with valuation \(\psi_{s2x}\psubst{\sigma_2 \uplus \nu_2}\) for the branch \(s_2\) using \hyp{5d} and \hyp{6d}:
	\begin{align*}
