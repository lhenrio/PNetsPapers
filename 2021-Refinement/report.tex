...
There are also similar work, introducing refinement relations, on other models than open automata.
...
For the open automata refinement, the transitivity property becomes \(\wrel{A}{B}{X} \wedge \wrel{B}{C}{Y} \implies \wrel{A}{C}{X \cap Y}\).
...
Some have to be slightly modified for the open automata refinement because of the tracked holes set.
...
\end{proof}
\begin{thm}[Context refinement] Open automata refinement is context refining when the composition happens in a tracked hole. \end{thm}
\begin{proofsketch}
