...
\begin{defi}[Pre-simulation on open automata] % TODO: Is the definition satifying now?
...
\begin{defi}[Deadlock reduction, intuitive definition] % TODO HERE: repasser a un implique
...
Let  \(A \defobject A_p\subst{A_c}{k} = \OA{S}{s_0}{V}{\sigma_0}{J}{T}\) be the composition of \(A_c \defobject \OA{S_c}{s_{0c}}{V_c}{\sigma_{0c}}{J_c}{T_c}\), in the hole \(k \in J_p\) of \(A_p \defobject \OA{S_p}{s_{0p}}{V_p}{\sigma_{0p}}{J_p}{T_p}\).
...
\section{Example of deadlock introduced by composition and requirements of non-locking composition}\ref{apx:lockcomp}
