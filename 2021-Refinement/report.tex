...
\end{align*}
It is an alternative implementation of the enable operator which is FH-bisimilar to the previous one \cite{henrio:01299562}. \Ludo{makes no sense: FH bisimlar is still undefined, neither formally nor informally}
...
\Ludo{je comprends ps cette phrase:} In a run, when taking effective transitions (without local variables), its value is not substituted with a closed term.
