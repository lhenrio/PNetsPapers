...
The composition makes 12 states from the \(R\) state, these states are in \(\mbrc{R} \times \mbrk{1; 6} \times \mbrc{S, C}\), however only \(\mpar{R, 1, S}\) and \(\mpar{R, 2, C}\) are reachable so we will only consider these two.
