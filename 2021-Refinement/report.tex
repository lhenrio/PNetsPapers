...
\item[\goal{2}:] Let \(\sigma: V \uplus V_1 \uplus \fvars{t} \to \values\).
	...
	\end{align*}
	For the left side we use the preservation of reachability across transitions:
...
\item[\goal{2}:] Let \nmm{\sigma: V \uplus V_2 \uplus \fvars{t} \to \values}.
	...
	For the right side we use the preservation of reachability across transitions:
...
Let \(v_3 \mapsto v_{3x}\) is the renaming for \(v_3 \in V_3\) in \(A_{x3}\).
...
\item[\goal{2}:] Let \(\sigma: V_{13} \uplus V_{23} \uplus \fvars{t_{13}} \to \values\).
	...
	For the middle part we use the preservation of reachability across transitions:
...
Let \(v_1 \mapsto v_{1x}\) is the renaming for \(v_1 \in V_1\) in \(A_{x1}\).
