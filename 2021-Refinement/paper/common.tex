...
% third argument is the hole subscript (should be the same as the first argument in most cases)
% last argument is the hole set subscript (should be the same as the second argument in most cases)
