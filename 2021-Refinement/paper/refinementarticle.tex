...
And secondly, because the domain of the substitution function is disjoint from the others, it has an effect only on the related elements, and relying on the  fact that initial states are reachable we  have:
\begin{align*}
& \mpar{\sigma_{01} \uplus \sigma_{02} \vdash R\mpar{s_{01}, s_{02}}} \wedge 
\mpar{\sigma_{013} \vdash \reach{A_{13}}\mpar{s_{013}}}\\
\iff & R\mpar{s_{01}, s_{02}}\psubst{ \sigma_{01} \uplus \sigma_{02}} \wedge \reach{A_{13}}\mpar{s_{013}} \psubst{\sigma_{013}} \wedge\underbrace{  \bigwedge_\subbox{v_3\in V_3} \sigma^1_{03}(v^1_3)=\sigma^2_{03}(v^2_3)\wedge s^1_3 = s^2_3}_{\Longleftrightarrow~\top}\\
\iff & \mpar{R\mpar{s_{01}, s_{02}} \wedge \reach{A_{13}}\mpar{s_{013}}  \wedge \bigwedge_\subbox{v_3\in V_3}  v^1_3=v^2_3\wedge s^1_3 = s^2_3} \psubst{ \sigma_{01} \uplus \sigma_{02} \uplus \sigma_{013} \uplus \sigma^1_{03}\uplus \sigma^2_{03} }\\
\iff & \sigma_{013} \uplus \sigma_{023} \vdash R'\mpar{s_{013}, s_{023}}
\end{align*}
...
\end{multline*}	
\smallskip
Consider any transition $t_{13}$ in $A_{13}$,  $t_{13}$ is obtained either by the composition of the transition $t_1=\OTx{1}{}{1}{1}$ and the transition %$t_3^1=\OTxup{3}{1} $, if $k \in J_1'$; or by the transition $t_1$ and the state $s_3^1$, otherwise (if $k \notin J_1'$).
%%%% Attention deactiver ici
\[
\choice{
\OT{\mpar{s_1, s^1_3}}{\mpar{s'_1, {s^1_3}'}}{\alpha_1}{\beta_{1j}^{j \in J'_1 \setminus \{k\}} \uplus  {(\beta^1_{3j})^{j \in J^{1 \prime}_3} }}{g_1 \wedge g^1_3 \wedge \alpha^1_3 = \beta_{1k}}{\psi_1 \uplus \psi^1_3} & \text{ if } k \in J'_{1} \\
\OT{\mpar{s_1, s^1_3}}{\mpar{s'_1, s^1_3}}{\alpha_1}{\beta_{1j}^{j \in J'_1}}{g_1}{\psi_1}& \text{otherwise}
}
\]
...
By hypothesis we have $k \in H$, so in the case where $k \in J'_{1}$, we deduce that $k \in J'_{2x}$ we can  then build  a family of OTs $t_{23x}^{x\in X}$ with the same transitions of $A_3$ (up to renaming) as those used to build $t_{13}$. For any $t_{23x}$  there will then be two cases according on how it is built:

\[
\choice{
\OT{\mpar{s_2, s^2_3}}{\mpar{s'_{2x}, {s^2_3}'}}{\alpha_{2x}}{\beta_{2xj}^{j \in J'_{2x}  \setminus \{k\}} \uplus   {(\beta^2_{3j})^{j \in J^{2 \prime}_3} }}{g_{2x} \wedge g^2_3 \wedge \alpha^2_3 = \beta_{2xk}}{\psi_{2x} \uplus \psi^2_3} & \text{ if } k \in J'_{2x} \\
\OT{\mpar{s_2, s^2_3}}{\mpar{s'_{2x}, s^2_3}}{\alpha_{2x}}{\beta_{2xj}^{j \in J'_{2x}}}{g_{2x}}{\psi_{2x}}& \text{otherwise}
}
\]

So have to prove the following:
\begin{align*}		
...
\begin{align*}
	...
	\mpar{ J'_{2x}\uplus J^{2 \prime}_{3}  \setminus \mbrc{k}} \cap  \mpar{J^{2 \prime}_{3} \uplus H \setminus \mbrc{k}} \\
		& = J^{2 \prime}_{3}  \uplus \mpar{J'_{2x} \cap H} \setminus \mbrc{k} \quad \text{ since } J^{1 \prime}_{3}=J^{2 \prime}_{3} \text{ and } J'_1 \cap H = J'_{2x} \cap H\\
		& = J^{1 \prime}_{3} \uplus \mpar{J'_1 \cap H} \setminus \mbrc{k} \\
		& = \mpar{ J'_1  \uplus J^{1 \prime}_{3}\setminus \mbrc{k}} \cap \mpar{J^{1 \prime}_{3} \uplus H \setminus \mbrc{k}}\\
		& = J'_{13} \cap H'\\
\text{if } k \notin J'_1:\quad &	J'_{23x} \cap H'  = \mpar{J'_{2x} \setminus \mbrc{k}} \cap \mpar{J^{2 \prime}_3 \uplus H \setminus \mbrc{k}} \\
\end{align*}
