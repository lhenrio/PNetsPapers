...
\begin{multline*}
\forall \mpar{s_1, s_3} \in S_1 \times S_3, \bigsymb{\forall} \mpar{t_1, t_3} = \mpar{\OTx{1}{}{1}{1}, \OTx{3}{}{3}{3}} \in \fOT{s_1} \times \fOT{s_3} \\ 
\bigsymb{\bigexists} 
\mpar{t_{1x} = \OTx{1}{x}{1x}{1x} \in \fOT{s_1}}^{x \in X},
...
\bigsymb{\bigwedge_{x\in X}}
\mpar{
\alpha_2=\alpha_{2 x}  \land J'_{2x}= J'_3 \land \bigwedge_\subbox{j \in J'_3 } \beta_{3j} = \beta_{2xj}\land g_{1 x}\land
...
For each $s_2 \in S_2$, we remark that  $s_2$  allows to relate $s_1$ and $s_3$ if and only if $R_{12}\mpar{s_1, s_2}\land R_{23}\mpar{s_2, s_3} $. 
We can make the conjunction of these two formulas,
we get  $\forall \mpar{s_1,s_2,s_3} \in S_1\times S_2 \times S_3$ and\\ $\bigsymb{\forall} \mpar{t_1,t_2, t_{3}}\!=\! \mpar{\OTx{1}{}{1}{1},\OTx{2}{}{2}{2},\OTx{3}{}{3}{3}}\! \in\! \fOT{s_1} \times\fOT{s_2} \times \fOT{s_3}$  
\begin{multline*}
\bigsymb{\bigexists} 
\mpar{t_{1x} = \OTx{1}{x}{1x}{1x} \in \fOT{s_1}}^{x \in X}, \bigsymb{\bigexists} 
\mpar{t_{2x} = \OTx{2}{y}{2y}{2y} \in \fOT{s_2}}^{y \in Y},\\
 V_1 \uplus V_2 \uplus V_3 \uplus \fvars{t_1} \uplus \fvars{t_2} \uplus \fvars{t_3} \uplus \biguplus_{x\in X}\fvars{t_{1x}}  \uplus \biguplus_{y\in Y}\fvars{t_{2y}}   \vdash \hspace{6cm}\\  \mpar{R_{12}\mpar{s_1, s_2} \wedge 	g_1 \wedge g_2 \wedge \alpha_1 = \alpha_2} \wedge \mpar{ R_{23}\mpar{s_2, s_3} \wedge 	g_2 \wedge g_3 \wedge \alpha_2 = \alpha_3 }
%\wedge \bigwedge_\subbox{j \in J'_2 \cap J'_3} \beta_{2j} = \beta_{3j}} 
%\wedge \bigwedge_\subbox{j \in J'_1 \cap J'_2} \beta_{1j} = \beta_{2j} 
\implies \hspace{6cm}\\
%\exists
...
\mpar{
\alpha_1=\alpha_{1 x}  \land J'_{1x}= J'_2 \land \bigwedge_\subbox{j \in J'_2 } \beta_{2j} = \beta_{1xj}\land g_{1 x}\land
 R_{12}\mpar{s'_{1 x}, s'_2}\psubst{\psi_{1 x} \uplus \psi_2}} \wedge\\
\bigsymb{\bigwedge_{y\in Y}}
\mpar{
\alpha_2=\alpha_{2 y}  \land J'_{2y}= J'_3 \land \bigwedge_\subbox{j \in J'_3 } \beta_{3j} = \beta_{2yj}\land g_{1 y}\land
 R_{23}\mpar{s'_{2 y}, s'_3}\psubst{\psi_{2 y} \uplus \psi_3}}\\
\end{multline*}
...
\TODO{Manque Argument de simplification mecanique a trouver}
...
Consider one $t_{1x}=\OT{s_1}{s_{1x}}{\alpha_{1x}}{\beta_{1xj}^{j \in J'_{1x}}}{g_{1x}}{\psi_{1x}}\in \fOT{s_1}$ to obtain a new open transition of $A_1$ and compose it with $t_3^2$.
We obtain 
\[
...
\Big(
 ...
 R\mpar{s'_{1x}, s'_{2}}\psubst{\psi_{1 x} \uplus \psi_2}\Big) \wedge g^2_3 \wedge \alpha^2_3 = \beta_{2k} = \beta_{1xk}\\
 \wedge \bigwedge_\subbox{v_3\in V_3}
 v^1_3=v^2_3\wedge s^1_3 = s^2_3
 \end{multline*}
 \TODO{to check $j \in J'_2 \setminus\{k\}$}
...
The proof continues as described above. 
