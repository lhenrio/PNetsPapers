...
\item The last formula we need to prove is that the relation is preserved along identical transitions, i.e. the following is satisfied  $\forall \mpar{s_{13}, s_{23}} \in S_{13} \times S_{23}$ and
\begin{multline*}
