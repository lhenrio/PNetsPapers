...
Let us consider any two states $s_{13} = \mpar{s_1,s_3}$ and $s_{23} = \mpar{s_2,s_3'}$ we define a relation $R'$ relating states of $A_{13}$ and $A_{23}$ as follows:
\[R' \mpar{s_{13}, s_{23}} = \choice{R\mpar{s_{1}, s_{2}} \wedge \reach{A_{13}}\mpar{s_{13}} \wedge\!\!\!\! \bigwedge_\subbox{v\in \fvars{s_{3}}
}\!\!\! \sigma_{13}(v)=\sigma_{23}(v) & \text{ if } s_{3} = s'_{3} \\ \bot & \text{otherwise}} \]
...
\end{align*}
\item We need to prove for any OT $t_{13}$ originating from $s_{13}$:
\begin{align*}
		&  \OTx{13}{}{13}{13} \in \fOT{s_{13}}
\end{align*}		
there exist an indexed family $t_{23x}$ of OTs originating from $s_{23}$: 
\begin{align*}
		&  \mpar{\OTx{23}{x}{23x}{23x} \in \fOT{s_{23}}}^{x \in X}
\end{align*}	
\begin{align*}		
		& \quad \mpar{\forall x \in X, J'_{23x} \cap H = J'_{13} \cap H} \nwedge\\
		...
		\end{array}} 
	\end{align*}
According to Definition \ref{Def:CompOA}, we know that $t_{13}$ is built by:
 \[  \choice{
	\OTx{1}{}{1}{1} \wedge  \OTx{3}{}{3}{3}
	& \text{if } k \in J'_{1} \\
...
By hypothesis, we have for any open transition $t_1$ in $T_1$  originating from $s_1$:
\begin{align*}
\OTx{1}{}{1}{1} \in \fOT{s_1}
\end{align*}
there exist an indexed family of OTs originating from $s_{2}$: 
\begin{align*}
