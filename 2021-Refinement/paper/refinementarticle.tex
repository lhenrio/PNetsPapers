...
\TODO{Beware, c'est la premiere apparition de "PNets", c'est un peu brutal...}
...
\end{definition}
\TODO{C'est etrange, la formulation "the variables they refer to", comme il n'y a plus de variables d'etat...}
