...
\paragraph{First case: Both automata perform a transition}
 $t_{13}$ is obtained by the composition of  transitions $t_1=\OTx{1}{}{1}{1}$ and  \[t_3^1=
...
$t_{12}$ is obtained  by the composition of transitions $t_2=\OTx{2}{}{2}{2}$ and  \[t_1^1=
...
\smallskip
\paragraph{First case: Only the encompassing automaton performs a transition}~\\

$t_{12}$ is obtained  by  the transition $t_1^1=
