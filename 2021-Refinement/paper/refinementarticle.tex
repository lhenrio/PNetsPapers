...
\begin{definition}[Preservation along simultaneous transitions]\label{def:preservation} \\
Let \(\OAg[1]\) and \(\OAg[2]\) be two OAs.
A relation \(R: S_1 \times S_2 \to \rformulas[V_1 \uplus V_2]\) between  \(\OAg[1]\) and \(\OAg[2]\)
  is preserved along simultaneous transitions if  it satisfies the following:
\begin{multline*}
...
\end{multline*}
\item[(3)] $R$ is  is preserved along simultaneous transitions of \(A_1\) and \(A_2\).
\end{definition}
...
\begin{multline*}
	...
	\end{array} 
\end{multline*}
\item[(3)] $R$ is preserved along simultaneous transitions of \(A_1\) and \(A_2\).
...
\end{multline*}	
\medskip
\item  \TODO{Part to check} Finally, we have to prove the following holds:
...
Yet according to the relation between   $A_2$ and $A_3$ we have for all $\mpar{s_2,s_3} \in S_2 \times S_3$:
\begin{multline*}
...
\begin{multline*}
V_1\uplus V_2 \uplus V_3 \uplus \fvars{t_1} \uplus \fvars{t_2} \uplus \fvars{t_3} \vdash \left(R_{12}\mpar{s_1, s_2} \wedge   g_1 \wedge g_{2} \wedge \alpha_1 = \alpha_{2} \wedge \bigwedge_\subbox{j \in J'_1 \cap J'_{2}} \beta_{1j} = \beta_{2j}\right) \wedge\\ \mpar{R_{23}\mpar{s_2, s_3} 
...
\item The last formula we need to prove is that the relation is preserved along simultaneous transitions, i.e. the following is satisfied  $\forall \mpar{s_{13}, s_{23}} \in S_{13} \times S_{23}$ and
\begin{multline*}
...
According to the refinement relation between  $A_1$ and $A_2$ we have,  $\forall \mpar{s_1,s_{2}} \in S_1 \times S_2$ and
\begin{multline*}
...
The reachability of a state ensures that $\bigsymb{\forall} t_{13} = \OTx{13}{}{13}{13} \in T_{13}$
\[\fvars{t_{13}} \vdash \left(\reach{A_{13}}\mpar{s_{13}} \wedge g_{13} \implies \reach{A_{13}}\mpar{s_{13}'}\psubst{\psi}\right)\]
