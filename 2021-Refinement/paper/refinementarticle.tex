...
\TODO{the subtelty here is that the original relation implies that valuations in A3 are equal (ie the value for each variable are the same in both valuations, modulo renaming), after a transition we should obtain ``equal'' valuations because Post are deterministic}
