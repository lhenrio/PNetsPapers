...
As $t_{13}$ and $t_{23}$ are built with the same transitions of $A_3$  (up renaming) so we can deduce:
\begin{align*}
{\displaystyle \bigwedge_\subbox{j \in J'_{2x} \cap H} \beta_{1j} = \beta_{2xj}} & \Rightarrow  {\displaystyle \bigwedge_\subbox{j \in (J'_{2x} \setminus \{k\}  \cap H)\uplus J^{2 \prime}_3} \beta_{13j} = \beta_{23xj}}\\
& \Rightarrow {\displaystyle \bigwedge_\subbox{j \in (J'_{2x} \setminus \{k\}  \cap H)\uplus J^{2 \prime}_3 } \beta_{13j} = \beta_{23xj}}\\
\end{align*}
...
By adding the same (and equivalent) terms  to both sides of the implication of the formula $(*)$,  and  from all the implications induced by the extension of the valuation context mentioned above, we get:
\begin{multline*}
V_1 \uplus V_2 \uplus \fvars{t_1} \uplus V^1_3  \uplus V^2_3 \vdash\\
...
\begin{array}{l}
			\alpha_{13} = \alpha_{23x} \wedge \bigwedge_\subbox{j \in (J'_{2x} \cap H)\uplus J_3} \beta_{13j}\! =\! \beta_{23xj}\\
			 \nwedge g_{2x} \wedge R\mpar{s'_1, s'_{2x}}\psubst{\psi_1 \uplus \psi_{2x}}
