...
\end{definition}
Again we use guards to characterise that the transition occurs. It is not sufficient to ensure the existence of equivalent transitions in general, but it will be sufficient in the context of refinement.
