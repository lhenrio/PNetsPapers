...
As an example, the traffic light system  that controls  
 traffic at the intersection of a busy highway. In Figure \ref{fig:tls} we model it as open automaton and abstract the timer   as  Holes: a controller and a counter. 
