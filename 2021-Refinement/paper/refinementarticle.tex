...
%\neg\left(\alpha_{1 a} = \alpha_{1 b}\land s'_{1 a}\neq s'_{1 b}\land g_{1 a}\land g_{1 b} \land\beta_{1 k} \neq \beta_{2 k}\right)
%\end{multline*}
%
...
\mpar{t_{1x} = \OTx{1}{x}{1x}{1x} \in \fOT{s_1}}^{x \in X},
 V_1 \uplus V_2 \uplus \biguplus_{x\in X}\fvars{t_{1x}} \uplus \fvars{t_2} \vdash \hspace{6cm}\\  R\mpar{s_1, s_2} \wedge 	g_1 \wedge g_2 \wedge \alpha_1 = \alpha_2 
...
\begin{multline*}
\forall \mpar{s_{13}, s_{23}} \in S_{13} \times S_{23}, \bigsymb{\forall} \mpar{t_{13}, t_{23}} = \mpar{\OTx{13}{}{13}{13}, \OTx{23}{}{23}{23}} \in \fOT{s_{13}} \times \fOT{s_{23}} \\  V_{13} \uplus V_{23} \uplus \fvars{t_{13}} \uplus \fvars{t_{23}} \vdash \hspace{6cm}\\  R\mpar{s_{13}, s_{23}} \wedge 	g_{13} \wedge g_{23} \wedge \alpha_{13} = \alpha_{23} 
\implies 
\exists
\OT{s_{13}}{s'_{13a}}{\alpha_{13a}}{\beta_{13aj}^{j \in J'_{13a}}}{g_{13a}}{\psi_{13a}}\in \fOT{s_{13}}.\\ \alpha_{13}=\alpha_{1 3a} \land
J'_{13a}  = J'_{23} \land g_{1 3a} \land \bigwedge_\subbox{j \in  J'_{23}} \beta_{12j} = \beta_{13aj}\land
 R\mpar{s'_{1 3a}, s'_{23}}\psubst{\psi_{1 3a} \uplus \psi_{23}}\\
\end{multline*}
...
\smallskip
In both cases note that $g_{13} \implies g_1$, with  $\mpar{s_1, s_2} \in S_1 \times S_2$, Definition~\ref{def:preservation} applied to OTs $t_1,\,t_2$ gives the following:

\begin{multline*}
  V_1 \uplus V_2 \uplus \fvars{t_1} \uplus \fvars{t_2} \vdash \hspace{6cm}\\  R\mpar{s_1, s_2} \wedge 	g_1 \wedge g_2 \wedge \alpha_1 = \alpha_2 
%\wedge \bigwedge_\subbox{j \in J'_1 \cap J'_2} \beta_{1j} = \beta_{2j} 
\implies \\
\exists
\OT{s_1}{s_4}{\alpha_4}{\beta_{4j}^{j \in J'_4}}{g_4}{\psi_4}\in \fOT{s_1}. \alpha_1=\alpha_{4} \land J'_4 =J'_2 \land g_{4} \land \bigwedge_\subbox{j \in J'_2} \beta_{2j} = \beta_{4j}\land
 R\mpar{s'_{4}, s'_2}\psubst{\psi_{4} \uplus \psi_2}\\
\end{multline*}

We reason on such a $t_1'=\OT{s_1}{s_4}{\alpha_4}{\beta_{4j}^{j \in J'_4}}{g_4}{\psi_4}\in \fOT{s_1}$ to obtain a new open transition of A1 and compose it with $t_3^2$

We obtain 
\[
t_{13}' = \OT{\mpar{s_1, s_3}}{\mpar{s_4, {s_3}}}{\alpha_4}{\beta_{4j}^{j \in J'_4 \setminus \{k\}} \uplus  {(\beta^2_{3j})^{j \in J^{2 \prime}_3} }}{g_4 \wedge g^2_3 \wedge \alpha^2_3 = \beta_{4k}}{\psi_4 \uplus \psi^2_3} \qquad \text{ where } k \in J'_{4} 
\]

ON REVIENT A NOTRE BUT INITIAL
ON VEUT:
\begin{multline*}
  V_{13} \uplus V_{23} \uplus \fvars{t_{13}} \uplus \fvars{t_{23}} \vdash \hspace{6cm}\\  R\mpar{s_{13}, s_{23}} \wedge 	g_{13} \wedge g_{23} \wedge \alpha_{13} = \alpha_{23} 
\implies 
\exists
\OT{s_{13}}{s'_{13a}}{\alpha_{13a}}{\beta_{13aj}^{j \in J'_{13a}}}{g_{13a}}{\psi_{13a}}\in \fOT{s_{13}}.\\ \alpha_{13}=\alpha_{1 3a} \land
J'_{13a}  = J'_{23} \land g_{1 3a} \land \bigwedge_\subbox{j \in  J'_{23}} \beta_{12j} = \beta_{13aj}\land
