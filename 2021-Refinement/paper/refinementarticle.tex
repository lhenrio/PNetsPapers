...
\proof
Let us denote by $A_{13}$ (resp. $A_{23}$) the open automaton resulting from $A_1\subst{A_3}{k}$ (resp. $A_2\subst{A_3}{k}$),  to prove the theorem it sufficient to prove that there exists a relation between states of the two open automata that satisfies the conditions of the Definition \ref{Def:OA-Refinement}. 
...
Considering that initial valuations $\sigma_{03}^1$ and $\sigma_{03}^2$ associate the same values to the ``same'' variables modulo renaming, we have the tautology:\\ $\left(\,\,\,\,{\displaystyle \bigwedge_\subbox{v_3\in vars(s_3)} v^1_3=v^2_3\wedge s^1_3 = s^2_3}\right)\psubst{\sigma_{03}^1 \uplus \sigma_{03}^2 }$.
...
& \mpar{\sigma_{01} \uplus \sigma_{02} \vdash R\mpar{s_{01}, s_{02}}} \wedge 
\mpar{\sigma_{013} \vdash \reach{A_{13}}\mpar{s_{013}}}\\
\implies & R\mpar{s_{01}, s_{02}}\psubst{ \sigma_{01} \uplus \sigma_{02}} \wedge \reach{A_{13}}\mpar{s_{013}} \psubst{\sigma_{013}} \land \bigwedge_\subbox{v_3\in vars(s_3)} v^1_3=v^2_3\wedge s^1_3 = s^2_3\\
\implies & \mpar{R\mpar{s_{01}, s_{02}} \wedge \reach{A_{13}}\mpar{s_{013}}  \wedge \bigwedge_\subbox{v_3\in vars(s_3)}  v^1_3=v^2_3\wedge s^1_3 = s^2_3} \psubst{ \sigma_{01} \uplus \sigma_{02} \uplus \sigma^1_{03}\uplus \sigma^2_{03} }\\
...
\end{align*}		
there exists an indexed family $t_{23x}$ of OTs originating from $s_{23}$ that simulates it: 
\begin{align*}
...
First, because composition doesn't change the resulting actions, nor their variables, we can extend the valuation context of the variables to cover the variables of the transition $t_3$.   By construction of  $t_{13}$ and $t_{23}$ we have $\alpha_{13}=
\alpha_{1}$ and $\alpha_{23x}=\alpha_{2x}$. So we deduce: 
$\alpha_{1} = \alpha_{2x} \Rightarrow \alpha_{13} = \alpha_{23x}$.\\
Second, we have: \TODO{discuss next equations}\\ $\beta_{13j}^{J'_{13}}= \beta_{1j}^{j \in J'_{1}  \setminus \{k\}} \uplus   {(\beta^1_{3j})^{j \in J^{1 \prime}_3} }$
and $\beta_{23xj}^{J'_{23}}= \beta_{2xj}^{j \in J'_{2x}  \setminus \{k\}} \uplus   {(\beta^2_{3j})^{j \in J^{2 \prime}_3} }$\\
Therefore, we have:  $\beta_{13j} = \beta_{23xj} \Rightarrow (\beta_{1j} = \beta_{2xj}) \vee (\beta^1_{3j}= \beta^2_{3j})$\\
Third, considering $\beta^1_{3j}$ and  $\beta^2_{3j}$  are the same (up to renaming)  we have: $V^1_{3} \uplus V^2_{3}  \vdash {\displaystyle \bigwedge_\subbox{j \in J^{2 \prime}_3} \beta^1_{3j}= \beta^2_{3j}}$ \TODO{No, rather:}\\
${\displaystyle V^1_{3} \uplus V^2_{3}  \vdash \bigwedge_\subbox{v_3\in \fvars{s_{3}}
}\!\!\! v^1_3=v^2_3\implies \bigwedge_\subbox{j \in J^{2 \prime}_3} \beta^1_{3j}= \beta^2_{3j}}$

\TODO{adapt}

And suppose that  $V_{1} \uplus V_{2} \uplus \fvars{t_1}  \vdash {\displaystyle \bigwedge_\subbox{j \in J'_{2x} \cap H} \beta_{1j} = \beta_{2xj}}$ holds then we can deduce:
\begin{align*}
& V_{1} \uplus V_{2}  \uplus V^1_{3} \uplus V^2_{3} \uplus \fvars{t_1}\vdash  & {\displaystyle \bigwedge_\subbox{j \in J'_{2x} \cap H} \beta_{1j} = \beta_{2xj}} \vee {\displaystyle \bigwedge_\subbox{j \in J^{2 \prime}_3} \beta^1_{3j}= \beta^2_{3j}}\\
\Rightarrow & V_{13} \uplus V_{23}  \uplus \fvars{t_1}\vdash & {\displaystyle \bigwedge_\subbox{j \in (J'_{2x}   \cap H)\uplus J^{2 \prime}_3 } \beta_{13j} = \beta_{23xj}} \\  
\Rightarrow & V_{13} \uplus V_{23}  \uplus \fvars{t_1}\vdash & {\displaystyle \bigwedge_\subbox{j \in \Rightarrow   ((J'_{2x}   \cap H)\uplus J^{2 \prime}_3)\setminus \{k\} } \beta_{13j} = \beta_{23xj}} \\
\Rightarrow &  V_{13} \uplus V_{23}  \uplus \fvars{t_1}\vdash & {\displaystyle \bigwedge_\subbox{j \in (J'_{23x}   \cap H') } \beta_{13j} = \beta_{23xj}}\\
\end{align*}
Finally, the composition gives $g_{13} \Leftrightarrow g_1 \wedge g^1_3 \wedge \alpha^1_3=\beta_{1k}$ and
$g_{23x}  \Leftrightarrow g_{2x} \wedge g^2_3 \wedge \alpha^2_3=\beta_{2xk}$. \\
Furthermore, as $k \in H$ we have   
...
From all the implications induced by the extension of the valuation context mentioned above, and by entering   all previous intermediate results in the formula $(*)$, we get:
\begin{multline*}
V_{13} \uplus V_{23}  \uplus \fvars{t_1} \vdash\\
R\mpar{s_1, s_{2}} \wedge g_1 \wedge g^1_3 \wedge \alpha^1_3=\beta_{1k} %\wedge \bigwedge_\subbox{v_3\in V_3}  v^1_3=v^2_3\wedge s^1_3=s^2_3
\implies  \hspace{12em}\\
...
By hypothesis we have  \(A_1\subst{A_3}{k}\) is non-blocking,  then according to the Definition \ref{Def:Reach} we have $ \sigma_{013} \vdash \reach{A_{13}}\mpar{s_{013}}$ and for all $t_{13} \in T_{13}$:
\[ \fvars{t_{13}} \vdash \left(\reach{A_{13}}\mpar{s_{13}} \wedge g_{13} \implies \reach{A_{13}}\mpar{s_{13}'}\psubst{\psi_{13}}\right) \]	
From these two previous formulas we obtain:
\begin{multline*}
...
\begin{array}{l}
			...
			\nwedge g_{23x} \wedge R\mpar{s'_1, s'_{2x}}\psubst{\psi_1 \uplus \psi_{2x}} 
%\wedge \bigwedge_\subbox{v_3\in V_3}  v^1_3=v^2_3\wedge s^1_3=s^2_3
		\end{array}}   \wedge \reach{A_{13}}\mpar{s_{13}'}\psubst{\psi_{13}} 
\end{multline*}	
...
Considering that at each step the valuations $\sigma_{3}^1$ and $\sigma_{3}^2$ associate the same values to the ``same'' variables modulo renaming, so for any states $s^1_3$ and $s^2_3$ the following formula is a tautology:\\ $\left({\displaystyle \bigwedge_\subbox{v_3\in V_3} v^1_3=v^2_3\wedge s^1_3 = s^2_3}\right)\psubst{\sigma_{3}^1 \uplus \sigma_{3}^2 }$ which is equivalent to \\
$V_3^1 \uplus V_3^2 \vdash \left({\displaystyle \bigwedge_\subbox{v_3\in V_3} v^1_3=v^2_3\wedge s^1_3 = s^2_3}\right)$ \\
By adding tautologies to both members of the implication, we get:
\begin{multline*}
V_{13} \uplus V_{23} \uplus \fvars{t_1}  \cap \fvars{t_{13}} \vdash\\
R\mpar{s_1, s_{2}} \wedge g_{13}  \wedge \reach{A_{13}}\mpar{s_{13}}
\wedge \bigwedge_\subbox{v_3\in V_3}  v^1_3=v^2_3\wedge s^1_3=s^2_3
...
\begin{array}{l}
			\alpha_{13} = \alpha_{23x} \wedge \bigwedge_\subbox{j \in J'_{23x} \cap H'} \beta_{13j} = \beta_{23xj} \nwedge \\
			g_{23x} \wedge R\mpar{s'_1, s'_{2x}}\psubst{\psi_1 \uplus \psi_{2x}} \wedge \reach{A_{13}}\mpar{s_{13}'}\psubst{\psi_{13}} 
\wedge \bigwedge_\subbox{v_3\in V_3}  v^1_3=v^2_3\wedge s^{1\prime}_3=s^{2\prime}_3
		\end{array}}   
\end{multline*}	
\TODO{Point a verifier!}
\item if $k \notin J'_1$:\\
The first and second arguments remain the same as the previous case, while for the third we have: $g_{13} \Leftrightarrow g_1$ and
$g_{23x}  \Leftrightarrow g_{2x} $. By replacing  these results in the formula $(*)$, we get the same formula:
\begin{multline*}
V_{13} \uplus V_{23} \uplus \fvars{t_1}  \vdash\\
R\mpar{s_1, s_{2}} \wedge g_{13}  
%\wedge \bigwedge_\subbox{v_3\in V_3}  v^1_3=v^2_3\wedge s^1_3=s^2_3
...
%\wedge \bigwedge_\subbox{v_3\in V_3}  v^1_3=v^2_3\wedge s^1_3=s^2_3
		\end{array}}   
\end{multline*}	
From this point on, the proof continues as in the previous case.\\
\end{itemize}
...
\end{multline*}
Let's start  with the hypothesis of the theorem that $\wrel{A_1}{A_2}{H}$, thus we have for all  $\mpar{s_1, s_2} \in S_1 \times S_2$ 
\begin{multline*}
...
\end{multline*}
By adding  the same term to both members of the implication, we get:
\begin{multline*}
V_1 \uplus V_2 \uplus \biguplus_\subbox{t_2 \in \fOT{s_2}} \fvars{t_2} \vdash \\\left(R\mpar{s_1, s_2} \wedge \bigvee_\subbox{t_2 \in \fOT{s_2}} \fguard{t_2} \wedge  \reach{A_{13}}\mpar{s_{13}}\implies \bigvee_\subbox{t_1 \in \fOT{s_1}} \fguard{t_1}  \wedge \reach{A_{13}}\mpar{s_{13}}\right)
\end{multline*}
But by hypothesis we have also the result of the composition \(A_1\subst{A_3}{k}\) is non-blocking, which leads to:
\begin{multline*}
