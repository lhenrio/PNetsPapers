...
Consider two OA with identical set of holes:  \(\OAg[1]\) and \(\OAg[2]\) where  \(J_1 = J_2\), the relation on configurations \(R: S_1 \times S_2 \to \rformulas[V_1 \uplus V_2]\) is a hole-\(\symb{equal}\) simulation from $S_1$ to $S_2$ if the following conditions hold: 
...
\TODO{Simulation: Il y a differentes facons de voir le relation de reffinement entre l'implem et la spec:
\begin{itemize}
\item implem as a conformance of spec:  implem deadlocks less often.
\item implem as a (nondeterminism) reduction of spec:  implem deadlocks less often. Can only used be used for complete specification.
\item implem as an extension of spec. C'est le complement du raffinement par reduction, i.e. Can be used to complete partial specification (implem can exhibit more behaviour than spec).
Our definition of simulation matches the definition given in \cite{EshuisF:2002} Section 3.2 $\implies$ Refinement par extension according to Thm 8 (Section 4)
\end{itemize}
}
...
Consider $(t_1,t_3)\in\fOT{s_1} \times \fOT{s_3}$


\newpage
\TODO{[RABEA] proof}
Let's consider any $s_{2p} \in (s_{2p})^{p\in P}$. Consider  $t_1$ in $T_1$  originating from $s_1$:
\begin{align*}
\OTx{1}{}{1}{1} \in \fOT{s_1}
\end{align*}
According to the refinement relation between  $A_1$ and $A_2$ there exists an indexed family of OTs originating from $s_{2p}$: 
\begin{align*}
\mpar{\OTx{2p}{x}{2px}{2px} \in \fOT{s_{2p}}}^{x \in X_p} 
\end{align*}
such that $\forall x \in X, J'_{2px} \cap H = J'_1 \cap H$ and
\begin{multline}\label{lab1}\tag{$*$}
%\everymath{\displaystyle}
V_1 \uplus V_2 \uplus \fvars{t_1} \vdash\\ \mpar{R_{12}\mpar{s_1, s_{2p}} \wedge g_1 \implies \operatorname*{\bigsymb{\bigvee}}_{x \in X_p} \mpar{\everymath{\displaystyle}
\begin{array}{l}
			\alpha_1 = \alpha_{2px} \wedge \bigwedge_\subbox{j \in J'_{2px} \cap H} \beta_{1j} = \beta_{2pxj} \nwedge\\
		...
		\end{array}}} 
\end{multline}	
On the other hand, according to the refinement relation between   $A_2$ and $A_3$, we know condition 3 is satisfied, $\bigforall \mpar{s_{2p}, s_3} \in S_2 \times S_3$ and $\bigsymb{\forall} \mpar{t_{2p}, t_3} \in \fOT{s_{2p}} \times \fOT{s_3}$ and in particular for  the set $(t_{2px})^{x\in X_p}$ so we  have the following that we denote ($**$):
\begin{multline*}
\bigsymb{\forall} \mpar{t_{2px}, t_3} = \mpar{\OTx{2px}{}{2px}{2px}, \OTx{3}{}{3}{3}} \in \fOT{s_{2p}} \times \fOT{s_3} \\ 
\bigsymb{\bigexists} 
\mpar{t_{2pxy} = \OTx{2px}{y}{2pxy}{2pxy} \in \fOT{s_{2p}}}^{y \in Y_X},
V_2 \uplus V_3\uplus \biguplus_{y\in Y}\fvars{t_{2pxy}} \uplus \fvars{t_3} \uplus \fvars{t_{2p}} \vdash \hspace{6cm}\\  R_{23}\mpar{s_{2p}, s_3} \wedge 	g_{2px}\wedge g_3 \wedge \alpha_{2px}= \alpha_3 
%\wedge \bigwedge_\subbox{j \in J'_2 \cap J'_3} \beta_{2pj} = \beta_{3j} 
\implies \hspace{6cm}\\
%\exists
%\OTx{1}{a}{3}{3}\in \fOT{s_2}. \\
\bigsymb{\bigvee_{y\in Y_X}}
\mpar{
\alpha_{2px}=\alpha_{2p xy}  \land J'_{2pxy}= J'_3 \land \bigwedge_\subbox{j \in J'_3 } \beta_{3j} = \beta_{2pxyj}\land g_{2p xy}\land
 R_{23}\mpar{s'_{2p xy}, s'_3}\psubst{\psi_{2p xy} \uplus \psi_3}}\\
\end{multline*}
combining $(*)$ and $(**)$ with the definition of the set $s_{2p}$, we obtain (variables on the left  of the $\vdash$ omitted for readability)
\begin{align*}
 R_{13}\mpar{s_1, s_3} &\wedge 	g_1 \wedge g_3 \wedge \alpha_1 = \alpha_3 \implies \\
&(\bigvee_{{p\in P}}\mpar{R_{12}\mpar{s_1,s_{2p}} \wedge R_{23}\mpar{s_{2p},s_3}}) \wedge 	g_1 \wedge g_3 \wedge \alpha_1 = \alpha_3  \implies \\
& (\bigvee_{{p\in P}}{\bigsymb{\bigvee}}_{x \in X_p} \left(\mpar{\everymath{\displaystyle}
\begin{array}{l}
			\alpha_1 = \alpha_{2px}= \alpha_3 \wedge \bigwedge_\subbox{j \in J'_{2px} \cap H} \beta_{1j} = \beta_{2pxj} \nwedge\\
			 g_{2px} \wedge R_{12}\mpar{s'_1, s'_{2px}}\psubst{\psi_1 \uplus \psi_{2px}}
		\end{array}} \right) 
	\wedge R_{23}\mpar{s_{2p},s_3}  \wedge g_3  \implies \\
\end{align*}

Again according to the refinement  relation between  $A_1$ and $A_2$ and condition 3  the following is satisfied $\bigforall \mpar{s_1, s_{2p}} \in S_1 \times S_2$ , in particular over the family of transitions in $(t_{2pxy})^{y\in Y_X}$:
\begin{multline*}
\bigsymb{\forall} \mpar{t_1, t_{2pxy}} = \mpar{\OTx{1}{}{1}{1}, \OTx{2pxy}{}{2pxy}{2pxy}} \in \fOT{s_1} \times \fOT{s_{2p}} \\ 
\bigsymb{\bigexists} 
\mpar{t_{1z} = \OTx{1}{z}{1z}{1z} \in \fOT{s_1}}^{z \in Z},
 V_1 \uplus V_2 \uplus \biguplus_{x\in X}\fvars{t_{1x}} \uplus \fvars{t_1} \uplus \fvars{t_{2p}} \vdash \hspace{6cm}\\  R_{12}\mpar{s_1, s_{2p}} \wedge 	g_1 \wedge g_{2pxy} \wedge \alpha_1 = \alpha_{2pxy} 
%\wedge \bigwedge_\subbox{j \in J'_1 \cap J'_{2p}} \beta_{1j} = \beta_{2pxyj} 
\implies \hspace{6cm}\\
%\exists
%\OTx{1}{a}{3}{3}\in \fOT{s_1}. \\
\bigsymb{\bigwedge_{z\in Z}}
\mpar{
\alpha_1=\alpha_{1 z}  \land J'_{1z}= J'_{2pxy} \land \bigwedge_\subbox{j \in J'_{2pxy} } \beta_{2pxyj} = \beta_{1zj}\land g_{1 z}\land
 R_{12}\mpar{s'_{1 z}, s'_{2pxy}}\psubst{\psi_{1 z} \uplus \psi_{2pxy}}}
\end{multline*}

This is verified for all $y \in  Y_X$.
\begin{multline*}
\bigsymb{\bigwedge_{y \in  Y_X}}
\Bigg[R_{12}\mpar{s_1, s_{2p}} \wedge 	g_1 \wedge g_{2pxy} \wedge \alpha_1 = \alpha_{2pxy}
\implies \hspace{6cm}\\
\bigsymb{\bigwedge_{z\in Z}}
\mpar{
\alpha_1=\alpha_{1 z}  \land J'_{1z}= J'_{2pxy} \land \bigwedge_\subbox{j \in J'_{2pxy} } \beta_{2pxyj} = \beta_{1zj}\land g_{1 z}\land
 R_{12}\mpar{s'_{1 z}, s'_{2pxy}}\psubst{\psi_{1 z} \uplus \psi_{2pxy}}}\Bigg]
\end{multline*}



The conjunction of formulas ($*$) and ($**$) gives:
\begin{multline*}
\bigsymb{\bigwedge_{y \in  Y_X}}
\Bigg[
\mpar{R_{12}\mpar{s_1, s_{2p}} \wedge 	g_1 \wedge g_{2pxy} \wedge \alpha_1 = \alpha_{2pxy}} \wedge \mpar{ R_{23}\mpar{s_{2p}, s_3} \wedge 	g_{2px}\wedge g_3 \wedge \alpha_{2px}= \alpha_3 } 
\implies \hspace{6cm}\\
%\exists
%\OTx{1}{a}{3}{3}\in \fOT{s_1}. \\
\bigsymb{\bigwedge_{z\in Z}}
\mpar{
\alpha_1=\alpha_{1 z}  \land J'_{1z}= J'_{2pxy} \land \bigwedge_\subbox{j \in J'_{2pxy} } \beta_{2pxyj} = \beta_{1zj}\land g_{1 z}\land
 R_{12}\mpar{s'_{1 z}, s'_{2pxy}}\psubst{\psi_{1 z} \uplus \psi_{2pxy}}} \wedge \\
\mpar{
\alpha_{2px}=\alpha_{2p xy}  \land J'_{2pxy}= J'_3 \land \bigwedge_\subbox{j \in J'_3 } \beta_{3j} = \beta_{2pxyj}\land g_{2p xy}\land
 R_{23}\mpar{s'_{2p xy}, s'_3}\psubst{\psi_{2p xy} \uplus \psi_3}}
 \Bigg]
...
\bigsymb{\bigwedge_{y \in  Y_X}}
\Bigg[
R_{12}\mpar{s_1, s_{2p}} \wedge  R_{23}\mpar{s_{2p}, s_3} \wedge g_1 \wedge g_3 \wedge 	g_{2px}\wedge g_{2pxy} \wedge \alpha_1 = \alpha_{2pxy} \wedge     \alpha_{2px}= \alpha_3 
\implies \hspace{6cm}\\
%\exists
%\OTx{1}{a}{3}{3}\in \fOT{s_1}. \\
\bigsymb{\bigwedge_{z\in Z}}
...
\alpha_{2px}=\alpha_{2p xy}  \land J'_{2pxy}= J'_3 \land \bigwedge_\subbox{j \in J'_3 } \beta_{3j} = \beta_{2pxyj}\land g_{2p xy}\land
 ...
 \Bigg]
\end{multline*}
\TODO{ Je suis bloque a ce niveau: dans la conclusion on a $\alpha_{2px}=\alpha_{2p xy}$ qui est dans les hypotheses.  
}
...
We reason on the way the open transition $t_{23}$ has been obtained: either the hole $k$ of $A_2$ is involved in the transition or not.
...
\item Second, we need to prove for any open transition $t_{12}$ in $T_{12}$ originating from $s_{12}$
...
We reason on the way the open transition $t_{13}$ has been obtained: either the hole $k$ of $A_1$ is involved in the transition or not.
