...
As well,  according to the refinement relation between  $A_1$ and $A_2$ that for all $\mpar{s_1,s_{2}} \in S_1 \times S_2$:
\begin{multline*}
...
\end{multline*}
By removing the $A_2$ variables that have not effect on   $A_1$ et  $A_3$, we get the desired result.
