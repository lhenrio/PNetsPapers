...
Quentin Corradi\inst{2}\orcidID{} \and
...
\email{first.last@ens-lyon.fr}
 \and
INRIA Sophia Antipolis M\'edit\'erann\'ee, UCA,  Sophia Antipolis, France
...
The next  theorem states that if two automata are in refinement relation and the same automata is placed in the same hole of the two automata, then the refinement is preserved. This is the first step toward proving that
