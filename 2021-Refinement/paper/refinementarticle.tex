...
\begin{definition}[XXX]\label{def:???} \TODO{To check}\\
...
\end{multline*}	
\medskip
\item Finally, we need to prove the satisfaction of ??? \TODO{to check}. 
...
We can make the conjunction of these two formulas,  for each $s_2 \in S_2$  relating $s_1$ and $s_3$. Thus, we get  $\forall \mpar{s_1,s_2,s_3} \in S_1\times S_2 \times S_3$ and $\bigsymb{\forall} \mpar{t_1,t_2, t_{3}}\!=\! \mpar{\OTx{1}{}{1}{1},\OTx{2}{}{2}{2},\OTx{3}{}{3}{3}}\! \in\! \fOT{s_1} \times\fOT{s_2} \times \fOT{s_3}$  
\begin{multline*}
...
\end{multline*}
By removing the $A_2$ variables that have not effect on   $A_1$ et  $A_3$, we get the desired result: $\forall \mpar{s_1,s_3} \in S_1 \times S_3$, $\bigsymb{\forall} \mpar{t_1,t_2, t_{3}}\!=\! \mpar{\OTx{1}{}{1}{1},\OTx{3}{}{3}{3}}\! \in\! \fOT{s_1} \times \fOT{s_3}$
\begin{multline*}
