...
\begin{multline*}
%\everymath{\displaystyle}
\forall v \in \mpar{\fvars{\alpha_{2px}}  \cup \bigcup_{j \in J'_{2px}} \!\fvars{\beta_{2pxj}}} \setminus \mpar{V_1 \uplus V_2 \uplus \fvars{t_1}}, \\ \mpar{R_{12}\mpar{s_1, s_{2p}} \wedge g_1 \implies \operatorname*{\bigsymb{\bigvee}}_{x \in X_p} \mpar{\everymath{\displaystyle}
\begin{array}{l}
			\alpha_1 = \alpha_{2px} \wedge \bigwedge_\subbox{j \in J'_{2px} \cap H} \beta_{1j} = \beta_{2pxj} \\
			\nwedge g_{2px} \wedge R_{12}\mpar{s'_1, s'_{2px}}\psubst{\psi_1 \uplus \psi_{2px}}
		\end{array}}} \\
...
\begin{multline*}
\everymath{\displaystyle}
\forall v\in \mpar{\fvars{\alpha_{2px}}  \cup \bigcup_{j \in J'_{3pxy}} \!\fvars{\beta_{2jpx}}} \setminus \mpar{V_2 \uplus V_3 \uplus \fvars{t_{2px}}},\\ \mpar{R_{23}\mpar{s_{2p}, s_{3}} \wedge g_{2px} \implies \operatorname*{\bigsymb{\bigvee}}_{y \in Y} \mpar{\everymath{\displaystyle}
\begin{array}{l}
			 \alpha_{2px}=\alpha_{3pxy} \wedge \bigwedge_\subbox{j \in J'_{3pxy} \cap H'} \beta_{2pxj}=\beta_{3pxyj} \\
			\nwedge g_{3pxy} \wedge R_{23}\mpar{s'_{2px}, s'_{3pxy}}\psubst{\psi_{2px} \uplus \psi_{3pxy}}
		\end{array}}} 
\end{multline*}
The following  can be derived from both cases:
$\forall x \in X, J'_{2px} \cap H = J'_1 \cap H$
$\forall y \in Y, J'_{2px} \cap H' = J'_{3pxy} \cap H'$ and 
implies
$\forall x \in X \forall y \in Y,  J'_1 \cap (H \cap H') = J'_{3pxy} \cap (H\cap H')$
In addition, we have

\begin{align*}
\forall v \in \mpar{\fvars{\alpha_{2px}}  \cup \bigcup_{j \in J'_{2px}} \!\fvars{\beta_{2pxj}}} \setminus \mpar{V_1 \uplus V_2 \uplus \fvars{t_1}},
\forall v\in \mpar{\fvars{\alpha_{2px}}  \cup \bigcup_{j \in J'_{3pxy}} \!\fvars{\beta_{2jpx}}} \setminus \mpar{V_2 \uplus V_3 \uplus \fvars{t_{2px}}},\\
...
\begin{align*}
\underbrace{R_{12}\mpar{s_1, s_{2p}} \wedge R_{23}\mpar{s_{2p},s_3}}_{R_{13}\mpar{s_1, s_3}} \wedge g_1 \implies 
\hspace{5.5cm}\\
\operatorname*{\bigsymb{\bigvee}}_{x \in X} 
\operatorname*{\bigsymb{\bigvee}}_{y \in Y}
\mpar{\everymath{\displaystyle}
\begin{array}{l}
\alpha_1=\alpha_{3pxy}\wedge \bigwedge_\subbox{j \in J'_{3pxy} \cap H'} \beta_{1j}=\beta_{3jpxy} \wedge g_{3pxy}\wedge \\
\underbrace{R_{12}\mpar{s'_1, s'_{2px}} \wedge R_{23}\mpar{s'_{2px}, s'_{3pxy}}}_{R_{12}\mpar{s'_1,s'_{3pxy}}}\psubst{\psi_1 \uplus \psi_{2px} \uplus \psi_{3pxy}}
\end{array}}
\end{align*}	
This allows us to conclude, with $R_{13}(s_1,s_3)=\bigvee_{{p\in P}}\mpar{R_{12}\mpar{s_1,s_{2p}} \wedge R_{23}\mpar{s_{2p},s_3}}$: 
\begin{align*}
R_{13}\mpar{s_1, s_3} \wedge g_1 \implies 
\hspace{7.5cm}\\
...
\begin{array}{l}
\alpha_1=\alpha_{3pxy}\wedge \bigwedge_\subbox{j \in J'_{3pxy} \cap H'} \beta_{1j}=\beta_{3jpxy} \\\wedge g_{3pxy}\wedge \\
{R_{12}\mpar{s'_1,s'_{3pxy}}}\psubst{\psi_1  \uplus \psi_{3pxy}}
\end{array}}
\end{align*}	
...
\mpar{\everymath{\displaystyle}
\begin{array}{l}
\alpha_1=\alpha_{3z}\wedge \bigwedge_\subbox{j \in J'_{3z} \cap H'} \beta_{1j}=\beta_{3jz}\\ \wedge g_{3z}\wedge 
{R_{12}\mpar{s'_1,s'_{3z}}}\psubst{\psi_1  \uplus \psi_{3z}}
\end{array}}}
\end{align*}	
\item Concerning the condition on the deadlock reducing. According to the relation between   $A_2$ and $A_3$ we have forall $\mpar{s_{2p}, s_3} \in S_2 \times S_3$:
\begin{multline*}
