...
\end{align*}
This allows us to conclude that the family of open transitions of $A_3$ indexed over $p$, $x$,  and $y$ simulates the original open transition \TODO{re-write the set of OTs or not?} with note that $\psi_{2px}$ has no effect on variables of $A1$ and $A3$:
\begin{multline*}
...
\TODO{[LUDO] je suis un peu embete par le fait qu on se soit debarrasse des quantifiers et qu ils reviennent miraculeusement ici, a completer ou au moins commeter a mon avis (1footnote peut suffire si on est bien convaincus)}
...
\begin{multline*}
\everymath{\displaystyle}
\forall v\in \mpar{\fvars{\alpha_{2px}}  \cup \!\! \bigcup_{j \in J'_{2p}} \!\! \fvars{\beta_{2pxj}}}\cup \mpar{\fvars{\alpha_{1}}  \cup\!\! \bigcup_{j \in J'_{1}} \!\!\fvars{\beta_{1j}}}
