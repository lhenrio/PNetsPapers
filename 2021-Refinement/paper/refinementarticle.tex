...
Consider any transition $t_{13}$ in $A_{13}$.  Based on  the definition of composition $t_{13}$ can be obtained from two different cases, we will consider the two cases separately. Namely, $t_{13}$ is obtained
\begin{enumerate}
\item either by the composition of  transitions $t_1=\OTx{1}{}{1}{1}$ and  \[t_3^1=
...
By the extension of the valuation context mentioned above in the formula $(*)$ and by using the results (i), (ii) and (iii), we get:
\begin{multline*}
...
\begin{enumerate}
\item either by the composition of transitions $t_2=\OTx{2}{}{2}{2}$ and  \[t_1^1=
