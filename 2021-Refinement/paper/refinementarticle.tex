...
Let us consider any two states $s_{13} = \mpar{s_1,s_3}$ and $s_{23} = \mpar{s_2,q_3}$ we define a relation $R'$ relating states of $A_{13}$ and $A_{23}$ as follows:
\[R' \mpar{s_{13}, s_{23}} = \choice{R\mpar{s_{1}, s_{2}} \wedge \reach{A_{13}}\mpar{s_{13}} \wedge\!\!\!\! \bigwedge_\subbox{v\in \fvars{s_{3}}
}\!\!\! \sigma_{13}(v)=\sigma_{23}(v) & \text{ if } s_{3} = q_{3} \\ \bot & \text{otherwise}} \]
...
\end{align*}
The open transition $t_{13}$ is obtained by the composition of $t_1=\OTx{1}{}{1}{1}$ and $t_3=\OTx{3}{}{3}{3} $, which gives,  according to Definition \ref{Def:CompOA}, an open transition in one of the following forms:
% \[  \choice{
...
\[
\choice{
\OT{\mpar{s_1, s_3}}{\mpar{s'_1, s'_3}}{\alpha_1}{\beta_j^{j \in J'_1 \uplus J'_3 \setminus \{k\}}}{g_1 \wedge g_3 \wedge \alpha_3 = \beta_k}{\psi_1 \uplus \psi_3} & \text{ if } k \in J'_{1} \\
\OT{\mpar{s_1, s_3}}{\mpar{s'_1, s_3}}{\alpha_1}{\beta_j^{j \in J'_1}}{g_1}{\psi_1}& \text{otherwise}
}
\]
...
By composing the family of OTs  $t_{2x}^{x\in X}$ originating from  $s_2$ with an open transition $t_3 =\OT{q_3}{q_3'}{\alpha_{3}'}{\beta_j^{j \in J''_{3}}}{g_{3}'}{\psi_{3}'} \in T_3$ %${\OT{q_{3}}{q'_{3}}{\alpha_{3}}{\beta_{ j}^{j \in J'_{3}}}{g_{3}}{\psi_{3}}}$, 
gives a family of OTs $t_{23x}^{x\in X}$.  The result of the composition will be as follows:
\begin{enumerate}
\item if $ s_3=q_3$
\[
\choice{
\OT{\mpar{s_2, q_3}}{\mpar{s'_{2x}, q'_3}}{\alpha_{2x}}{\beta_j^{j \in J'_{2x} \uplus J''_3 \setminus \{k\}}}{g_{2x} \wedge g_3' \wedge \alpha_3' = \beta_{2xk}}{\psi_{2x} \uplus \psi_3'} & \text{ if } k \in J'_{2x} \\
\OT{\mpar{s_2, q_3}}{\mpar{s'_{2x}, q_3}}{\alpha_{2x}}{\beta_j^{j \in J'_{2x}}}{g_{2x}}{\psi_{2x}}& \text{otherwise}
}
\]
\item if $s_3 \neq q_3$ no element is produced that results an empty family.
\end{enumerate}
...
\TODO{Un peu de gymnastique est necessaire sur les valuations, etc...}
From this formula and $(*)$ 
\begin{multline*}
%\everymath{\displaystyle}
V_1 \uplus V_2 \uplus V_3 \uplus \fvars{t_1} \vdash\\ \mpar{R\mpar{s_1, s_{2}} \wedge \reach{A_{13}}\mpar{s_{13}} \wedge g_{13} 
\wedge g_1 \implies \operatorname*{\bigsymb{\bigvee}}_{x \in X} \mpar{\everymath{\displaystyle}
\begin{array}{l}
			\alpha_1 = \alpha_{2x} \wedge \bigwedge_\subbox{j \in J'_{2x} \cap H} \beta_{1j} = \beta_{2xj} \nwedge\\
			 g_{2x} \wedge R\mpar{s'_1, s'_{2x}}\psubst{\psi_1 \uplus \psi_{2x}}
