...
\begin{example} The composition of the refined \texttt{database} and the \texttt{counter} is again an open automata depicted in Fig.~\ref{Fig:ComposeRefine}. As stated by the theorem, this automaton is a refinement of the automaton of the figure Fig.~\ref{Def:CompOA}, the automaton resulting from the composition of the abstract \texttt{database}.
\end{example}
...
\newpage
\TODO{[RABEA] proof}
Let's consider any $s_{2p} \in (s_{2p})^{p\in P}$. According to the refinement relation between  $A_1$ and $A_2$ we have for any open transition $t_1$ in $T_1$  originating from $s_1$:
\begin{align*}
\OTx{1}{}{1}{1} \in \fOT{s_1}
\end{align*}
there exists an indexed family of OTs originating from $s_{2p}$: 
...
\begin{array}{l}
		...
		\end{array}}} 
\end{multline*}	
According to the refinement  relation between   $A_2$ and $A_3$, we know the following is satisfied, in particular for  the set $(t_{2pxy})^{x\in X_p}$:
\begin{multline*}
\bigforall \mpar{s_{2p}, s_3} \in S_1 \times S_3, \bigsymb{\forall} \mpar{t_{2px}, t_3} = \mpar{\OTx{2px}{}{2px}{2px}, \OTx{3}{}{3}{3}} \in \fOT{s_{2p}} \times \fOT{s_3} \\ 
\bigsymb{\bigexists} 
\mpar{t_{2pxy} = \OTx{2px}{y}{2pxy}{2pxy} \in \fOT{s_{2p}}}^{y \in Y},
...
\end{multline*}
Yet according to the refinement  relation between  $A_1$ and $A_2$ the following is satisfied, in particular over the family of transitions in $Y$:
\begin{multline*}
\bigforall \mpar{s_1, s_{2p}} \in S_1 \times S_2, \bigsymb{\forall} \mpar{t_1, t_{2pxy}} = \mpar{\OTx{1}{}{1}{1}, \OTx{2pxy}{}{2pxy}{2pxy}} \in \fOT{s_1} \times \fOT{s_{2p}} \\ 
\bigsymb{\bigexists} 
...
\mpar{
\alpha_1=\alpha_{1 z}  \land J'_{1z}= J'_{2pxy} \land \bigwedge_\subbox{j \in J'_{2pxy} } \beta_{2pxyj} = \beta_{1zj}\land g_{1 z}\land
 R_{12}\mpar{s'_{1 z}, s'_{2pxy}}\psubst{\psi_{1 z} \uplus \psi_{2pxy}}} \wedge \\\bigsymb{\bigwedge_{y\in Y}}
\mpar{
\alpha_{2px}=\alpha_{2p xy}  \land J'_{2pxy}= J'_3 \land \bigwedge_\subbox{j \in J'_3 } \beta_{3j} = \beta_{2pxyj}\land g_{2p xy}\land
 R_{23}\mpar{s'_{2p xy}, s'_3}\psubst{\psi_{2p xy} \uplus \psi_3}}
\end{multline*}
