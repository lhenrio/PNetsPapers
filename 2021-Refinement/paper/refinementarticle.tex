...
\begin{itemize}
\item if $k \in J'_1$:\\
Because composition doesn't change the resulting actions, nor their variables, we can extend the valuation context of the variables to cover the variables of the transition $t_3$, we will then have:\\ $ \alpha_{1} = \alpha_{2x} \Rightarrow \alpha_{13} = \alpha_{23x}$ and
${\displaystyle \bigwedge_\subbox{j \in J'_{23x} \cap H} \beta_{1j} = \beta_{2xj} \Rightarrow  \bigwedge_\subbox{j \in (J'_{2x} \cap H)\uplus J_3} \beta_{13j} = \beta_{23xj}}$\\
