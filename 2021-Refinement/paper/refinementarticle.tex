...
For any open automata \(A = \OAg\), a reachability predicate \(\reach{A}: S \to \rformulas[V]\) is a predicate on states satisfying both
 ...
 Reachability is preserved across transitions: \nmm{\forall t = \OTg \in T, \fvars{t} \vdash \reach{A}\mpar{s} \wedge g \implies \reach{A}\mpar{s'}\psubst{\psi}}
\end{definition}
...
\begin{definition}[Non-locking composition, intuitive definition]
...
\begin{definition}[Non-locking composition, working definition]
