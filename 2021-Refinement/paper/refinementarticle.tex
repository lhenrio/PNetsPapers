...
\end{array}}
\end{align*}	
This allows us to conclude, with ${\displaystyle R_{13}(s_1,s_3)=\bigvee_{{p\in P}}\mpar{R_{12}\mpar{s_1,s_{2p}} \wedge R_{23}\mpar{s_{2p},s_3}}}$: 

$\forall p \in P, \forall x \in X, \forall y \in Y,  J'_1 \cap (H \cap H') = J'_{3pxy} \cap (H\cap H'),$\\
$\displaystyle {\forall v \in \mpar{\fvars{\alpha_{1}}  \cup\!\!\! \bigcup_{j \in J'_{3pxy} \cap H \cap H'} \!\!\!\fvars{\beta_{1j} } } \setminus  \mpar{V_1 \uplus  V_3 \uplus \fvars{t_1}}}, $
\begin{align*}
