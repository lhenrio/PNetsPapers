...
\item The last formula we need to prove is that the relation is preserved along simultaneous transitions, i.e. for all $\mpar{s_{13}, s_{23}} \in S_{13} \times S_{23}$ and
\begin{multline*}
...
According to the refinement relation between  $A_1$ and $A_2$ we have, for all $\mpar{s_1,s_{2}} \in S_1 \times S_2$ and
\begin{multline*}
