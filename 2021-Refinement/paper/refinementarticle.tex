...
On the other side, from the relation between $A_2$ and $A_3$ we have for any open transition in $T_2$ originating from $s_{2p}$:
\begin{align*}
...
\begin{array}{l}
			 \alpha_{2px}=\alpha_{3pxy} \wedge \bigwedge_\subbox{j \in J'_{3pxy} \cap H'} \beta_{2jpx}=\beta_{3jpxy} \\
...
\begin{multline*}
\everymath{\displaystyle}
\forall v\in \mpar{\fvars{\alpha_{2px}}  \cup \bigcup_{j \in J'} \!\fvars{\beta_{2jpx}}} \setminus \mpar{V_2 \uplus V_3 \uplus \fvars{t_{2px}}},\\ \mpar{R_{23}\mpar{s_{2p}, s_{3}} \wedge g_{2px} \implies \operatorname*{\bigsymb{\bigvee}}_{y \in Y} \mpar{\everymath{\displaystyle}
\begin{array}{l}
			 \alpha_{2px}=\alpha_{3pxy} \wedge \bigwedge_\subbox{j \in J'_{3pxy} \cap H'} \beta_{2jpx}=\beta_{3jpxy} \\
