...
Let us define $R'$ the relation:
\[R' \mpar{\mpar{s_{13}, s'_{13}}, \mpar{s_{23}, s_{23}'}} = \choice{R\mpar{s_{13}, s_{23}} \wedge \reach{A_{13}}\mpar{s_{13},s_{13}'} \wedge\!\!\!\! \bigwedge_\subbox{\begin{array}{c}
v\in \fvars{s'_{13}}\\
v\in V_3
\end{array}}\!\!\! \sigma_{13}(v)=\sigma_{23}(v) & \text{ if } s'_{13} = s'_{23} \\ \bot & \text{otherwise}} \]
We want to prove that $\mpar{R, H\cup J_3 \setminus\{k\}}$ is a hole-tracking simulation of $A_{13}$ and $A_{23}$.
\begin{enumerate}
\item By using the fact $R$ relates initial configurations of  $A_1$ and $A_2$, initial state is reachable and renaming $\sigma_{03}$ by  $\sigma_{013}$ and  $\sigma_{023}$ we need to prove:
...
\iff & R\mpar{s_{01}, s_{02}}\psubst{ \sigma_{01} \uplus \sigma_{02}} \wedge \reach{A_{13}}\mpar{s_{013}} \psubst{\sigma_{013}} \wedge \bigwedge_\subbox{\begin{array}{c}
v\in V_3
\end{array}} \sigma_{03}(v)=\sigma_{03}(v)\\
\iff & R\mpar{s_{01}, s_{02}}\psubst{ \sigma_{01} \uplus \sigma_{02}} \wedge \reach{A_{13}}\mpar{s_{013}} \psubst{\sigma_{013}} \wedge \bigwedge_\subbox{\begin{array}{c}
v\in V_3
\end{array}} \sigma_{013}(v)=\sigma_{023}(v)
\end{align*}
