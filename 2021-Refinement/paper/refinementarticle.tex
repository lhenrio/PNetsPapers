...
\begin{enumerate}
\item either by the composition of a transition $t_1=\OTx{1}{}{1}{1}$ and a transition \[t_3^1=
...
\item  or by  the transition $t_1=\OTx{1}{}{1}{1}$ alone with the state $s^1_3$ unchanged, if $k \not\in J_1'$
...
\begin{itemize}
\item if $k \in J'_1$:\\
The proof is based on the following facts: (i) Because composition doesn't change the resulting actions, nor their variables, we can extend the valuation context of the variables to cover the variables of the transition $t_3$.   By construction of  $t_{13}$ and $t_{23}$ we have $\alpha_{13}=
\alpha_{1}$ and $\alpha_{23x}=\alpha_{2x}$. So we deduce: 
$\alpha_{1} = \alpha_{2x} \Rightarrow \alpha_{13} = \alpha_{23x}$.
(ii) We have: \\ $\beta_{13j}^{j\in J'_{13}}= \beta_{1j}^{j \in J'_{1}  \setminus \{k\}} \uplus   {(\beta^1_{3j})^{j \in J^{1 \prime}_3} }$
...
(iii) Considering $\beta^1_{3j}$ and  $\beta^2_{3j}$  are the same (up to renaming)  we have: 
...
From all the implications induced by the extension of the valuation context mentioned above in the formula $(*)$ and by using the results (i), (ii) and (iii), we get:
\begin{multline*}
...
\item if $k \notin J'_1$:\\
The proof of this case follows the same steps as the previous case the only argument that changes is that by composition we obtain:  $g_{13} \Leftrightarrow g_1$ and
...
\begin{enumerate}
\item either by the composition of a transition $t_2=\OTx{2}{}{2}{2}$ and a transition \[t_1^1=
...
\item  or by  the transition $t_1^1=
...
As before, the proof  is based  on the fact that the composition doesn't change the resulting actions, nor their variables, we can extend the valuation context of the variables to cover the variables of the transition $t_3$. (i)  By construction of  $t_{12}$ and $t_{13}$ we have $\alpha_{12}=
\alpha^1_{1}$ and $\alpha_{13x}=\alpha^2_{1}$. As  $\alpha^1_{1}=\alpha^2_{1}$  we deduce: 
$\alpha_{12} = \alpha_{13x}$. (ii) In addition we have:\\
...
(iii) Considering $\beta^1_{1j}$ and  $\beta^2_{1j}$  are the same (up to renaming)  we have: 
...
From the results (i), (ii), (iii)  and the formula $(*)$ we get:
\begin{multline*}
%\everymath{\displaystyle}
