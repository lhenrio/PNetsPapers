...
\TODO{do this case: the following is old text that makes no sense}
Principle:
\TODO{The proof of the rest of the formula follows the same steps as the previous case the only argument that changes is that by composition we obtain:  $g_{13} \Leftrightarrow g_1$ and $g_{23x}  \Leftrightarrow g_{2x}$}
%
