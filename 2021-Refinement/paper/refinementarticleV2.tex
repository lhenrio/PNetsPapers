...
Because the hole is not involved we can define (where elements of $A_1$ are the same as above modulo renaming of variables):
...
Thus, because transitions are the same:
\[R' \mpar{s_{12}, s_{13}} \implies
R\mpar{s_{2}, s_{3}} \land \reach{A_{12}}(s_{12}) \wedge \bigwedge_\subbox{v_1\in V_1} v^1_1=v^2_1\wedge {s^1_1}^\prime = {s^2_1}^\prime
\]
