...
V_1 \uplus V_2 \uplus \fvars{t_1} \uplus \fvars{t_2}  \vdash R\mpar{s_1, s_2} \wedge g_2 \implies\\
V_1 \uplus V_2 \uplus \fvars{t_{1x}} \uplus \fvars{t_2}\vdash  \bigsymb{\bigexists} 
\mpar{t_{1x} \!=\! \OTx{1}{x}{1x}{1x}}^{x \in X} \operatorname*{\bigsymb{\bigvee}}_{x \in X}
\mpar{\begin{array}{l}
			\alpha_{1x} = \alpha_{2} \wedge \bigwedge_\subbox{j \in J'_{2}} \beta_{1xj} = \beta_{2j} \nwedge\\[12pt]
			 g_{1x} \wedge R\mpar{s'_{1x}, s'_{2}}\psubst{\psi_{1x} \uplus \psi_{2}}
		\end{array}} 
\end{array} 
\end{multline*}
\item [(3)] The deadlock reduction:
\begin{multline*}
\forall \mpar{s_1, s_2} \in S_1 \times S_2, V_1 \uplus V_2  \fvars{t_2} \vdash R\mpar{s_1, s_2} \wedge  \bigvee_\subbox{t_1 \in \fOT{s_1}} \fguard{t_1} \implies \bigvee_\subbox{t_2 \in \fOT{s_2}} \fguard{t_2}  
\end{multline*}
