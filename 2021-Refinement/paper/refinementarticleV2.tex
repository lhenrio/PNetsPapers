...
For this case, the  composition doesn't change the produced actions nor its variables, we have:  $g_{12} \Leftrightarrow g^1_1$ and $g_{13x}  \Leftrightarrow g^2_1$ and the actions of $\alpha_{12}= \alpha^1_1$ and $\alpha_{23x} = = \alpha^2_1$ and the actions of the holes in $J_{13}$ coincide by the composition.


The same for $\beta_{13j}$ and $\beta_{23xj}$ that are renaming of $\beta_{1j}$ and $\beta_{2xj}$ resp.
