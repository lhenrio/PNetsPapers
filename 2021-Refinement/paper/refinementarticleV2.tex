...
\begin{quote}
Suppose that $\wrel{A_1}{A_2}{H}$, \(k \in H\) \cancel{and that \(A_1\subst{A_3}{k}\) is non-blocking}. We have: 
...
\end{multline*}
From the three previous formulas we deduce:
  \begin{multline*}
V_{13} \uplus V_{23} \vdash R\mpar{s_1, s_2} \nwedge \neg (\bigvee_\subbox{t_{13} \in \fOT{s_{13}}} \fguard{t_{13}}) \implies   \neg(\bigvee_\subbox{t_{23} \in \fOT{s_{23}}} \fguard{t_{23}})
\end{multline*}
...
\begin{enumerate}
\item \TODO{Pareil que le theorem precedent}
