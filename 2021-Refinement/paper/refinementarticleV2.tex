...
\begin{example} As a running example, we consider a classical producer-consumer pair  with FIFO buffer. The overall structure shown in Fig. \ref{Fig:Architect}
reflects the different processes involved in the communication and all the actions performed.
