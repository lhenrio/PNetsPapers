...
Recall in this case \LUDO{ WHICH CASE???}  $k \notin J'_1$, $\forall x \in X$ we have
\begin{align*}		
...
\item \LUDO{ OLD OUTDATED PROOF?????} Lastly, we have to prove the satisfaction of the deadlock reduction condition, i.e., for all $\mpar{s_{13}, s_{23}} \in S_{13} \times S_{23}$
\begin{multline*}
