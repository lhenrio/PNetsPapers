...
Quentin Corradi\inst{4}\orcidID{0000-0003-4218-3987} \and
...
\and
Imperial College London, United Kingdom (previously Universit\'e Lyon)\\
\email{qc322[at]ic.ac.uk}}
%
...
\RAB{The notion of symbolic bisimulation, as it was introduced in \cite{HENNESSY:1995}, is aimed at computing bisimulation of value-passing processes. The class of processes manipulating and exchanging with the environment data, where the values are from possibly infinite domain.}
...
V_1 \uplus V_2 \uplus  \fvars{t_1} \vdash \bigsymb{\bigexists} \mpar{\bigcup_x\fvars{t_{2x}}}. \hspace{7cm}
\\
