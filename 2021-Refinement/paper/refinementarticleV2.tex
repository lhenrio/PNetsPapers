...
The parallel substitution of variables in \(e\) by a map \(\psi: V \to \terms\) is denoted \(e\psubst{\psi}\).
 ...
 We suppose given a satisfiability relation on closed formulas, denoted \({\vdash} f\).
...
\begin{multline*}
\left(\forall \mpar{s_1, s_2} \!\in\! S_1 \!\times\! S_2, V_1 \uplus V_2  \vdash \mathcal{R}\mpar{s_1, s_2} \wedge \lnot( \bigvee_\subbox{t_1 \in \fOT{s_1}} \fguard{t_1})\right) \\\implies \lnot( \bigvee_\subbox{t_2 \in \fOT{s_2}} \fguard{t_2}  )
\end{multline*}
...
\[
\left(
\forall \mpar{s_1, s_2} \!\in\! S_1 \!\times\! S_2, V_1 \uplus V_2  \vdash \mathcal{R}\mpar{s_1, s_2}\right) \implies( \bigvee_\subbox{t_1 \in \fOT{s_1}} \fguard{t_1} ) \lor¢ \lnot( \bigvee_\subbox{t_2 \in \fOT{s_2}} \fguard{t_2}  )
\]
...
\TODO{add comments} we do not have any guarantee on the action of the holes inside $H$.
