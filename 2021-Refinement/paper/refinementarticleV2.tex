...
Refinement entails that one system  can be considered as a more precise version of another one that is considered to be the specification. The refined model features all the specified behaviours with more concrete details. From a formal point of view,  refinement can be defined as a mathematical relations between a specification and its implementation, one frequently used relation is trace inclusion or simulation  \cite{Milner:1980,Kouchnarenko:2007}.  \RAB{The refinement approach provides mechanism for transforming high-level processes into concrete processes (i.e. implementation), in such a way that some behavioural properties are preserved within the transformation.} \st{semantic treatment  offers specific guarantees on the  behavioural properties of the specification, and it ensures that all behaviours of the specification must belong to the behaviours of the implementation.} Most  refinement work focused on  the study  of  closed
...
The origins of refinement are in the  approach of programming that aims to provide solid foundations for building correct programs \cite{Dijkstra76}.  Many work  contributed to the  development of elaborated notions of refinement \LUDO{\st{TODO: define refinement calculus}} in various area (e.g. \cite{BACK1990133,Abrialbooks96,soton250550,Bellegarde:2000}).
