...
Recall in this second case (where only the encompassing automaton performs a transition $t_{13}$)  $k \notin J'_1$, $\forall x \in X$ we have
\begin{align*}		
...
\begin{multline*}
V_{13} \uplus V_{23} \uplus \biguplus_\subbox{t_{23}\in \fOT{s_{23}}} \fvars{t_{23}} \vdash \\ R\mpar{s_{13}, s_{23}}  \implies \bigvee_\subbox{t_1 \in \fOT{s_{13}}} \fguard{t_{13}} \vee \neg \mpar{\,\,\,\,\, \bigvee_\subbox{t_{23} \in \fOT{s_{23}}} \fguard{t_{23}} } 
\end{multline*}
...
\begin{multline*}
V_1 \uplus V_2 \uplus \biguplus_\subbox{t_2 \in \fOT{s_2}} \fvars{t_2} \vdash R\mpar{s_1, s_2}  \implies \bigvee_\subbox{t_1 \in \fOT{s_1}} \fguard{t_1} \vee \neg\mpar{\,\,\,\,\,\bigvee_\subbox{t_2 \in \fOT{s_2}} \fguard{t_2}}
\end{multline*}

\RAB{ Il faudra exprimer une condition de non blocage peut on exprimer comme ceci}
the result of the composition \(A_1\subst{A_3}{k}\) is non-blocking:
\begin{multline*}
V_{13}  \uplus \biguplus_\subbox{t_1 \in \fOT{s_1}} \fvars{t_1} \vdash \left( \cancel{\reach{A_{13}}\mpar{s_{13}} \wedge} \bigvee_\subbox{t_1 \in \fOT{s_1}} \fguard{t_1} \implies \bigvee_\subbox{t_{13} \in \fOT{s_{13}}} \fguard{t_{13}} \right)
\end{multline*}
