...
\RAB{Pourquoi masquer partie en dessous? we need to prove  $\mpar{\forall x \in X, J'_{13x} \cap H' = J'_{12} \cap H'}$}
% 
%$\forall x \in X$ we have
%\begin{align*}		
...
\RAB{Bien entendu ce passage est vrai que parce que  $\alpha_{12}$ and $\alpha_{13}$ are the same...}
