...
\begin{example}  Consider again the \texttt{prod-cons}  \texttt{Simprod-cons}  automata given in examples above.  Since we have \texttt{prod-cons} $\leq_{\{\texttt{P,Q}\}}$ \texttt{simprod-cons},  hence according to Theorem \ref{thm:ContextRefinement}, we get 
