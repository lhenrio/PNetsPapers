...
\draw (v1) edge[dir=80] node[above] {\OTd{\tau}{ctl \mapsto \theta\mpar{x}, cnt \mapsto \act{set}\mpar{x}}{}} (v1);
...
\draw (v2) edge[dir=320] node[xshift=1cm,below] {\OTd{\tau}{ctl \mapsto \theta\mpar{x}, cnt \mapsto \act{set}\mpar{x}}{}} (v2);
...
\draw (v3) edge[dir=200] node {\OTd{\tau}{ctl \mapsto \theta\mpar{x}, cnt \mapsto \act{set}\mpar{x}}{}} (v3);
